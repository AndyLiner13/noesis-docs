Source: https://www.noesisengine.com/docs/Gui.Animation._EasingPointKeyFrame.html

# EasingPointKeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.easingpointkeyframe.aspx)

A class that enables you to associate easing functions with a [PointAnimationUsingKeyFrames](/Gui.Animation/_PointAnimationUsingKeyFrames.md) key frame animation.

This class is used as part of a [PointKeyFrameCollection](/Gui.Animation/_PointKeyFrameCollection.md) in conjunction with a [PointAnimationUsingKeyFrames](/Gui.Animation/_PointAnimationUsingKeyFrames.md) to animate a Point property value along a set of key frames. This [PointKeyFrame](/Gui.Animation/_PointKeyFrame.md) interpolates between the Point value of the previous key frame and its own value linearly with an easing function to produce its output value.
...
EasingPointKeyFrame has no attached properties
...
EasingPointKeyFrame has no events