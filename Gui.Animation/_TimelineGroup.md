Source: https://www.noesisengine.com/docs/Gui.Animation._TimelineGroup.html

# TimelineGroup Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.timelinegroup.aspx)

Abstract class that, when implemented represents a [Timeline](/Gui.Animation/_Timeline.md) that may contain a collection of child [Timeline](/Gui.Animation/_Timeline.md) objects.
