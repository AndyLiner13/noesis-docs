...
Represents a collection of [DoubleKeyFrame](_DoubleKeyFrame.md) objects.

This collection is used as part of a [DoubleAnimationUsingKeyFrames](_DoubleAnimationUsingKeyFrames.md) to animate a Double property value along a set of key frames.
