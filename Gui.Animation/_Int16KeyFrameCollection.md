...
Represents a collection of [Int16KeyFrame](_Int16KeyFrame.md) objects.

This collection is used as part of a [Int16AnimationUsingKeyFrames](_Int16AnimationUsingKeyFrames.md) to animate a Int16 property value along a set of key frames.
