Source: https://www.noesisengine.com/docs/Gui.Animation._Int16KeyFrameCollection.html

# Int16KeyFrameCollection Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.animation.int16keyframecollection)

Represents a collection of [Int16KeyFrame](/Gui.Animation/_Int16KeyFrame.md) objects.

This collection is used as part of a [Int16AnimationUsingKeyFrames](/Gui.Animation/_Int16AnimationUsingKeyFrames.md) to animate a Int16 property value along a set of key frames.
...
Int16KeyFrameCollection has no attached properties
...
Int16KeyFrameCollection has no events