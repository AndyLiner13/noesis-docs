Source: https://www.noesisengine.com/docs/Gui.Animation._RectAnimation.html

# RectAnimation Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.rectanimation.aspx)

Animates the value of a *Rect* property between two target values using linear interpolation over a specified *Duration*.
