...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.doubleanimationusingkeyframes.aspx)

Animates the value of a Double property along a set of KeyFrames.

A key frame animation's target values are defined by its KeyFrames property, which contains a collection of [DoubleKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._DoubleKeyFrame.html) objects. Each [DoubleKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._DoubleKeyFrame.html) defines a segment of the animation with its own target Value and [KeyTime](https://www.noesisengine.com/docs/Gui.Animation._KeyTime.html). When the animation runs, it progresses from one key value to the next at the specified key times.

There are three types of [DoubleKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._DoubleKeyFrame.html) classes, one for each supported interpolation method: [LinearDoubleKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._LinearDoubleKeyFrame.html), [DiscreteDoubleKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._DiscreteDoubleKeyFrame.html), and [SplineDoubleKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._SplineDoubleKeyFrame.html).

Unlike a [DoubleAnimation](https://www.noesisengine.com/docs/Gui.Animation._DoubleAnimation.html), a DoubleAnimationUsingKeyFrames can have more than two of target values. You can also control the interpolation method of individual [DoubleKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._DoubleKeyFrame.html) segments.
...
- [DoubleAnimationBase](https://www.noesisengine.com/docs/Gui.Animation._DoubleAnimationBase.html)
...
### From [DoubleAnimationBase](https://www.noesisengine.com/docs/Gui.Animation._DoubleAnimationBase.html)
