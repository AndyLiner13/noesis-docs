...
Describes how a [Timeline](/Gui.Animation/_Timeline.md) repeats its simple duration. Examples:
...
| Name | Description |
| --- | --- |
|  *Forever()* | Creates a [RepeatBehavior](/Gui.Animation/_RepeatBehavior.md) object that specifies an infinite number of repetitions |
|  *ToString()* | Generates a string representation of the point The string has the following form: "Forever", "2x", or a [TimeSpan](/Gui.Animation/_TimeSpan.md): "0:0:1" |
|  *TryParse(txt, result)* | Tries to parse a [RepeatBehavior](/Gui.Animation/_RepeatBehavior.md) from a string |
