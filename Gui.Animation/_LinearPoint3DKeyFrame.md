Source: https://www.noesisengine.com/docs/Gui.Animation._LinearPoint3DKeyFrame.html

# LinearPoint3DKeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.linearpoint3dkeyframe.aspx)
...
Linear key frames like [LinearPoint3DKeyFrame](_LinearPoint3DKeyFrame.md) create a smooth, linear interpolation between values.
...
LinearPoint3DKeyFrame has no attached properties
...
LinearPoint3DKeyFrame has no events