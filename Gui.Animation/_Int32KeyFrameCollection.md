...
Represents a collection of [Int32KeyFrame](_Int32KeyFrame.md) objects.

This collection is used as part of a [Int32AnimationUsingKeyFrames](_Int32AnimationUsingKeyFrames.md) to animate a Int32 property value along a set of key frames.
