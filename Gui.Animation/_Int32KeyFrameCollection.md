Source: https://www.noesisengine.com/docs/Gui.Animation._Int32KeyFrameCollection.html

# Int32KeyFrameCollection Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.animation.int32keyframecollection)

Represents a collection of [Int32KeyFrame](/Gui.Animation/_Int32KeyFrame.md) objects.

This collection is used as part of a [Int32AnimationUsingKeyFrames](/Gui.Animation/_Int32AnimationUsingKeyFrames.md) to animate a Int32 property value along a set of key frames.
...
Int32KeyFrameCollection has no attached properties
...
Int32KeyFrameCollection has no events