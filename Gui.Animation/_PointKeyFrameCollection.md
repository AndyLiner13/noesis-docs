...
Represents a collection of [PointKeyFrame](_PointKeyFrame.md) objects.

This collection is used as part of a [PointAnimationUsingKeyFrames](_PointAnimationUsingKeyFrames.md) to animate a Point property value along a set of key frames.
