Source: https://www.noesisengine.com/docs/Gui.Animation._SplineInt32KeyFrame.html

# SplineInt32KeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.splineint32keyframe.aspx)
...
Spline key frames like [SplineInt32KeyFrame](_SplineInt32KeyFrame.md) creates a variable transition between values which is determined by the [KeySpline](_KeySpline.md) property. Splined interpolation can be used to achieve more realistic "real world" timing effects such as acceleration and deceleration.
...
SplineInt32KeyFrame has no attached properties
...
SplineInt32KeyFrame has no events