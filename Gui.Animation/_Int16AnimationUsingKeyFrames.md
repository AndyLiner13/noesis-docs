...
A key frame animation's target values are defined by its KeyFrames property, which contains a collection of [Int16KeyFrame](_Int16KeyFrame.md) objects. Each [Int16KeyFrame](_Int16KeyFrame.md) defines a segment of the animation with its own target Value and [KeyTime](_KeyTime.md). When the animation runs, it progresses from one key value to the next at the specified key times.

There are three types of [Int16KeyFrame](_Int16KeyFrame.md) classes, one for each supported interpolation method: [LinearInt16KeyFrame](_LinearInt16KeyFrame.md), [DiscreteInt16KeyFrame](_DiscreteInt16KeyFrame.md), and [SplineInt16KeyFrame](_SplineInt16KeyFrame.md).

Unlike a [Int16Animation](_Int16Animation.md), a [Int16AnimationUsingKeyFrames](_Int16AnimationUsingKeyFrames.md) can have more than two of target values. You can also control the interpolation method of individual [Int16KeyFrame](_Int16KeyFrame.md) segments.
...
• [Int16AnimationBase](_Int16AnimationBase.md)
...
## From [Int16AnimationBase](_Int16AnimationBase.md)
