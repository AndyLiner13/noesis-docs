Source: https://www.noesisengine.com/docs/Gui.Animation._Int16AnimationUsingKeyFrames.html

# Int16AnimationUsingKeyFrames Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.int16animationusingkeyframes.aspx)

Animates the value of a *Int16* property along a set of *KeyFrames*.

A key frame animation's target values are defined by its KeyFrames property, which contains a collection of [Int16KeyFrame](/Gui.Animation/_Int16KeyFrame.md) objects. Each [Int16KeyFrame](/Gui.Animation/_Int16KeyFrame.md) defines a segment of the animation with its own target Value and [KeyTime](/Gui.Animation/_KeyTime.md). When the animation runs, it progresses from one key value to the next at the specified key times.

There are three types of [Int16KeyFrame](/Gui.Animation/_Int16KeyFrame.md) classes, one for each supported interpolation method: [LinearInt16KeyFrame](/Gui.Animation/_LinearInt16KeyFrame.md), [DiscreteInt16KeyFrame](/Gui.Animation/_DiscreteInt16KeyFrame.md), and [SplineInt16KeyFrame](/Gui.Animation/_SplineInt16KeyFrame.md).

Unlike a [Int16Animation](/Gui.Animation/_Int16Animation.md), a [Int16AnimationUsingKeyFrames](/Gui.Animation/_Int16AnimationUsingKeyFrames.md) can have more than two of target values. You can also control the interpolation method of individual [Int16KeyFrame](/Gui.Animation/_Int16KeyFrame.md) segments.
...
• [Int16AnimationBase](/Gui.Animation/_Int16AnimationBase.md)
...
## From [Int16AnimationBase](/Gui.Animation/_Int16AnimationBase.md)
