Source: https://www.noesisengine.com/docs/Gui.Animation._ExponentialEase.html

# ExponentialEase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.exponentialease.aspx)
...
ExponentialEase has no attached properties
