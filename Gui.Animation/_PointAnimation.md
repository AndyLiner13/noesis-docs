Source: https://www.noesisengine.com/docs/Gui.Animation._PointAnimation.html

# PointAnimation Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.pointanimation.aspx)
