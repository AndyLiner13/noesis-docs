Source: https://www.noesisengine.com/docs/Gui.Animation._LinearThicknessKeyFrame.html

# LinearThicknessKeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.linearthicknesskeyframe.aspx)
...
Linear key frames like [LinearThicknessKeyFrame](_LinearThicknessKeyFrame.md) create a smooth, linear interpolation between values.
...
LinearThicknessKeyFrame has no attached properties
...
LinearThicknessKeyFrame has no events