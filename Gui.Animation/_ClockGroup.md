...
An assemblage of [Clock](/Gui.Animation/_Clock.md) types with behavior based off of a [TimelineGroup](/Gui.Animation/_TimelineGroup.md).
...
| Name | Description |
| --- | --- |
|  *Add(clock)* | Gets the children collection of this [ClockGroup](/Gui.Animation/_ClockGroup.md) |
|  *GetChild(index)* | Get child at index position |
|  *GetChildrenCount()* | Get number of children |
|  *GetTimeline()* | Gets the [TimelineGroup](/Gui.Animation/_TimelineGroup.md) object that dictates the behavior of this [ClockGroup](/Gui.Animation/_ClockGroup.md) instance |
