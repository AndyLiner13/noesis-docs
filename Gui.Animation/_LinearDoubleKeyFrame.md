Source: https://www.noesisengine.com/docs/Gui.Animation._LinearDoubleKeyFrame.html

# LinearDoubleKeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.lineardoublekeyframe.aspx)

Animates from the *Float* value of the previous key frame to its own *Value* using linear interpolation.
...
Linear key frames like [LinearDoubleKeyFrame](_LinearDoubleKeyFrame.md) create a smooth, linear interpolation between values.
...
LinearDoubleKeyFrame has no attached properties
...
LinearDoubleKeyFrame has no events