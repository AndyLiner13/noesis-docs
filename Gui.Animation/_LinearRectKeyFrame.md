Source: https://www.noesisengine.com/docs/Gui.Animation._LinearRectKeyFrame.html

# LinearRectKeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.linearrectkeyframe.aspx)
...
Linear key frames like [LinearRectKeyFrame](_LinearRectKeyFrame.md) create a smooth, linear interpolation between values.
...
LinearRectKeyFrame has no attached properties
...
LinearRectKeyFrame has no events