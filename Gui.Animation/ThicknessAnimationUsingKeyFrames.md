...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.thicknessanimationusingkeyframes.aspx)

Animates the value of a Thickness property along a set of KeyFrames. A key frame animation's target values are defined by its KeyFrames property, which contains a collection of [ThicknessKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._ThicknessKeyFrame.html) objects. Each [ThicknessKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._ThicknessKeyFrame.html) defines a segment of the animation with its own target Value and [KeyTime](https://www.noesisengine.com/docs/Gui.Animation._KeyTime.html). When the animation runs, it progresses from one key value to the next at the specified key times. There are three types of [ThicknessKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._ThicknessKeyFrame.html) classes, one for each supported interpolation method: [LinearThicknessKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._LinearThicknessKeyFrame.html), [DiscreteThicknessKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._DiscreteThicknessKeyFrame.html), and [SplineThicknessKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._SplineThicknessKeyFrame.html). Unlike a [ThicknessAnimation](https://www.noesisengine.com/docs/Gui.Animation._ThicknessAnimation.html), a ThicknessAnimationUsingKeyFrames can have more than two of target values. You can also control the interpolation method of individual [ThicknessKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._ThicknessKeyFrame.html) segments.
...
- [ThicknessAnimationBase](https://www.noesisengine.com/docs/Gui.Animation._ThicknessAnimationBase.html)
...
### From [ThicknessAnimationBase](https://www.noesisengine.com/docs/Gui.Animation._ThicknessAnimationBase.html)
