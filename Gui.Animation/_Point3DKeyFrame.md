Source: https://www.noesisengine.com/docs/Gui.Animation._Point3DKeyFrame.html

# Point3DKeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.point3dkeyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [Point3DAnimationUsingKeyFrames](/Gui.Animation/_Point3DAnimationUsingKeyFrames.md).
...
• [DiscretePoint3DKeyFrame](/Gui.Animation/_DiscretePoint3DKeyFrame.md)

• [EasingPoint3DKeyFrame](/Gui.Animation/_EasingPoint3DKeyFrame.md)

• [LinearPoint3DKeyFrame](/Gui.Animation/_LinearPoint3DKeyFrame.md)

• [SplinePoint3DKeyFrame](/Gui.Animation/_SplinePoint3DKeyFrame.md)
...
Point3DKeyFrame has no attached properties
