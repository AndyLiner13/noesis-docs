...
Defines an animation segment with its own target value and interpolation method for a [Point3DAnimationUsingKeyFrames](_Point3DAnimationUsingKeyFrames.md).
...
• [DiscretePoint3DKeyFrame](_DiscretePoint3DKeyFrame.md)

• [EasingPoint3DKeyFrame](_EasingPoint3DKeyFrame.md)

• [LinearPoint3DKeyFrame](_LinearPoint3DKeyFrame.md)

• [SplinePoint3DKeyFrame](_SplinePoint3DKeyFrame.md)
