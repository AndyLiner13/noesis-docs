...
Defines an animation segment with its own target value and interpolation method for a [MatrixAnimationUsingKeyFrames](_MatrixAnimationUsingKeyFrames.md).
...
• [DiscreteMatrixKeyFrame](_DiscreteMatrixKeyFrame.md)
