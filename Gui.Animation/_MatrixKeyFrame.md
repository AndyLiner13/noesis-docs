Source: https://www.noesisengine.com/docs/Gui.Animation._MatrixKeyFrame.html

# MatrixKeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.matrixkeyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [MatrixAnimationUsingKeyFrames](/Gui.Animation/_MatrixAnimationUsingKeyFrames.md).
...
• [DiscreteMatrixKeyFrame](/Gui.Animation/_DiscreteMatrixKeyFrame.md)
...
MatrixKeyFrame has no attached properties
