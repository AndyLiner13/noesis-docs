Source: https://www.noesisengine.com/docs/Gui.Animation._KeySpline.html

# KeySpline Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.keyspline.aspx)
...
| Name | Description |
| --- | --- |
| ○ *ControlPoint1* | Gets or sets the first control point used to define a Bezier curve that describes a [KeySpline](/Gui.Animation/_KeySpline.md) |
| ○ *ControlPoint2* | Gets or sets the second control point used to define a Bezier curve that describes a [KeySpline](/Gui.Animation/_KeySpline.md) |
...
KeySpline has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *GetSplineProgress(linearProgress)* | Calculates spline progress from a supplied linear progress |
|  *TryParse(str, result)* | Tries to parse a [KeySpline](/Gui.Animation/_KeySpline.md) from a string |
