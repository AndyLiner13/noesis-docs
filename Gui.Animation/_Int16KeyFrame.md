...
Defines an animation segment with its own target value and interpolation method for a [Int16AnimationUsingKeyFrames](_Int16AnimationUsingKeyFrames.md).
...
• [DiscreteInt16KeyFrame](_DiscreteInt16KeyFrame.md)

• [EasingInt16KeyFrame](_EasingInt16KeyFrame.md)

• [LinearInt16KeyFrame](_LinearInt16KeyFrame.md)

• [SplineInt16KeyFrame](_SplineInt16KeyFrame.md)
