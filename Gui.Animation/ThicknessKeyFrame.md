...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.thicknesskeyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [ThicknessAnimationUsingKeyFrames](https://www.noesisengine.com/docs/Gui.Animation._ThicknessAnimationUsingKeyFrames.html).
