Source: https://www.noesisengine.com/docs/Gui.Animation._Int64AnimationBase.html

# Int64AnimationBase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.int64animationbase.aspx)

Abstract class that, when implemented, animates a *Int64* value.

Derive from a [Int64AnimationBase](/Gui.Animation/_Int64AnimationBase.md) class and implement the *GetCurrentValueCore* method. The *GetCurrentValueCore* method returns the current value of the animation. It takes three parameters: a suggested starting value, a suggested ending value, and an [AnimationClock](/Gui.Animation/_AnimationClock.md), which you use to determine the progress of the animation.

Because [Int64AnimationBase](/Gui.Animation/_Int64AnimationBase.md) class inherit from the [Freezable](/Gui.DependencySystem/_Freezable.md) class, you must also override *CreateInstanceCore* core to return a new instance of your class.
...
• [Int64Animation](/Gui.Animation/_Int64Animation.md)

• [Int64AnimationUsingKeyFrames](/Gui.Animation/_Int64AnimationUsingKeyFrames.md)
