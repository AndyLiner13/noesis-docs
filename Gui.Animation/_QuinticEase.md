Source: https://www.noesisengine.com/docs/Gui.Animation._QuinticEase.html

# QuinticEase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.quinticease.aspx)
...
QuinticEase has no attached properties
