...
Defines an animation segment with its own target value and interpolation method for a [ObjectAnimationUsingKeyFrames](_ObjectAnimationUsingKeyFrames.md).
...
• [DiscreteObjectKeyFrame](_DiscreteObjectKeyFrame.md)
