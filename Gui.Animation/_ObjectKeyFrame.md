Source: https://www.noesisengine.com/docs/Gui.Animation._ObjectKeyFrame.html

# ObjectKeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.objectkeyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [ObjectAnimationUsingKeyFrames](/Gui.Animation/_ObjectAnimationUsingKeyFrames.md).
...
• [DiscreteObjectKeyFrame](/Gui.Animation/_DiscreteObjectKeyFrame.md)
...
ObjectKeyFrame has no attached properties
