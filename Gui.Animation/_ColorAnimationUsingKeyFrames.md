Source: https://www.noesisengine.com/docs/Gui.Animation._ColorAnimationUsingKeyFrames.html

# ColorAnimationUsingKeyFrames Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.coloranimationusingkeyframes.aspx)

Animates the value of a *Color* property along a set of *KeyFrames*.

A key frame animation's target values are defined by its KeyFrames property, which contains a collection of [ColorKeyFrame](/Gui.Animation/_ColorKeyFrame.md) objects. Each [ColorKeyFrame](/Gui.Animation/_ColorKeyFrame.md) defines a segment of the animation with its own target Value and [KeyTime](/Gui.Animation/_KeyTime.md). When the animation runs, it progresses from one key value to the next at the specified key times.

There are four types of [ColorKeyFrame](/Gui.Animation/_ColorKeyFrame.md) classes, one for each supported interpolation method: [LinearColorKeyFrame](/Gui.Animation/_LinearColorKeyFrame.md), [DiscreteColorKeyFrame](/Gui.Animation/_DiscreteColorKeyFrame.md), [EasingColorKeyFrame](/Gui.Animation/_EasingColorKeyFrame.md), and [SplineColorKeyFrame](/Gui.Animation/_SplineColorKeyFrame.md).

Unlike a [ColorAnimation](/Gui.Animation/_ColorAnimation.md), a [ColorAnimationUsingKeyFrames](/Gui.Animation/_ColorAnimationUsingKeyFrames.md) can have more than two of target values. You can also control the interpolation method of individual [ColorKeyFrame](/Gui.Animation/_ColorKeyFrame.md) segments.
...
• [ColorAnimationBase](/Gui.Animation/_ColorAnimationBase.md)
...
## From [ColorAnimationBase](/Gui.Animation/_ColorAnimationBase.md)
