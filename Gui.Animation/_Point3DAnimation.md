Source: https://www.noesisengine.com/docs/Gui.Animation._Point3DAnimation.html

# Point3DAnimation Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.point3danimation.aspx)

Animates the value of a *Point3D* property between two target values using linear interpolation over a specified *Duration*.
