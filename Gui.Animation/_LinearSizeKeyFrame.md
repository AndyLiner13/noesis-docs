Source: https://www.noesisengine.com/docs/Gui.Animation._LinearSizeKeyFrame.html

# LinearSizeKeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.linearsizekeyframe.aspx)
...
Linear key frames like [LinearSizeKeyFrame](_LinearSizeKeyFrame.md) create a smooth, linear interpolation between values.
...
LinearSizeKeyFrame has no attached properties
...
LinearSizeKeyFrame has no events