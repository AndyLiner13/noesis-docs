Source: https://www.noesisengine.com/docs/Gui.Animation._ParallelTimeline.html

# ParallelTimeline Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.paralleltimeline.aspx)

Defines a segment of time that may contain child [Timeline](/Gui.Animation/_Timeline.md) objects.
...
• [Storyboard](/Gui.Animation/_Storyboard.md)
