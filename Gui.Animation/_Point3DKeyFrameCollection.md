...
Represents a collection of [Point3DKeyFrame](_Point3DKeyFrame.md) objects.

This collection is used as part of a [Point3DAnimationUsingKeyFrames](_Point3DAnimationUsingKeyFrames.md) to animate a Point3D property value along a set of key frames.
