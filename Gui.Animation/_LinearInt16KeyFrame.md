Source: https://www.noesisengine.com/docs/Gui.Animation._LinearInt16KeyFrame.html

# LinearInt16KeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.linearint16keyframe.aspx)
...
Linear key frames like [LinearInt16KeyFrame](_LinearInt16KeyFrame.md) create a smooth, linear interpolation between values.
...
LinearInt16KeyFrame has no attached properties
...
LinearInt16KeyFrame has no events