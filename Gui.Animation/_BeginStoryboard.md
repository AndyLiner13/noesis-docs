...
A trigger action that begins a [Storyboard](_Storyboard.md) and distributes its animations to their targeted objects and properties.
...
| ○ *Name* | Gets or sets the name of the [BeginStoryboard](_BeginStoryboard.md) object. By naming the [BeginStoryboard](_BeginStoryboard.md) object, the [Storyboard](_Storyboard.md) can be controlled after it is started |
| ● *Storyboard* | Gets or sets the [Storyboard](_Storyboard.md) that this [BeginStoryboard](_BeginStoryboard.md) starts |
