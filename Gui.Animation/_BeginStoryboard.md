Source: https://www.noesisengine.com/docs/Gui.Animation._BeginStoryboard.html

# BeginStoryboard Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.beginstoryboard.aspx)

A trigger action that begins a [Storyboard](/Gui.Animation/_Storyboard.md) and distributes its animations to their targeted objects and properties.
...
| ○ *Name* | Gets or sets the name of the [BeginStoryboard](/Gui.Animation/_BeginStoryboard.md) object. By naming the [BeginStoryboard](/Gui.Animation/_BeginStoryboard.md) object, the [Storyboard](/Gui.Animation/_Storyboard.md) can be controlled after it is started |
| ● *Storyboard* | Gets or sets the [Storyboard](/Gui.Animation/_Storyboard.md) that this [BeginStoryboard](/Gui.Animation/_BeginStoryboard.md) starts |
...
BeginStoryboard has no attached properties
