Source: https://www.noesisengine.com/docs/Gui.Animation._EasingFunctionBase.html

# EasingFunctionBase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.easingfunctionbase.aspx)
...
• [BackEase](/Gui.Animation/_BackEase.md)

• [BounceEase](/Gui.Animation/_BounceEase.md)

• [CircleEase](/Gui.Animation/_CircleEase.md)

• [CubicEase](/Gui.Animation/_CubicEase.md)

• [ElasticEase](/Gui.Animation/_ElasticEase.md)

• [ExponentialEase](/Gui.Animation/_ExponentialEase.md)

• [PowerEase](/Gui.Animation/_PowerEase.md)

• [QuadraticEase](/Gui.Animation/_QuadraticEase.md)

• [QuarticEase](/Gui.Animation/_QuarticEase.md)

• [QuinticEase](/Gui.Animation/_QuinticEase.md)

• [SineEase](/Gui.Animation/_SineEase.md)
...
EasingFunctionBase has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *Ease(normalizedTime)* | Transforms normalized time to control the pace of an animation |
...
EasingFunctionBase has no events