Source: https://www.noesisengine.com/docs/Gui.Animation._LinearInt64KeyFrame.html

# LinearInt64KeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.linearint64keyframe.aspx)
...
Linear key frames like [LinearInt64KeyFrame](_LinearInt64KeyFrame.md) create a smooth, linear interpolation between values.
...
LinearInt64KeyFrame has no attached properties
...
LinearInt64KeyFrame has no events