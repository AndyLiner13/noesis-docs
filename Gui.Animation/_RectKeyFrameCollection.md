Source: https://www.noesisengine.com/docs/Gui.Animation._RectKeyFrameCollection.html

# RectKeyFrameCollection Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.animation.rectkeyframecollection)

Represents a collection of [RectKeyFrame](/Gui.Animation/_RectKeyFrame.md) objects.

This collection is used as part of a [RectAnimationUsingKeyFrames](/Gui.Animation/_RectAnimationUsingKeyFrames.md) to animate a Rect property value along a set of key frames.
...
RectKeyFrameCollection has no attached properties
...
RectKeyFrameCollection has no events