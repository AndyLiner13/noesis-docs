...
Represents a collection of [RectKeyFrame](_RectKeyFrame.md) objects.

This collection is used as part of a [RectAnimationUsingKeyFrames](_RectAnimationUsingKeyFrames.md) to animate a Rect property value along a set of key frames.
