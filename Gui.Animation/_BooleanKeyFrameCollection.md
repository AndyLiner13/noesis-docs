Source: https://www.noesisengine.com/docs/Gui.Animation._BooleanKeyFrameCollection.html

# BooleanKeyFrameCollection Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.animation.booleankeyframecollection)

Represents a collection of [BooleanKeyFrame](/Gui.Animation/_BooleanKeyFrame.md) objects.

This collection is used as part of a [BooleanAnimationUsingKeyFrames](/Gui.Animation/_BooleanAnimationUsingKeyFrames.md) to animate a Boolean property value along a set of key frames.
...
BooleanKeyFrameCollection has no attached properties
...
BooleanKeyFrameCollection has no events