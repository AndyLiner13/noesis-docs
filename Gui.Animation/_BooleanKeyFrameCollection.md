...
Represents a collection of [BooleanKeyFrame](_BooleanKeyFrame.md) objects.

This collection is used as part of a [BooleanAnimationUsingKeyFrames](_BooleanAnimationUsingKeyFrames.md) to animate a Boolean property value along a set of key frames.
