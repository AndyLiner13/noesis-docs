Source: https://www.noesisengine.com/docs/Gui.Animation._Point3DAnimationUsingKeyFrames.html

# Point3DAnimationUsingKeyFrames Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.point3danimationusingkeyframes.aspx)

Animates the value of a *Point3D* property along a set of *KeyFrames*.

A key frame animation's target values are defined by its KeyFrames property, which contains a collection of [Point3DKeyFrame](/Gui.Animation/_Point3DKeyFrame.md) objects. Each [Point3DKeyFrame](/Gui.Animation/_Point3DKeyFrame.md) defines a segment of the animation with its own target Value and [KeyTime](/Gui.Animation/_KeyTime.md). When the animation runs, it progresses from one key value to the next at the specified key times.

There are three types of [Point3DKeyFrame](/Gui.Animation/_Point3DKeyFrame.md) classes, one for each supported interpolation method: [LinearPoint3DKeyFrame](/Gui.Animation/_LinearPoint3DKeyFrame.md), [DiscretePoint3DKeyFrame](/Gui.Animation/_DiscretePoint3DKeyFrame.md), and [SplinePoint3DKeyFrame](/Gui.Animation/_SplinePoint3DKeyFrame.md).

Unlike a [Point3DAnimation](/Gui.Animation/_Point3DAnimation.md), a [Point3DAnimationUsingKeyFrames](/Gui.Animation/_Point3DAnimationUsingKeyFrames.md) can have more than two of target values. You can also control the interpolation method of individual [Point3DKeyFrame](/Gui.Animation/_Point3DKeyFrame.md) segments.
...
• [Point3DAnimationBase](/Gui.Animation/_Point3DAnimationBase.md)
...
## From [Point3DAnimationBase](/Gui.Animation/_Point3DAnimationBase.md)
