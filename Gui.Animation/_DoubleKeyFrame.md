...
Defines an animation segment with its own target value and interpolation method for a [DoubleAnimationUsingKeyFrames](_DoubleAnimationUsingKeyFrames.md).
...
• [DiscreteDoubleKeyFrame](_DiscreteDoubleKeyFrame.md)

• [EasingDoubleKeyFrame](_EasingDoubleKeyFrame.md)

• [LinearDoubleKeyFrame](_LinearDoubleKeyFrame.md)

• [SplineDoubleKeyFrame](_SplineDoubleKeyFrame.md)
