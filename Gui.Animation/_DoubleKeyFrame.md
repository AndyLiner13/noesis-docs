Source: https://www.noesisengine.com/docs/Gui.Animation._DoubleKeyFrame.html

# DoubleKeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.doublekeyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [DoubleAnimationUsingKeyFrames](/Gui.Animation/_DoubleAnimationUsingKeyFrames.md).
...
• [DiscreteDoubleKeyFrame](/Gui.Animation/_DiscreteDoubleKeyFrame.md)

• [EasingDoubleKeyFrame](/Gui.Animation/_EasingDoubleKeyFrame.md)

• [LinearDoubleKeyFrame](/Gui.Animation/_LinearDoubleKeyFrame.md)

• [SplineDoubleKeyFrame](/Gui.Animation/_SplineDoubleKeyFrame.md)
