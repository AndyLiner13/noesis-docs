...
Represents a collection of [StringKeyFrame](_StringKeyFrame.md) objects.

This collection is used as part of a [StringAnimationUsingKeyFrames](_StringAnimationUsingKeyFrames.md) to animate a String property value along a set of key frames.
