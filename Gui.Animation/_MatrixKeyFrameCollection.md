Source: https://www.noesisengine.com/docs/Gui.Animation._MatrixKeyFrameCollection.html

# MatrixKeyFrameCollection Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.animation.matrixkeyframecollection)

Represents a collection of [MatrixKeyFrame](/Gui.Animation/_MatrixKeyFrame.md) objects.

This collection is used as part of a [MatrixAnimationUsingKeyFrames](/Gui.Animation/_MatrixAnimationUsingKeyFrames.md) to animate a Matrix property value along a set of key frames.
...
MatrixKeyFrameCollection has no attached properties
...
MatrixKeyFrameCollection has no events