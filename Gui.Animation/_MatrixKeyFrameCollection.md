...
Represents a collection of [MatrixKeyFrame](_MatrixKeyFrame.md) objects.

This collection is used as part of a [MatrixAnimationUsingKeyFrames](_MatrixAnimationUsingKeyFrames.md) to animate a Matrix property value along a set of key frames.
