Source: https://www.noesisengine.com/docs/Gui.Animation._Point3DAnimationBase.html

# Point3DAnimationBase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.point3danimationbase.aspx)

Abstract class that, when implemented, animates a *Point3D* value.

Derive from a [Point3DAnimationBase](/Gui.Animation/_Point3DAnimationBase.md) class and implement the *GetCurrentValueCore* method. The *GetCurrentValueCore* method returns the current value of the animation. It takes three parameters: a suggested starting value, a suggested ending value, and an [AnimationClock](/Gui.Animation/_AnimationClock.md), which you use to determine the progress of the animation.

Because [Point3DAnimationBase](/Gui.Animation/_Point3DAnimationBase.md) class inherit from the [Freezable](/Gui.DependencySystem/_Freezable.md) class, you must also override *CreateInstanceCore* core to return a new instance of your class.
...
• [Point3DAnimation](/Gui.Animation/_Point3DAnimation.md)

• [Point3DAnimationUsingKeyFrames](/Gui.Animation/_Point3DAnimationUsingKeyFrames.md)
