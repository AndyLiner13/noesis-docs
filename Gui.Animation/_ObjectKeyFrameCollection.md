Source: https://www.noesisengine.com/docs/Gui.Animation._ObjectKeyFrameCollection.html

# ObjectKeyFrameCollection Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.animation.objectkeyframecollection)

Represents a collection of [ObjectKeyFrame](/Gui.Animation/_ObjectKeyFrame.md) objects.

This collection is used as part of an [ObjectAnimationUsingKeyFrames](/Gui.Animation/_ObjectAnimationUsingKeyFrames.md) to animate an Object property value along a set of key frames.
...
ObjectKeyFrameCollection has no attached properties
...
ObjectKeyFrameCollection has no events