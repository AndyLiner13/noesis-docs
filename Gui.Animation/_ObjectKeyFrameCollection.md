...
Represents a collection of [ObjectKeyFrame](_ObjectKeyFrame.md) objects.

This collection is used as part of an [ObjectAnimationUsingKeyFrames](_ObjectAnimationUsingKeyFrames.md) to animate an Object property value along a set of key frames.
