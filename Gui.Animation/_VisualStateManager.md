...
The [VisualStateManager](_VisualStateManager.md) enables you to specify states for a control, the appearance of a control when it is in a certain state, and when a control changes states.
...
| Name | Description |
| --- | --- |
| ● *CustomVisualStateManager* | Gets or sets the [VisualStateManager](_VisualStateManager.md) object that transitions between the states of a control |
| ● *VisualStateGroups* | Gets or sets a collection of [VisualStateGroup](_VisualStateGroup.md) objects |
