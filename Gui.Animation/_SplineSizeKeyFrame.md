Source: https://www.noesisengine.com/docs/Gui.Animation._SplineSizeKeyFrame.html

# SplineSizeKeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.splinesizekeyframe.aspx)
...
Spline key frames like [SplineSizeKeyFrame](_SplineSizeKeyFrame.md) creates a variable transition between values which is determined by the [KeySpline](_KeySpline.md) property. Splined interpolation can be used to achieve more realistic "real world" timing effects such as acceleration and deceleration.
...
SplineSizeKeyFrame has no attached properties
...
SplineSizeKeyFrame has no events