Source: https://www.noesisengine.com/docs/Gui.Animation._StringKeyFrame.html

# StringKeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.stringkeyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [StringAnimationUsingKeyFrames](/Gui.Animation/_StringAnimationUsingKeyFrames.md).
...
• [DiscreteStringKeyFrame](/Gui.Animation/_DiscreteStringKeyFrame.md)
...
StringKeyFrame has no attached properties
