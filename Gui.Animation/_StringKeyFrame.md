...
Defines an animation segment with its own target value and interpolation method for a [StringAnimationUsingKeyFrames](_StringAnimationUsingKeyFrames.md).
...
• [DiscreteStringKeyFrame](_DiscreteStringKeyFrame.md)
