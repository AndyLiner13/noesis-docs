...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.stringanimationusingkeyframes.aspx)

Animates the value of a String property along a set of KeyFrames. A key frame animation's target values are defined by its KeyFrames property, which contains a collection of [StringKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._StringKeyFrame.html) objects. Each [StringKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._StringKeyFrame.html) defines a segment of the animation with its own target Value and [KeyTime](https://www.noesisengine.com/docs/Gui.Animation._KeyTime.html). When the animation runs, it progresses from one key value to the next at the specified key times.
...
### From [StringAnimationBase](https://www.noesisengine.com/docs/Gui.Animation._StringAnimationBase.html)
