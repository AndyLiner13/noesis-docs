Source: https://www.noesisengine.com/docs/Gui.Animation._EasingColorKeyFrame.html

# EasingColorKeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.easingcolorkeyframe.aspx)

A class that enables you to associate easing functions with a [ColorAnimationUsingKeyFrames](/Gui.Animation/_ColorAnimationUsingKeyFrames.md) key frame animation.

For an example of using an object similar to this one, see [EasingDoubleKeyFrame](/Gui.Animation/_EasingDoubleKeyFrame.md).

This class is used as part of a [ColorKeyFrameCollection](/Gui.Animation/_ColorKeyFrameCollection.md) in conjunction with a [ColorAnimationUsingKeyFrames](/Gui.Animation/_ColorAnimationUsingKeyFrames.md) to animate a Color property value along a set of key frames. This [ColorKeyFrame](/Gui.Animation/_ColorKeyFrame.md) interpolates between the Color value of the previous key frame and its own value linearly with an easing function to produce its output value.
...
• [ColorKeyFrame](/Gui.Animation/_ColorKeyFrame.md)
...
## From [ColorKeyFrame](/Gui.Animation/_ColorKeyFrame.md)
...
EasingColorKeyFrame has no attached properties
...
EasingColorKeyFrame has no events