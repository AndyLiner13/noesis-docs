Source: https://www.noesisengine.com/docs/Gui.Animation._DoubleAnimation.html

# DoubleAnimation Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.doubleanimation.aspx)

Animates the value of a *Float* property between two target values using linear interpolation over a specified *Duration*.
