Source: https://www.noesisengine.com/docs/Gui.Animation._PowerEase.html

# PowerEase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.powerease.aspx)
...
| Name | Description |
| --- | --- |
| ● *Power* | Gets or sets the exponential power of the animation interpolation. For example, a value of 7 will create an animation interpolation curve that follows the formula f(t) = t7. |

● Dependency Property   ○ Reflection Property

## From [EasingFunctionBase](/Gui.Animation/_EasingFunctionBase.md)
...
PowerEase has no attached properties
