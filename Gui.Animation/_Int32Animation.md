Source: https://www.noesisengine.com/docs/Gui.Animation._Int32Animation.html

# Int32Animation Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.int32animation.aspx)

Animates the value of a *Int32* property between two target values using linear interpolation over a specified *Duration*.
