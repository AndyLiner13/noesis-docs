Source: https://www.noesisengine.com/docs/Gui.Animation._PointKeyFrame.html

# PointKeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.pointkeyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [PointAnimationUsingKeyFrames](/Gui.Animation/_PointAnimationUsingKeyFrames.md).
...
• [DiscretePointKeyFrame](/Gui.Animation/_DiscretePointKeyFrame.md)

• [EasingPointKeyFrame](/Gui.Animation/_EasingPointKeyFrame.md)

• [LinearPointKeyFrame](/Gui.Animation/_LinearPointKeyFrame.md)

• [SplinePointKeyFrame](/Gui.Animation/_SplinePointKeyFrame.md)
...
PointKeyFrame has no attached properties
