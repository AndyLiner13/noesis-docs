...
Defines an animation segment with its own target value and interpolation method for a [PointAnimationUsingKeyFrames](_PointAnimationUsingKeyFrames.md).
...
• [DiscretePointKeyFrame](_DiscretePointKeyFrame.md)

• [EasingPointKeyFrame](_EasingPointKeyFrame.md)

• [LinearPointKeyFrame](_LinearPointKeyFrame.md)

• [SplinePointKeyFrame](_SplinePointKeyFrame.md)
