...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.doublekeyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [DoubleAnimationUsingKeyFrames](https://www.noesisengine.com/docs/Gui.Animation._DoubleAnimationUsingKeyFrames.html).
...
- DoubleKeyFrame
  - [DiscreteDoubleKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._DiscreteDoubleKeyFrame.html)
  - [EasingDoubleKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._EasingDoubleKeyFrame.html)
  - [LinearDoubleKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._LinearDoubleKeyFrame.html)
  - [SplineDoubleKeyFrame](https://www.noesisengine.com/docs/Gui.Animation._SplineDoubleKeyFrame.html)
...
DoubleKeyFrame has no attached properties
