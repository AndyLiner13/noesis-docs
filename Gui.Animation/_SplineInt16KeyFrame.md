Source: https://www.noesisengine.com/docs/Gui.Animation._SplineInt16KeyFrame.html

# SplineInt16KeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.splineint16keyframe.aspx)

Animates from the *Int16* value of the previous key frame to its own *Value* using splined interpolation.

This class is used as part of a [Int16KeyFrameCollection](_Int16KeyFrameCollection.md) in conjunction with a [Int16AnimationUsingKeyFrames](_Int16AnimationUsingKeyFrames.md) to animate a Int16 property value along a set of key frames.
...
Spline key frames like [SplineInt16KeyFrame](_SplineInt16KeyFrame.md) creates a variable transition between values which is determined by the [KeySpline](_KeySpline.md) property. Splined interpolation can be used to achieve more realistic "real world" timing effects such as acceleration and deceleration.
...
SplineInt16KeyFrame has no attached properties
...
SplineInt16KeyFrame has no events