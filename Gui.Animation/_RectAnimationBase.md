Source: https://www.noesisengine.com/docs/Gui.Animation._RectAnimationBase.html

# RectAnimationBase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.rectanimationbase.aspx)

Abstract class that, when implemented, animates a *Rect* value.

Derive from a [RectAnimationBase](/Gui.Animation/_RectAnimationBase.md) class and implement the *GetCurrentValueCore* method. The *GetCurrentValueCore* method returns the current value of the animation. It takes three parameters: a suggested starting value, a suggested ending value, and an [AnimationClock](/Gui.Animation/_AnimationClock.md), which you use to determine the progress of the animation.

Because [RectAnimationBase](/Gui.Animation/_RectAnimationBase.md) class inherit from the [Freezable](/Gui.DependencySystem/_Freezable.md) class, you must also override *CreateInstanceCore* core to return a new instance of your class.
...
• [RectAnimation](/Gui.Animation/_RectAnimation.md)

• [RectAnimationUsingKeyFrames](/Gui.Animation/_RectAnimationUsingKeyFrames.md)
