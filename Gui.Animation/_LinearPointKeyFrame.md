Source: https://www.noesisengine.com/docs/Gui.Animation._LinearPointKeyFrame.html

# LinearPointKeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.linearpointkeyframe.aspx)
...
Linear key frames like [LinearPointKeyFrame](_LinearPointKeyFrame.md) create a smooth, linear interpolation between values.
...
LinearPointKeyFrame has no attached properties
...
LinearPointKeyFrame has no events