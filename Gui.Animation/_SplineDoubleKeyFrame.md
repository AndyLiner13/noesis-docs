Source: https://www.noesisengine.com/docs/Gui.Animation._SplineDoubleKeyFrame.html

# SplineDoubleKeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.splinedoublekeyframe.aspx)
...
Spline key frames like [SplineDoubleKeyFrame](_SplineDoubleKeyFrame.md) creates a variable transition between values which is determined by the [KeySpline](_KeySpline.md) property. Splined interpolation can be used to achieve more realistic "real world" timing effects such as acceleration and deceleration.
