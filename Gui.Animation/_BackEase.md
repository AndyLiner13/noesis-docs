Source: https://www.noesisengine.com/docs/Gui.Animation._BackEase.html

# BackEase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.backease.aspx)
...
| Name | Description |
| --- | --- |
| ● *Amplitude* | Gets or sets the amplitude of retraction associated with a [BackEase](/Gui.Animation/_BackEase.md) animation. |
...
BackEase has no attached properties
