...
Defines an animation segment with its own target value and interpolation method for a [ColorAnimationUsingKeyFrames](_ColorAnimationUsingKeyFrames.md).
...
• [DiscreteColorKeyFrame](_DiscreteColorKeyFrame.md)

• [EasingColorKeyFrame](_EasingColorKeyFrame.md)

• [LinearColorKeyFrame](_LinearColorKeyFrame.md)

• [SplineColorKeyFrame](_SplineColorKeyFrame.md)
