Source: https://www.noesisengine.com/docs/Gui.Animation._ColorKeyFrame.html

# ColorKeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.colorkeyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [ColorAnimationUsingKeyFrames](/Gui.Animation/_ColorAnimationUsingKeyFrames.md).
...
• [DiscreteColorKeyFrame](/Gui.Animation/_DiscreteColorKeyFrame.md)

• [EasingColorKeyFrame](/Gui.Animation/_EasingColorKeyFrame.md)

• [LinearColorKeyFrame](/Gui.Animation/_LinearColorKeyFrame.md)

• [SplineColorKeyFrame](/Gui.Animation/_SplineColorKeyFrame.md)
...
ColorKeyFrame has no attached properties
