...
Defines an animation segment with its own target value and interpolation method for a [BooleanAnimationUsingKeyFrames](_BooleanAnimationUsingKeyFrames.md).
...
• [DiscreteThicknessKeyFrame](_DiscreteThicknessKeyFrame.md)

• [EasingThicknessKeyFrame](_EasingThicknessKeyFrame.md)

• [LinearThicknessKeyFrame](_LinearThicknessKeyFrame.md)

• [SplineThicknessKeyFrame](_SplineThicknessKeyFrame.md)
