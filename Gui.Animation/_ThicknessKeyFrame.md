Source: https://www.noesisengine.com/docs/Gui.Animation._ThicknessKeyFrame.html

# ThicknessKeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.booleankeyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [BooleanAnimationUsingKeyFrames](/Gui.Animation/_BooleanAnimationUsingKeyFrames.md).
...
• [DiscreteThicknessKeyFrame](/Gui.Animation/_DiscreteThicknessKeyFrame.md)

• [EasingThicknessKeyFrame](/Gui.Animation/_EasingThicknessKeyFrame.md)

• [LinearThicknessKeyFrame](/Gui.Animation/_LinearThicknessKeyFrame.md)

• [SplineThicknessKeyFrame](/Gui.Animation/_SplineThicknessKeyFrame.md)
...
ThicknessKeyFrame has no attached properties
...
ThicknessKeyFrame has no events