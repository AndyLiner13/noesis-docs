...
Defines an animation segment with its own target value and interpolation method for a [SizeAnimationUsingKeyFrames](_SizeAnimationUsingKeyFrames.md).
...
• [DiscreteSizeKeyFrame](_DiscreteSizeKeyFrame.md)

• [EasingSizeKeyFrame](_EasingSizeKeyFrame.md)

• [LinearSizeKeyFrame](_LinearSizeKeyFrame.md)

• [SplineSizeKeyFrame](_SplineSizeKeyFrame.md)
