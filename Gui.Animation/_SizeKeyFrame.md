Source: https://www.noesisengine.com/docs/Gui.Animation._SizeKeyFrame.html

# SizeKeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.sizekeyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [SizeAnimationUsingKeyFrames](/Gui.Animation/_SizeAnimationUsingKeyFrames.md).
...
• [DiscreteSizeKeyFrame](/Gui.Animation/_DiscreteSizeKeyFrame.md)

• [EasingSizeKeyFrame](/Gui.Animation/_EasingSizeKeyFrame.md)

• [LinearSizeKeyFrame](/Gui.Animation/_LinearSizeKeyFrame.md)

• [SplineSizeKeyFrame](/Gui.Animation/_SplineSizeKeyFrame.md)
...
SizeKeyFrame has no attached properties
