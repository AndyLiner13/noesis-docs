Source: https://www.noesisengine.com/docs/Gui.Animation._Int64AnimationUsingKeyFrames.html

# Int64AnimationUsingKeyFrames Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.int64animationusingkeyframes.aspx)

Animates the value of a *Int64* property along a set of *KeyFrames*.

A key frame animation's target values are defined by its KeyFrames property, which contains a collection of [Int64KeyFrame](/Gui.Animation/_Int64KeyFrame.md) objects. Each [Int64KeyFrame](/Gui.Animation/_Int64KeyFrame.md) defines a segment of the animation with its own target Value and [KeyTime](/Gui.Animation/_KeyTime.md). When the animation runs, it progresses from one key value to the next at the specified key times.

There are three types of [Int64KeyFrame](/Gui.Animation/_Int64KeyFrame.md) classes, one for each supported interpolation method: [LinearInt64KeyFrame](/Gui.Animation/_LinearInt64KeyFrame.md), [DiscreteInt64KeyFrame](/Gui.Animation/_DiscreteInt64KeyFrame.md), and [SplineInt64KeyFrame](/Gui.Animation/_SplineInt64KeyFrame.md).

Unlike a [Int64Animation](/Gui.Animation/_Int64Animation.md), a [Int64AnimationUsingKeyFrames](/Gui.Animation/_Int64AnimationUsingKeyFrames.md) can have more than two of target values. You can also control the interpolation method of individual [Int64KeyFrame](/Gui.Animation/_Int64KeyFrame.md) segments.
...
• [Int64AnimationBase](/Gui.Animation/_Int64AnimationBase.md)
...
## From [Int64AnimationBase](/Gui.Animation/_Int64AnimationBase.md)
