...
A key frame animation's target values are defined by its KeyFrames property, which contains a collection of [Int64KeyFrame](_Int64KeyFrame.md) objects. Each [Int64KeyFrame](_Int64KeyFrame.md) defines a segment of the animation with its own target Value and [KeyTime](_KeyTime.md). When the animation runs, it progresses from one key value to the next at the specified key times.

There are three types of [Int64KeyFrame](_Int64KeyFrame.md) classes, one for each supported interpolation method: [LinearInt64KeyFrame](_LinearInt64KeyFrame.md), [DiscreteInt64KeyFrame](_DiscreteInt64KeyFrame.md), and [SplineInt64KeyFrame](_SplineInt64KeyFrame.md).

Unlike a [Int64Animation](_Int64Animation.md), a [Int64AnimationUsingKeyFrames](_Int64AnimationUsingKeyFrames.md) can have more than two of target values. You can also control the interpolation method of individual [Int64KeyFrame](_Int64KeyFrame.md) segments.
...
• [Int64AnimationBase](_Int64AnimationBase.md)
...
## From [Int64AnimationBase](_Int64AnimationBase.md)
