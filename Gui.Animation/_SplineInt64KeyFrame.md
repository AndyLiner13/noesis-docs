Source: https://www.noesisengine.com/docs/Gui.Animation._SplineInt64KeyFrame.html

# SplineInt64KeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.splineint64keyframe.aspx)
...
Spline key frames like [SplineInt64KeyFrame](_SplineInt64KeyFrame.md) creates a variable transition between values which is determined by the [KeySpline](_KeySpline.md) property. Splined interpolation can be used to achieve more realistic "real world" timing effects such as acceleration and deceleration.
...
SplineInt64KeyFrame has no attached properties
...
SplineInt64KeyFrame has no events