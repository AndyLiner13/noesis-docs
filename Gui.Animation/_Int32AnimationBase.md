...
Derive from a [Int32AnimationBase](_Int32AnimationBase.md) class and implement the *GetCurrentValueCore* method. The *GetCurrentValueCore* method returns the current value of the animation. It takes three parameters: a suggested starting value, a suggested ending value, and an [AnimationClock](_AnimationClock.md), which you use to determine the progress of the animation.

Because [Int32AnimationBase](_Int32AnimationBase.md) class inherit from the [Freezable](../Gui.DependencySystem/_Freezable.md) class, you must also override *CreateInstanceCore* core to return a new instance of your class.
...
• [Int32Animation](_Int32Animation.md)

• [Int32AnimationUsingKeyFrames](_Int32AnimationUsingKeyFrames.md)
