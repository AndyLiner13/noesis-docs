...
Defines an animation segment with its own target value and interpolation method for a [RectAnimationUsingKeyFrames](_RectAnimationUsingKeyFrames.md).
...
• [DiscreteRectKeyFrame](_DiscreteRectKeyFrame.md)

• [EasingRectKeyFrame](_EasingRectKeyFrame.md)

• [LinearRectKeyFrame](_LinearRectKeyFrame.md)

• [SplineRectKeyFrame](_SplineRectKeyFrame.md)
