Source: https://www.noesisengine.com/docs/Gui.Animation._RectKeyFrame.html

# RectKeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.rectkeyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [RectAnimationUsingKeyFrames](/Gui.Animation/_RectAnimationUsingKeyFrames.md).
...
• [DiscreteRectKeyFrame](/Gui.Animation/_DiscreteRectKeyFrame.md)

• [EasingRectKeyFrame](/Gui.Animation/_EasingRectKeyFrame.md)

• [LinearRectKeyFrame](/Gui.Animation/_LinearRectKeyFrame.md)

• [SplineRectKeyFrame](/Gui.Animation/_SplineRectKeyFrame.md)
...
RectKeyFrame has no attached properties
