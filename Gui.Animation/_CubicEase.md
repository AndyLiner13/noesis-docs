Source: https://www.noesisengine.com/docs/Gui.Animation._CubicEase.html

# CubicEase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.cubicease.aspx)
