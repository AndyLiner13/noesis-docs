Source: https://www.noesisengine.com/docs/Gui.Animation._LinearColorKeyFrame.html

# LinearColorKeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.linearcolorkeyframe.aspx)
...
Linear key frames like [LinearColorKeyFrame](_LinearColorKeyFrame.md) create a smooth, linear interpolation between values.
...
LinearColorKeyFrame has no attached properties
...
LinearColorKeyFrame has no events