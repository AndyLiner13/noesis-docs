...
A class that enables you to associate easing functions with a [Int32AnimationUsingKeyFrames](_Int32AnimationUsingKeyFrames.md) key frame animation.

For an example of using an object similar to this one, see [EasingDoubleKeyFrame](_EasingDoubleKeyFrame.md).

This class is used as part of an [Int32KeyFrameCollection](_Int32KeyFrameCollection.md) in conjunction with an [Int32AnimationUsingKeyFrames](_Int32AnimationUsingKeyFrames.md) to animate an Int32 property value along a set of key frames. This [Int32KeyFrame](_Int32KeyFrame.md) interpolates between the Int32 value of the previous key frame and its own value linearly with an easing function to produce its output value.
