Source: https://www.noesisengine.com/docs/Gui.Animation._EasingInt32KeyFrame.html

# EasingInt32KeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.easingint32keyframe.aspx)

A class that enables you to associate easing functions with a [Int32AnimationUsingKeyFrames](/Gui.Animation/_Int32AnimationUsingKeyFrames.md) key frame animation.

For an example of using an object similar to this one, see [EasingDoubleKeyFrame](/Gui.Animation/_EasingDoubleKeyFrame.md).

This class is used as part of an [Int32KeyFrameCollection](/Gui.Animation/_Int32KeyFrameCollection.md) in conjunction with an [Int32AnimationUsingKeyFrames](/Gui.Animation/_Int32AnimationUsingKeyFrames.md) to animate an Int32 property value along a set of key frames. This [Int32KeyFrame](/Gui.Animation/_Int32KeyFrame.md) interpolates between the Int32 value of the previous key frame and its own value linearly with an easing function to produce its output value.
...
EasingInt32KeyFrame has no attached properties
...
EasingInt32KeyFrame has no events