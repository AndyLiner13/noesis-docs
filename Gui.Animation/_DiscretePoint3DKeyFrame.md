...
This class is used as part of a [Point3DKeyFrameCollection](/Gui.Animation/_Point3DKeyFrameCollection.md) object in conjunction with a [Point3DAnimationUsingKeyFrames](/Gui.Animation/_Point3DAnimationUsingKeyFrames.md) object to animate a Point3D property value along a set of key frames.
