Source: https://www.noesisengine.com/docs/Gui.Animation._EasingInt64KeyFrame.html

# EasingInt64KeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.easingint64keyframe.aspx)

A class that enables you to associate easing functions with a [Int64AnimationUsingKeyFrames](/Gui.Animation/_Int64AnimationUsingKeyFrames.md) key frame animation.

For an example of using an object similar to this one, see [EasingDoubleKeyFrame](/Gui.Animation/_EasingDoubleKeyFrame.md).

This class is used as part of an [Int64KeyFrameCollection](/Gui.Animation/_Int64KeyFrameCollection.md) in conjunction with an [Int64AnimationUsingKeyFrames](/Gui.Animation/_Int64AnimationUsingKeyFrames.md) to animate an Int64 property value along a set of key frames. This [Int64KeyFrame](/Gui.Animation/_Int64KeyFrame.md) interpolates between the Int64 value of the previous key frame and its own value linearly with an easing function to produce its output value.
...
EasingInt64KeyFrame has no attached properties
...
EasingInt64KeyFrame has no events