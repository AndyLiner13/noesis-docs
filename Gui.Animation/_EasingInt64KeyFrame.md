...
A class that enables you to associate easing functions with a [Int64AnimationUsingKeyFrames](_Int64AnimationUsingKeyFrames.md) key frame animation.

For an example of using an object similar to this one, see [EasingDoubleKeyFrame](_EasingDoubleKeyFrame.md).

This class is used as part of an [Int64KeyFrameCollection](_Int64KeyFrameCollection.md) in conjunction with an [Int64AnimationUsingKeyFrames](_Int64AnimationUsingKeyFrames.md) to animate an Int64 property value along a set of key frames. This [Int64KeyFrame](_Int64KeyFrame.md) interpolates between the Int64 value of the previous key frame and its own value linearly with an easing function to produce its output value.
