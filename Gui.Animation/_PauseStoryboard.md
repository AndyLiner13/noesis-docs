Source: https://www.noesisengine.com/docs/Gui.Animation._PauseStoryboard.html

# PauseStoryboard Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.pausestoryboard.aspx)

A trigger action that pauses a [Storyboard](/Gui.Animation/_Storyboard.md).
...
PauseStoryboard has no attached properties
