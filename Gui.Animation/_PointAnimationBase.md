Source: https://www.noesisengine.com/docs/Gui.Animation._PointAnimationBase.html

# PointAnimationBase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.pointanimationbase.aspx)

Abstract class that, when implemented, animates a *Point* value.

Derive from a [PointAnimationBase](/Gui.Animation/_PointAnimationBase.md) class and implement the *GetCurrentValueCore* method. The *GetCurrentValueCore* method returns the current value of the animation. It takes three parameters: a suggested starting value, a suggested ending value, and an [AnimationClock](/Gui.Animation/_AnimationClock.md), which you use to determine the progress of the animation.

Because [PointAnimationBase](/Gui.Animation/_PointAnimationBase.md) class inherit from the [Freezable](/Gui.DependencySystem/_Freezable.md) class, you must also override *CreateInstanceCore* core to return a new instance of your class.
...
• [PointAnimation](/Gui.Animation/_PointAnimation.md)

• [PointAnimationUsingKeyFrames](/Gui.Animation/_PointAnimationUsingKeyFrames.md)
