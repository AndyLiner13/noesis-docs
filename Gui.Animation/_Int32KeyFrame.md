...
Defines an animation segment with its own target value and interpolation method for a [Int32AnimationUsingKeyFrames](_Int32AnimationUsingKeyFrames.md).
...
• [DiscreteInt32KeyFrame](_DiscreteInt32KeyFrame.md)

• [EasingInt32KeyFrame](_EasingInt32KeyFrame.md)

• [LinearInt32KeyFrame](_LinearInt32KeyFrame.md)

• [SplineInt32KeyFrame](_SplineInt32KeyFrame.md)
