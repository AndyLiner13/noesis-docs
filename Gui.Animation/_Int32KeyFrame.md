Source: https://www.noesisengine.com/docs/Gui.Animation._Int32KeyFrame.html

# Int32KeyFrame Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.int32keyframe.aspx)

Defines an animation segment with its own target value and interpolation method for a [Int32AnimationUsingKeyFrames](/Gui.Animation/_Int32AnimationUsingKeyFrames.md).
...
• [DiscreteInt32KeyFrame](/Gui.Animation/_DiscreteInt32KeyFrame.md)

• [EasingInt32KeyFrame](/Gui.Animation/_EasingInt32KeyFrame.md)

• [LinearInt32KeyFrame](/Gui.Animation/_LinearInt32KeyFrame.md)

• [SplineInt32KeyFrame](/Gui.Animation/_SplineInt32KeyFrame.md)
...
Int32KeyFrame has no attached properties
