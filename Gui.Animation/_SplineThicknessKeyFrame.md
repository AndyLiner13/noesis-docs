Source: https://www.noesisengine.com/docs/Gui.Animation._SplineThicknessKeyFrame.html

# SplineThicknessKeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.splinethicknesskeyframe.aspx)

Animates from the *Thickness* value of the previous key frame to its own *Value* using splined interpolation.

This class is used as part of a [ThicknessKeyFrameCollection](_ThicknessKeyFrameCollection.md) in conjunction with a [ThicknessAnimationUsingKeyFrames](_ThicknessAnimationUsingKeyFrames.md) to animate a Thickness property value along a set of key frames.
...
Spline key frames like [SplineThicknessKeyFrame](_SplineThicknessKeyFrame.md) creates a variable transition between values which is determined by the [KeySpline](_KeySpline.md) property. Splined interpolation can be used to achieve more realistic "real world" timing effects such as acceleration and deceleration.
...
SplineThicknessKeyFrame has no attached properties
...
SplineThicknessKeyFrame has no events