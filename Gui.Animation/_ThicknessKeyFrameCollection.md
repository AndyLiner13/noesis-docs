Source: https://www.noesisengine.com/docs/Gui.Animation._ThicknessKeyFrameCollection.html

# ThicknessKeyFrameCollection Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.animation.thicknesskeyframecollection)

Represents a collection of [ThicknessKeyFrame](/Gui.Animation/_ThicknessKeyFrame.md) objects.

This collection is used as part of a [ThicknessAnimationUsingKeyFrames](/Gui.Animation/_ThicknessAnimationUsingKeyFrames.md) to animate a Thickness property value along a set of key frames.
