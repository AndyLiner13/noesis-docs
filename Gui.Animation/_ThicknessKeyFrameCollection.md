...
Represents a collection of [ThicknessKeyFrame](_ThicknessKeyFrame.md) objects.

This collection is used as part of a [ThicknessAnimationUsingKeyFrames](_ThicknessAnimationUsingKeyFrames.md) to animate a Thickness property value along a set of key frames.
