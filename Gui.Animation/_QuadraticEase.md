Source: https://www.noesisengine.com/docs/Gui.Animation._QuadraticEase.html

# QuadraticEase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.quadraticease.aspx)
...
QuadraticEase has no attached properties
