Source: https://www.noesisengine.com/docs/Gui.Animation._SizeKeyFrameCollection.html

# SizeKeyFrameCollection Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.animation.sizekeyframecollection)

Represents a collection of [SizeKeyFrame](/Gui.Animation/_SizeKeyFrame.md) objects.

This collection is used as part of a [SizeAnimationUsingKeyFrames](/Gui.Animation/_SizeAnimationUsingKeyFrames.md) to animate a Size property value along a set of key frames.
...
SizeKeyFrameCollection has no attached properties
...
SizeKeyFrameCollection has no events