...
Represents a collection of [SizeKeyFrame](_SizeKeyFrame.md) objects.

This collection is used as part of a [SizeAnimationUsingKeyFrames](_SizeAnimationUsingKeyFrames.md) to animate a Size property value along a set of key frames.
