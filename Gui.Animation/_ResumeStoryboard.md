Source: https://www.noesisengine.com/docs/Gui.Animation._ResumeStoryboard.html

# ResumeStoryboard Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.resumestoryboard.aspx)

A trigger action that resumes a paused [Storyboard](/Gui.Animation/_Storyboard.md).
...
• [ControllableStoryboardAction](/Gui.Animation/_ControllableStoryboardAction.md)

• *ResumeStoryboard*

# Properties

## From [ControllableStoryboardAction](/Gui.Animation/_ControllableStoryboardAction.md)

| Name | Description |
| --- | --- |
| ○ *BeginStoryboardName* | Gets or sets the *Name* of the [BeginStoryboard](/Gui.Animation/_BeginStoryboard.md) that began the [Storyboard](/Gui.Animation/_Storyboard.md) you want to interactively control |
...
ResumeStoryboard has no attached properties
...
ResumeStoryboard has no events