Source: https://www.noesisengine.com/docs/Gui.Animation._LinearInt32KeyFrame.html

# LinearInt32KeyFrame Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.linearint32keyframe.aspx)
...
Linear key frames like [LinearInt32KeyFrame](_LinearInt32KeyFrame.md) create a smooth, linear interpolation between values.
...
LinearInt32KeyFrame has no attached properties
...
LinearInt32KeyFrame has no events