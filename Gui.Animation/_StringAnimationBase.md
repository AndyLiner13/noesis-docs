...
Derive from a [StringAnimationBase](_StringAnimationBase.md) class and implement the *GetCurrentValueCore* method. The *GetCurrentValueCore* method returns the current value of the animation. It takes three parameters: a suggested starting value, a suggested ending value, and an [AnimationClock](_AnimationClock.md), which you use to determine the progress of the animation.

Because [StringAnimationBase](_StringAnimationBase.md) class inherit from the [Freezable](../Gui.DependencySystem/_Freezable.md) class, you must also override *CreateInstanceCore* core to return a new instance of your class.
...
• [StringAnimationUsingKeyFrames](_StringAnimationUsingKeyFrames.md)
