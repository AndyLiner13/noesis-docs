Source: https://www.noesisengine.com/docs/Gui.Animation._Int32AnimationUsingKeyFrames.html

# Int32AnimationUsingKeyFrames Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.int32animationusingkeyframes.aspx)

Animates the value of a *Int32* property along a set of *KeyFrames*.

A key frame animation's target values are defined by its KeyFrames property, which contains a collection of [Int32KeyFrame](/Gui.Animation/_Int32KeyFrame.md) objects. Each [Int32KeyFrame](/Gui.Animation/_Int32KeyFrame.md) defines a segment of the animation with its own target Value and [KeyTime](/Gui.Animation/_KeyTime.md). When the animation runs, it progresses from one key value to the next at the specified key times.

There are three types of [Int32KeyFrame](/Gui.Animation/_Int32KeyFrame.md) classes, one for each supported interpolation method: [LinearInt32KeyFrame](/Gui.Animation/_LinearInt32KeyFrame.md), [DiscreteInt32KeyFrame](/Gui.Animation/_DiscreteInt32KeyFrame.md), and [SplineInt32KeyFrame](/Gui.Animation/_SplineInt32KeyFrame.md).

Unlike a [Int32Animation](/Gui.Animation/_Int32Animation.md), a [Int32AnimationUsingKeyFrames](/Gui.Animation/_Int32AnimationUsingKeyFrames.md) can have more than two of target values. You can also control the interpolation method of individual [Int32KeyFrame](/Gui.Animation/_Int32KeyFrame.md) segments.
...
• [Int32AnimationBase](/Gui.Animation/_Int32AnimationBase.md)
...
## From [Int32AnimationBase](/Gui.Animation/_Int32AnimationBase.md)
