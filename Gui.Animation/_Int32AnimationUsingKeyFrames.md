...
A key frame animation's target values are defined by its KeyFrames property, which contains a collection of [Int32KeyFrame](_Int32KeyFrame.md) objects. Each [Int32KeyFrame](_Int32KeyFrame.md) defines a segment of the animation with its own target Value and [KeyTime](_KeyTime.md). When the animation runs, it progresses from one key value to the next at the specified key times.

There are three types of [Int32KeyFrame](_Int32KeyFrame.md) classes, one for each supported interpolation method: [LinearInt32KeyFrame](_LinearInt32KeyFrame.md), [DiscreteInt32KeyFrame](_DiscreteInt32KeyFrame.md), and [SplineInt32KeyFrame](_SplineInt32KeyFrame.md).

Unlike a [Int32Animation](_Int32Animation.md), a [Int32AnimationUsingKeyFrames](_Int32AnimationUsingKeyFrames.md) can have more than two of target values. You can also control the interpolation method of individual [Int32KeyFrame](_Int32KeyFrame.md) segments.
...
• [Int32AnimationBase](_Int32AnimationBase.md)
...
## From [Int32AnimationBase](_Int32AnimationBase.md)
