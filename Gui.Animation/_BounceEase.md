Source: https://www.noesisengine.com/docs/Gui.Animation._BounceEase.html

# BounceEase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.bounceease.aspx)
...
BounceEase has no attached properties
