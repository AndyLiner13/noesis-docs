Source: https://www.noesisengine.com/docs/Gui.Animation._ThicknessAnimation.html

# ThicknessAnimation Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.thicknessanimation.aspx)

Animates the value of a *Thickness* property between two target values using linear interpolationover a specified *Duration*.
