...
Represents a collection of [ColorKeyFrame](_ColorKeyFrame.md) objects.

This collection is used as part of a [ColorAnimationUsingKeyFrames](_ColorAnimationUsingKeyFrames.md) to animate a Color property value along a set of key frames.
