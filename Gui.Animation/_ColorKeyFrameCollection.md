Source: https://www.noesisengine.com/docs/Gui.Animation._ColorKeyFrameCollection.html

# ColorKeyFrameCollection Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.animation.colorkeyframecollection)

Represents a collection of [ColorKeyFrame](/Gui.Animation/_ColorKeyFrame.md) objects.

This collection is used as part of a [ColorAnimationUsingKeyFrames](/Gui.Animation/_ColorAnimationUsingKeyFrames.md) to animate a Color property value along a set of key frames.
...
ColorKeyFrameCollection has no attached properties
...
ColorKeyFrameCollection has no events