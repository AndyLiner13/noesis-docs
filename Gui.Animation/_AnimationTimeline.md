Source: https://www.noesisengine.com/docs/Gui.Animation._AnimationTimeline.html

# AnimationTimeline Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.animationtimeline.aspx)
...
• [BooleanAnimationBase](/Gui.Animation/_BooleanAnimationBase.md)
...
• [MatrixAnimationBase](/Gui.Animation/_MatrixAnimationBase.md)

• [ObjectAnimationBase](/Gui.Animation/_ObjectAnimationBase.md)
...
• [StringAnimationBase](/Gui.Animation/_StringAnimationBase.md)
