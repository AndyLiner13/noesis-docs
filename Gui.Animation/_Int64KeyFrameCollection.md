...
Represents a collection of [Int64KeyFrame](_Int64KeyFrame.md) objects.

This collection is used as part of a [Int64AnimationUsingKeyFrames](_Int64AnimationUsingKeyFrames.md) to animate a Int64 property value along a set of key frames.
