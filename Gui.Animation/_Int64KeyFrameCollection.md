Source: https://www.noesisengine.com/docs/Gui.Animation._Int64KeyFrameCollection.html

# Int64KeyFrameCollection Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.animation.int64keyframecollection)

Represents a collection of [Int64KeyFrame](/Gui.Animation/_Int64KeyFrame.md) objects.

This collection is used as part of a [Int64AnimationUsingKeyFrames](/Gui.Animation/_Int64AnimationUsingKeyFrames.md) to animate a Int64 property value along a set of key frames.
...
Int64KeyFrameCollection has no attached properties
...
Int64KeyFrameCollection has no events