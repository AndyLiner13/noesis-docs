Source: https://www.noesisengine.com/docs/App.Shaders._DirectionalBlurEffect.html

# DirectionalBlurEffect Class
...
The directional blur effect is similar to [BlurEffect](../Gui.Core/_BlurEffect.md), except you can skew the blur in a particular direction. You can use this effect to make an image look as if it is in motion or to emphasize an animated image.
...
![DirectionalBlur.jpg](https://www.noesisengine.com/docs/DirectionalBlur.jpg)
...
• [ShaderEffect](../Gui.Core/_ShaderEffect.md)
...
| Name | Description |
| --- | --- |
| ● *Angle* | Gets or sets the angle of the blur relative to the x-axis, in the counterclockwise direction. The units are specified in degrees |
| ● *Radius* | Gets or sets the amount of blur to be applied to the image |
...
DirectionalBlurEffect has no attached properties
...
DirectionalBlurEffect has no events