Source: https://www.noesisengine.com/docs/App.Shaders._PinchEffect.html

# PinchEffect Class

## namespace [NoesisApp](../Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

[Effect](../Gui.Core/_Effect.md) to warp or pinch a specific area in a visual.
...
![Pinch.jpg](https://www.noesisengine.com/docs/Pinch.jpg)
...
| Name | Description |
| --- | --- |
| ● *Amount* | Gets or sets the intensity of the pinch effect |
| ● *Center* | Gets or sets the origin of the pinch effect in pixels |
| ● *Radius* | Gets or sets the radius of the pinch effect in pixels |
...
PinchEffect has no attached properties
