Source: https://www.noesisengine.com/docs/App.Shaders._WavesBrush.html

# WavesBrush Class

## namespace [NoesisApp](../Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

[BrushShader](../Gui.Core/_BrushShader.md) that paints a PSP wavy background effect.
...
![Waves.jpg](https://www.noesisengine.com/docs/Waves.jpg)
...
WavesBrush has no attached properties
