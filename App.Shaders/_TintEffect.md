Source: https://www.noesisengine.com/docs/App.Shaders._TintEffect.html
...
![Tint.jpg](https://www.noesisengine.com/docs/Tint.jpg)
...
| Name | Description |
| --- | --- |
| ● *Color* | Gets or Sets the color used to multiply the source image |
...
TintEffect has no attached properties
