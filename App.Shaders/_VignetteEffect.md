Source: https://www.noesisengine.com/docs/App.Shaders._VignetteEffect.html
...
![Vignette.jpg](https://www.noesisengine.com/docs/Vignette.jpg)
...
| Name | Description |
| --- | --- |
| ● *Color* | Gets or sets the RGB tripplet that specifies the color to fade the image's edges to |
| ● *Size* | Gets or sets a float value that specifies the size of the vignette region as a percentage of the full image region |
| ● *Strength* | Gets or sets a float value that specifies how much the vignette color bleeds in for a given transition size |
...
VignetteEffect has no attached properties
