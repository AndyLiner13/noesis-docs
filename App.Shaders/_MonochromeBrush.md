Source: https://www.noesisengine.com/docs/App.Shaders._MonochromeBrush.html

# MonochromeBrush Class

## namespace [NoesisApp](../Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

[BrushShader](../Gui.Core/_BrushShader.md) that turns an image into a monochrome color
...
![Monochrome.jpg](https://www.noesisengine.com/docs/Monochrome.jpg)
...
MonochromeBrush has no attached properties
