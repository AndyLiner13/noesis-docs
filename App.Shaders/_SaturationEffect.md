Source: https://www.noesisengine.com/docs/App.Shaders._SaturationEffect.html
...
![Saturation.jpg](https://www.noesisengine.com/docs/Saturation.jpg)
...
| Name | Description |
| --- | --- |
| ● *Saturation* | Gets or sets the saturation of the image. You can set the saturation to a value between 0 and 1. If you set it to 1 the output image is fully saturated. If you set it to 0 the output image is monochrome |
...
SaturationEffect has no attached properties
...
SaturationEffect has no events