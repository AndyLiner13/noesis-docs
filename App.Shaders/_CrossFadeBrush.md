Source: https://www.noesisengine.com/docs/App.Shaders._CrossFadeBrush.html

# CrossFadeBrush Class
...
![CrossFade.jpg](https://www.noesisengine.com/docs/CrossFade.jpg)
...
| Name | Description |
| --- | --- |
| ● *Source* | Gets or sets the source image |
| ● *Weight* | Gets or sets how much to weigh the source image color values |
...
CrossFadeBrush has no attached properties
