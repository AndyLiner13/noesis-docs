Source: https://www.noesisengine.com/docs/App.Interactivity._StoryboardCompletedTrigger.html

# StoryboardCompletedTrigger Class

## namespace [NoesisApp](../Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

A trigger that listens for the completion of a [Storyboard](../Gui.Animation/_Storyboard.md).
...
• [StoryboardTrigger](_StoryboardTrigger.md)

• *StoryboardCompletedTrigger*

# Properties

## From [StoryboardTrigger](_StoryboardTrigger.md)

| Name | Description |
| --- | --- |
| ● *Storyboard* | Gets or sets the targeted storyboard |
...
StoryboardCompletedTrigger has no attached properties
