...
| Property | Description |
|----------|-------------|
| Duration | Gets or sets the duration of the animation that will occur when the ChangePropertyAction is invoked. If the duration is unset, no animation will be applied |
