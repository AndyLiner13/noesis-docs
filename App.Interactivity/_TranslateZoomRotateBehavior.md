Source: https://www.noesisengine.com/docs/App.Interactivity._TranslateZoomRotateBehavior.html
...
| ● *SupportedGestures* | Gets or sets a value specifying wich zooming and translation variants to support |
| ● *TranslateFriction* | Gets or sets a number describing the rate at which the translation will decrease |
| ● *WheelSensitivity* | Gets or sets the sensitivity factor used to zoom using mouse wheel. Default value is 1.0f. |
...
TranslateZoomRotateBehavior has no attached properties
