...
• [TargetedTriggerActionT](_TargetedTriggerActionT.md)
...
| Name | Description |
| --- | --- |
| ● *Duration* | Gets or sets the duration of the animation that will occur when the [ChangePropertyAction](_ChangePropertyAction.md) is invoked. If the duration is unset, no animation will be applied |
