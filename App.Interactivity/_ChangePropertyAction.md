Source: https://www.noesisengine.com/docs/App.Interactivity._ChangePropertyAction.html
...
• [TargetedTriggerActionT](/App.Interactivity/_TargetedTriggerActionT.md)
...
| Name | Description |
| --- | --- |
| ● *Duration* | Gets or sets the duration of the animation that will occur when the [ChangePropertyAction](/App.Interactivity/_ChangePropertyAction.md) is invoked. If the duration is unset, no animation will be applied |
| ● *Increment* | Increment by *Value* if true and property can be incremented; otherwise set value directly |
...
| Name | Description |
| --- | --- |
| ● *TargetName* | Gets or sets the name of the object this action targets |
...
ChangePropertyAction has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *GetPropertyName()* | Gets or sets the name of the property to change |
...
ChangePropertyAction has no events