Source: https://www.noesisengine.com/docs/App.Interactivity._TimerTrigger.html
...
• [EventTriggerBase](/App.Interactivity/_EventTriggerBase.md)

• [EventTriggerBaseT](/App.Interactivity/_EventTriggerBaseT.md)

• [EventTrigger](/App.Interactivity/_EventTrigger.md)
...
| Name | Description |
| --- | --- |
| ● *MillisecondsPerTick* | Gets or sets the number of milliseconds to wait between ticks |
| ● *TotalTicks* | Gets or sets the total number of ticks to be fired before the trigger is finished |

● Dependency Property   ○ Reflection Property

## From [EventTrigger](/App.Interactivity/_EventTrigger.md)

| Name | Description |
| --- | --- |
| ● *EventName* | Gets or sets the name of the event to listen for |

● Dependency Property   ○ Reflection Property

## From [EventTriggerBase](/App.Interactivity/_EventTriggerBase.md)

| Name | Description |
| --- | --- |
| ● *SourceName* | Gets or sets the name of the object this trigger listens for as source |
| ● *SourceObject* | Gets or sets the source object |
...
TimerTrigger has no attached properties
