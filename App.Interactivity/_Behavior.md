Source: https://www.noesisengine.com/docs/App.Interactivity._Behavior.html

# Behavior Class

## namespace [NoesisApp](/Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

Represents the base class for specifying *Behaviors* for a [DependencyObject](/Gui.DependencySystem/_DependencyObject.md).
...
Behavior has no attached properties
