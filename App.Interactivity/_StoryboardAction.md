Source: https://www.noesisengine.com/docs/App.Interactivity._StoryboardAction.html

# StoryboardAction Class

## namespace [NoesisApp](../Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

An abstract action class that provides the ability to target a [Storyboard](../Gui.Animation/_Storyboard.md).
...
• [ControlStoryboardAction](_ControlStoryboardAction.md)
...
StoryboardAction has no attached properties
...
StoryboardAction has no events