Source: https://www.noesisengine.com/docs/App.Interactivity._ConditionalExpression.html
...
| Name | Description |
| --- | --- |
| ● *Conditions* | Returns the *Conditions* collection |
| ● *ForwardChaining* | Gets or sets forward chaining for the conditions If forward chaining is set to *And*, all conditions must be met If forward chaining is set to *Or*, only one condition must be met |
...
ConditionalExpression has no attached properties
