...
Represents one ternary condition: *left operand*, *operator*, *right operand*. Used as condition in the list of conditions on a [ConditionalExpression](_ConditionalExpression.md).
