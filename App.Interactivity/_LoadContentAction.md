Source: https://www.noesisengine.com/docs/App.Interactivity._LoadContentAction.html

# LoadContentAction Class

## namespace [NoesisApp](/Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

An action that will set the Content of the target [ContentControl](/Gui.Core/_ContentControl.md) by loading a xaml.
...
LoadContentAction has no attached properties
...
LoadContentAction has no events