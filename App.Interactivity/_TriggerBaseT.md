...
Templatized base class for [TriggerBase](/App.Interactivity/_TriggerBase.md).
...
• [DataEventTrigger](/App.Interactivity/_DataEventTrigger.md)

• [GamepadTrigger](/App.Interactivity/_GamepadTrigger.md)

• [KeyTrigger](/App.Interactivity/_KeyTrigger.md)
