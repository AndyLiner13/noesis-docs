Source: https://www.noesisengine.com/docs/App.Interactivity._TriggerBaseT.html

# TriggerBaseT Class

## namespace [NoesisApp](../Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

Templatized base class for [TriggerBase](_TriggerBase.md).
...
• [DataEventTrigger](_DataEventTrigger.md)

• [GamepadTrigger](_GamepadTrigger.md)

• [KeyTrigger](_KeyTrigger.md)

• [PropertyChangedTrigger](_PropertyChangedTrigger.md)
...
TriggerBaseT has no attached properties
