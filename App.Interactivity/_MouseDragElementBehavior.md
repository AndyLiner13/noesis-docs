Source: https://www.noesisengine.com/docs/App.Interactivity._MouseDragElementBehavior.html
...
| Name | Description |
| --- | --- |
| ● *ConstrainToParentBounds* | Gets or sets a value indicating whether the dragged element is constrained to stay within the bounds of its Parent container |
| ● *X* | Gets or sets the X position of the dragged element, relative to the left of the root element |
| ● *Y* | Gets or sets the Y position of the dragged element, relative to the top of the root element |
...
MouseDragElementBehavior has no attached properties
