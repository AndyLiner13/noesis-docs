...
| ● *HandleWhenFired* | Indicates if [GamepadTrigger](/App.Interactivity/_GamepadTrigger.md) should set gamepad button event as handled when the trigger invokes its actions |
