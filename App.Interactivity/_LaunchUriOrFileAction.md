Source: https://www.noesisengine.com/docs/App.Interactivity._LaunchUriOrFileAction.html
...
| Name | Description |
| --- | --- |
| ● *Path* | Gets or sets the file or uri to open |
...
LaunchUriOrFileAction has no attached properties
...
LaunchUriOrFileAction has no events