Source: https://www.noesisengine.com/docs/App.Interactivity._CollectionSortBehavior.html

# CollectionSortBehavior Class
...
| Name | Description |
| --- | --- |
| ● *Comparer* | Gets or sets the comparer object used to sort the collection |
| ● *ItemsSource* | Gets or sets the collection of items to be sorted |
| ● *SortedItems* | Gets the sorted collection of items |
...
CollectionSortBehavior has no attached properties
...
CollectionSortBehavior has no events