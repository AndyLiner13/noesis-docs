Source: https://www.noesisengine.com/docs/App.Interactivity._CollectionFilterBehavior.html

# CollectionFilterBehavior Class
...
| Name | Description |
| --- | --- |
| ● *FilteredItems* | Gets the filtered collection of items |
| ● *IsEnabled* | Gets or sets a value indicating whether this behavior is active. When activated a full filter of the source collection is made. This is useful to disable the behavior when performing lots of updates on the source collection |
| ● *ItemsSource* | Gets or sets the collection of items to be filtered |
| ● *Predicate* | Gets or sets the predicate object used to filter the collection |
...
CollectionFilterBehavior has no attached properties
...
CollectionFilterBehavior has no events