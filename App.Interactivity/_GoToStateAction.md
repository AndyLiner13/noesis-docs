Source: https://www.noesisengine.com/docs/App.Interactivity._GoToStateAction.html

# GoToStateAction Class

## namespace [NoesisApp](/Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

An action that will transition a [FrameworkElement](/Gui.Core/_FrameworkElement.md) to a specified [VisualState](/Gui.Animation/_VisualState.md) when invoked.
...
| Name | Description |
| --- | --- |
| ● *StateName* | Gets or sets the name of the visual state |
| ● *UseTransitions* | Determines whether or not to use a [VisualTransition](/Gui.Animation/_VisualTransition.md) to transition between states |
...
GoToStateAction has no attached properties
