Source: https://www.noesisengine.com/docs/App.Interactivity._MoveFocusAction.html

# MoveFocusAction Class
...
| Name | Description |
| --- | --- |
| ● *Direction* | Gets or sets the direction to look for the next control to get focus. |
| ● *Engage* | Gets or sets a value indicating if control should be engaged when getting the focus. Default value is true. |
...
MoveFocusAction has no attached properties
