Source: https://www.noesisengine.com/docs/App.Interactivity._ControlStoryboardAction.html
...
• [StoryboardAction](/App.Interactivity/_StoryboardAction.md)
...
| Name | Description |
| --- | --- |
| ● *ControlStoryboardOption* | Gets or sets the action to be executed on the target [Storyboard](/Gui.Animation/_Storyboard.md): Play, Stop, TogglePlayPause, Pause, Resume, or SkipToFill. Default value is Play |

● Dependency Property   ○ Reflection Property

## From [StoryboardAction](/App.Interactivity/_StoryboardAction.md)

| Name | Description |
| --- | --- |
| ● *Storyboard* | Gets or sets the targeted [Storyboard](/Gui.Animation/_Storyboard.md) |
...
ControlStoryboardAction has no attached properties
...
| Name | Description |
| --- | --- |
|  *FindStoryboardTarget(storyboard, associatedObject)* | Returns the element that is used as target to interact with the [Storyboard](/Gui.Animation/_Storyboard.md) |
...
ControlStoryboardAction has no events