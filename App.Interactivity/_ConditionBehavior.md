Source: https://www.noesisengine.com/docs/App.Interactivity._ConditionBehavior.html

# ConditionBehavior Class
...
| Name | Description |
| --- | --- |
| ● *Condition* | Gets or sets the Conditon object on the behavior |
...
ConditionBehavior has no attached properties
...
ConditionBehavior has no events