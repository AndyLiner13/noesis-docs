Source: https://www.noesisengine.com/docs/App.Interactivity._StoryboardTrigger.html

# StoryboardTrigger Class

## namespace [NoesisApp](../Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

An abstract trigger class that provides the ability to target a [Storyboard](../Gui.Animation/_Storyboard.md).
...
• [StoryboardCompletedTrigger](_StoryboardCompletedTrigger.md)
...
StoryboardTrigger has no attached properties
