Source: https://www.noesisengine.com/docs/App.Interactivity._TriggerActionT.html

# TriggerActionT Class

## namespace [NoesisApp](/Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

Templatized base class for [TriggerAction](/App.Interactivity/_TriggerAction.md).
...
• [InvokeCommandAction](/App.Interactivity/_InvokeCommandAction.md)

• [LaunchUriOrFileAction](/App.Interactivity/_LaunchUriOrFileAction.md)

• [MoveFocusAction](/App.Interactivity/_MoveFocusAction.md)

• [PlaySoundAction](/App.Interactivity/_PlaySoundAction.md)

• [SelectAction](/App.Interactivity/_SelectAction.md)

• [SelectAllAction](/App.Interactivity/_SelectAllAction.md)
