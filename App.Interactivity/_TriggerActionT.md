...
Templatized base class for [TriggerAction](_TriggerAction.md).
...
• [InvokeCommandAction](_InvokeCommandAction.md)

• [LaunchUriOrFileAction](_LaunchUriOrFileAction.md)

• [MoveFocusAction](_MoveFocusAction.md)

• [PlaySoundAction](_PlaySoundAction.md)

• [SelectAction](_SelectAction.md)

• [SelectAllAction](_SelectAllAction.md)
