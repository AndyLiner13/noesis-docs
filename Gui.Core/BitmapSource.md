...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.media.imaging.bitmapsource.aspx)
...
- BitmapSource
- [BitmapImage](https://www.noesisengine.com/docs/Gui.Core._BitmapImage.html)
- [CroppedBitmap](https://www.noesisengine.com/docs/Gui.Core._CroppedBitmap.html)
- [TextureSource](https://www.noesisengine.com/docs/Gui.Core._TextureSource.html)
