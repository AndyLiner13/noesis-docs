Source: https://www.noesisengine.com/docs/Gui.Core._TabControl.html

# TabControl Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.tabcontrol.aspx)
...
• [Selector](/Gui.Core/_Selector.md)
...
| Name | Description |
| --- | --- |
| ● *ContentTemplate* | Gets or sets the [DataTemplate](/Gui.Core/_DataTemplate.md) to apply to any [TabItem](/Gui.Core/_TabItem.md) that does not have a ContentTemplate |
| ● *ContentTemplateSelector* | Gets or sets a [DataTemplateSelector](/Gui.Core/_DataTemplateSelector.md) that provides custom logic for choosing the template that is used to display the content of the control |
| ● *SelectedContent* | Gets the content of the currently selected [TabItem](/Gui.Core/_TabItem.md) |
| ● *SelectedContentTemplate* | Gets the [DataTemplate](/Gui.Core/_DataTemplate.md) of the currently selected item |
| ● *SelectedContentTemplateSelector* | Gets the [DataTemplateSelector](/Gui.Core/_DataTemplateSelector.md) of the currently selected item |
| ● *TabStripPlacement* | Gets or sets how tab headers align relative to the tab content |

● Dependency Property   ○ Reflection Property

## From [Selector](/Gui.Core/_Selector.md)

| Name | Description |
| --- | --- |
| ● *IsSynchronizedWithCurrentItem* | Gets or sets a value that indicates whether a [Selector](/Gui.Core/_Selector.md) should keep the SelectedItem synchronized with the current item in the Items property. Returns true if the *SelectedItem* is always synchronized with the current item in the [ItemCollection](/Gui.Core/_ItemCollection.md); false if the *SelectedItem* is never synchronized with the current item; or null if the *SelectedItem* is synchronized with the current item only if the [Selector](/Gui.Core/_Selector.md) uses a [CollectionView](/Gui.Core/_CollectionView.md). The default value is null |
...
| Name | Description |
| --- | --- |
| ● *IsSelected* | Gets or sets a value that indicates whether an item is selected |
| ● *IsSelectionActive* | Gets a value that indicates whether the keyboard focus is within the [Selector](/Gui.Core/_Selector.md) |
...
| Name | Description |
| --- | --- |
| ▸ *SelectionChanged* | Occurs when the selection of a [Selector](/Gui.Core/_Selector.md) changes |
