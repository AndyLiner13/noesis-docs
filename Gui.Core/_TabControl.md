...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.tabcontrol.aspx)
...
| Name | Description |
| --- | --- |
| ● *ContentTemplate* | Gets or sets the [DataTemplate](_DataTemplate.md) to apply to any [TabItem](_TabItem.md) that does not have a ContentTemplate |
| ● *ContentTemplateSelector* | Gets or sets a [DataTemplateSelector](_DataTemplateSelector.md) that provides custom logic for choosing the template that is used to display the content of the control |
| ● *SelectedContent* | Gets the content of the currently selected [TabItem](_TabItem.md) |
| ● *SelectedContentTemplate* | Gets the [DataTemplate](_DataTemplate.md) of the currently selected item |
| ● *SelectedContentTemplateSelector* | Gets the [DataTemplateSelector](_DataTemplateSelector.md) of the currently selected item |
| ● *TabStripPlacement* | Gets or sets how tab headers align relative to the tab content |

● Dependency Property   ○ Reflection Property

## From [Selector](_Selector.md)

| Name | Description |
| --- | --- |
| ● *IsSynchronizedWithCurrentItem* | Gets or sets a value that indicates whether a [Selector](_Selector.md) should keep the SelectedItem synchronized with the current item in the Items property. Returns true if the *SelectedItem* is always synchronized with the current item in the [ItemCollection](_ItemCollection.md); false if the *SelectedItem* is never synchronized with the current item; or null if the *SelectedItem* is synchronized with the current item only if the [Selector](_Selector.md) uses a [CollectionView](_CollectionView.md). The default value is null |
...
| ● *IsSelectionActive* | Gets a value that indicates whether the keyboard focus is within the [Selector](_Selector.md) |
...
| Name | Description |
| --- | --- |
| ▸ *SelectionChanged* | Occurs when the selection of a [Selector](_Selector.md) changes |
