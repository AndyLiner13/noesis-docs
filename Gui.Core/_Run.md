Source: https://www.noesisengine.com/docs/Gui.Core._Run.html

# Run Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.documents.run.aspx)
...
| Name | Description |
| --- | --- |
| ● *Text* | Gets or sets the unformatted text contents of this text [Run](/Gui.Core/_Run.md) |
...
Run has no attached properties
