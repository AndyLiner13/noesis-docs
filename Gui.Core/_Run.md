...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.documents.run.aspx)
...
| Name | Description |
| --- | --- |
| ● *Text* | Gets or sets the unformatted text contents of this text [Run](_Run.md) |
