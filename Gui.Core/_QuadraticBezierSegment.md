...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.quadraticbeziersegment)
...
| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [QuadraticBezierSegment](_QuadraticBezierSegment.md) to the path |
