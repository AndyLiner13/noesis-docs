Source: https://www.noesisengine.com/docs/Gui.Core._QuadraticBezierSegment.html

# QuadraticBezierSegment Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.quadraticbeziersegment)
...
QuadraticBezierSegment has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [QuadraticBezierSegment](/Gui.Core/_QuadraticBezierSegment.md) to the path |
...
QuadraticBezierSegment has no events