Source: https://www.noesisengine.com/docs/Gui.Core._ToolTip.html

# ToolTip Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.tooltip)
...
| ● *IsOpen* | Gets or sets a value that indicates whether a [ToolTip](/Gui.Core/_ToolTip.md) is visible |
| ● *Placement* | Gets or sets the orientation of the [ToolTip](/Gui.Core/_ToolTip.md) control when it opens, and specifies how the [ToolTip](/Gui.Core/_ToolTip.md) control behaves when it overlaps screen boundaries |
| ● *PlacementRectangle* | Gets or sets the rectangular area relative to which the [ToolTip](/Gui.Core/_ToolTip.md) control is positioned when it opens |
| ● *PlacementTarget* | Gets or sets the [UIElement](/Gui.Core/_UIElement.md) relative to which the [ToolTip](/Gui.Core/_ToolTip.md) is positioned when it opens |
| ● *StaysOpen* | Gets or sets a value that indicates whether an open [ToolTip](/Gui.Core/_ToolTip.md) remains open until the user clicks the mouse when the mouse is not over the [ToolTip](/Gui.Core/_ToolTip.md) |
...
ToolTip has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *GetPopup()* | Gets [Popup](/Gui.Core/_Popup.md) where [ToolTip](/Gui.Core/_ToolTip.md) is shown |
...
| Name | Description |
| --- | --- |
| ▸ *Closed* | Occurs when a [ToolTip](/Gui.Core/_ToolTip.md) is closed and is no longer visible |
| ▸ *Opened* | Occurs when a [ToolTip](/Gui.Core/_ToolTip.md) becomes visible |
