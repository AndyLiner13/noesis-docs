...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.tooltip)
...
| ● *IsOpen* | Gets or sets a value that indicates whether a [ToolTip](_ToolTip.md) is visible |
| ● *Placement* | Gets or sets the orientation of the [ToolTip](_ToolTip.md) control when it opens, and specifies how the [ToolTip](_ToolTip.md) control behaves when it overlaps screen boundaries |
| ● *PlacementRectangle* | Gets or sets the rectangular area relative to which the [ToolTip](_ToolTip.md) control is positioned when it opens |
| ● *PlacementTarget* | Gets or sets the [UIElement](_UIElement.md) relative to which the [ToolTip](_ToolTip.md) is positioned when it opens |
| ● *StaysOpen* | Gets or sets a value that indicates whether an open [ToolTip](_ToolTip.md) remains open until the user clicks the mouse when the mouse is not over the [ToolTip](_ToolTip.md) |
...
| Name | Description |
| --- | --- |
|  *GetPopup()* | Gets [Popup](_Popup.md) where [ToolTip](_ToolTip.md) is shown |
...
| Name | Description |
| --- | --- |
| ▸ *Closed* | Occurs when a [ToolTip](_ToolTip.md) is closed and is no longer visible |
| ▸ *Opened* | Occurs when a [ToolTip](_ToolTip.md) becomes visible |
