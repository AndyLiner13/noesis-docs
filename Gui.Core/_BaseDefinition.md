...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.definitionbase.aspx)
...
• [ColumnDefinition](_ColumnDefinition.md)

• [RowDefinition](_RowDefinition.md)
