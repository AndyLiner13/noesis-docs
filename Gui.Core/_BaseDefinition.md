Source: https://www.noesisengine.com/docs/Gui.Core._BaseDefinition.html

# BaseDefinition Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.definitionbase.aspx)

Defines the functionality required to support a shared-size group that is used by the ColumnDefinitionCollection and RowDefinitionCollection classes.
...
• [ColumnDefinition](/Gui.Core/_ColumnDefinition.md)

• [RowDefinition](/Gui.Core/_RowDefinition.md)
...
BaseDefinition has no attached properties
