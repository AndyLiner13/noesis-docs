Source: https://www.noesisengine.com/docs/Gui.Core._Path.html

# Path Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.shapes.path.aspx)

Draws a series of connected lines and curves.

The [Path](/Gui.Core/_Path.md) object can draw closed or open shapes, multiple shapes, and even curved shapes. Unlike the [Line](/Gui.Core/_Line.md) and Polyline objects, you can use this object to draw curves.

The following example shows how to create a [Path](/Gui.Core/_Path.md) element and set its properties by using code.
...
| Name | Description |
| --- | --- |
| ● *Data* | Gets or sets the geometry that specifies the shape to be drawn |

● Dependency Property   ○ Reflection Property

## From [Shape](/Gui.Core/_Shape.md)

| Name | Description |
| --- | --- |
| ● *Fill* | Gets or sets the [Brush](/Gui.Core/_Brush.md) that specifies how the shape's interior is painted |
| ● *Stretch* | Gets or sets a Stretch value that describes how the shape fills its allocated space |
| ● *Stroke* | Gets or sets the [Brush](/Gui.Core/_Brush.md) that specifies how the shape's outline is painted |
| ● *StrokeDashArray* | Gets or sets a collection of float values that indicate the pattern of dashes and gaps that is used to outline shapes |
| ● *StrokeDashCap* | Gets or sets a PenLineCap enumeration value that specifies how the ends of a dash are drawn |
| ● *StrokeDashOffset* | Gets or sets a float that specifies the distance within the dash pattern where a dash begins |
| ● *StrokeEndLineCap* | Gets or sets a PenLineCap enumeration value that describes the [Shape](/Gui.Core/_Shape.md) at the end of a line |
| ● *StrokeLineJoin* | Gets or sets a PenLineJoin enumeration value that specifies the type of join that is used at the vertices of a [Shape](/Gui.Core/_Shape.md) |
| ● *StrokeMiterLimit* | Gets or sets a limit on the ratio of the miter length to half the StrokeThickness of a [Shape](/Gui.Core/_Shape.md) element |
| ● *StrokeStartLineCap* | Gets or sets a PenLineCap enumeration value describing the [Shape](/Gui.Core/_Shape.md) at the start of a Stroke |
| ● *StrokeThickness* | Gets or sets the width of the [Shape](/Gui.Core/_Shape.md) outline |
...
Path has no attached properties
