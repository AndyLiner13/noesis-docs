...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.shapes.path.aspx)

Draws a series of connected lines and curves.

The [Path](_Path.md) object can draw closed or open shapes, multiple shapes, and even curved shapes. Unlike the [Line](_Line.md) and Polyline objects, you can use this object to draw curves.

The following example shows how to create a [Path](_Path.md) element and set its properties by using code.
...
## From [Shape](_Shape.md)

| Name | Description |
| --- | --- |
| ● *Fill* | Gets or sets the [Brush](_Brush.md) that specifies how the shape's interior is painted |
| ● *Stretch* | Gets or sets a Stretch value that describes how the shape fills its allocated space |
| ● *Stroke* | Gets or sets the [Brush](_Brush.md) that specifies how the shape's outline is painted |
...
| ● *StrokeEndLineCap* | Gets or sets a PenLineCap enumeration value that describes the [Shape](_Shape.md) at the end of a line |
| ● *StrokeLineJoin* | Gets or sets a PenLineJoin enumeration value that specifies the type of join that is used at the vertices of a [Shape](_Shape.md) |
| ● *StrokeMiterLimit* | Gets or sets a limit on the ratio of the miter length to half the StrokeThickness of a [Shape](_Shape.md) element |
| ● *StrokeStartLineCap* | Gets or sets a PenLineCap enumeration value describing the [Shape](_Shape.md) at the start of a Stroke |
| ● *StrokeThickness* | Gets or sets the width of the [Shape](_Shape.md) outline |
