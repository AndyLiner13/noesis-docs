...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.tabitem.aspx)

Represents a selectable item inside a [TabControl](_TabControl.md).
...
| Name | Description |
| --- | --- |
| ● *IsSelected* | Gets or sets a value that indicates whether the [TabItem](_TabItem.md) is selected |
