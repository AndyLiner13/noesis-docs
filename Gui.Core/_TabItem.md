Source: https://www.noesisengine.com/docs/Gui.Core._TabItem.html

# TabItem Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.tabitem.aspx)

Represents a selectable item inside a [TabControl](/Gui.Core/_TabControl.md).
...
| Name | Description |
| --- | --- |
| ● *IsSelected* | Gets or sets a value that indicates whether the [TabItem](/Gui.Core/_TabItem.md) is selected |
...
TabItem has no attached properties
