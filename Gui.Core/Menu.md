...
| Property | Description |
|----------|-------------|
| IsMainMenu | Gets or sets a value that indicates whether this Menu receives a main menu activation notification |
...
| Method | Description |
|--------|-------------|
| GetActivated() | Gets or sets a value that indicates whether this Menu is activated and sub menu items get opened when mouse moves over them |
