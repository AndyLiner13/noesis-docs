...
- Enhancement Added support for all types of [Popup](_Popup.md) animations: *Fade*, *Slide*, and *Scroll*.
...
- Fixed Crash generating [TickBar](_TickBar.md) for a [Slider](_Slider.md) with many ticks.
- Fixed Crash when [BindingExpression](_BindingExpression.md) destroyed while invalidating target.
- Fixed [ComboBox](_ComboBox.md) not focusing or scrolling when no default selected item ([#1958](https://www.noesisengine.com/bugs/view.php?id=1958)).
- Fixed [Tooltip](_ToolTip.md) issues ([#1879](https://www.noesisengine.com/bugs/view.php?id=1879)).
- Fixed [Viewbox](_Viewbox.md) also scales [Tooltip](_ToolTip.md) ([#1956](https://www.noesisengine.com/bugs/view.php?id=1956)).
- Fixed [TextBox](_TextBox.md) crashing when using a [ScrollViewer](_ScrollViewer.md) without *IScrollInfo* ([#1968](https://www.noesisengine.com/bugs/view.php?id=1968)).
- Fixed Incorrect layout of [Path](_Path.md) with *Uniform* stretch inside [WrapPanel](_WrapPanel.md) ([#1972](https://www.noesisengine.com/bugs/view.php?id=1972)).
- Fixed [GridView](../Gui.Controls/_GridView.md) *Column* is frozen ([#1973](https://www.noesisengine.com/bugs/view.php?id=1973)).
- Fixed [TabControl](_TabControl.md) focus inconsistent with WPF standard ([#1979](https://www.noesisengine.com/bugs/view.php?id=1979)).
- Fixed [DataTemplate](_DataTemplate.md) XAML reports duplicate name elements ([#1994](https://www.noesisengine.com/bugs/view.php?id=1994)).
...
- Fixed C# Crash destroying [ItemsControl](_ItemsControl.md) if attached to its [ItemContainerGenerator](_ItemContainerGenerator.md) events.
...
- Feature Unreal Support for [localization](UnrealTutorial.md#localization) using *LocText* and *LocTable* extensions.
...
- Fixed [Popup](_Popup.md) not checking if target element is in the tree ([#1928](https://www.noesisengine.com/bugs/view.php?id=1928)).
- Fixed Crash updating inherited values with closing [Tooltip](_ToolTip.md) ([#1933](https://www.noesisengine.com/bugs/view.php?id=1933)).
- Fixed [ContextMenu](_ContextMenu.md) and [Tooltip](_ToolTip.md) are no longer logical children to match WPF.
- Fixed Error converting [PathGeometry](_PathGeometry.md) *Figures* property from string ([#1929](https://www.noesisengine.com/bugs/view.php?id=1929)).
- Fixed [FormattedText](_FormattedText.md) GetBounds(), GetGlyphPosition() and HitTest() returning inverted y-coordinate ([#1878](https://www.noesisengine.com/bugs/view.php?id=1878)).
- Fixed Better antialiasing geometry for underlines when [PPAA](AntialiasingTutorial.md) enabled ([#1922](https://www.noesisengine.com/bugs/view.php?id=1922)).
- Fixed [Slider](_Slider.md) Ticks disappearing ([#1924](https://www.noesisengine.com/bugs/view.php?id=1924)).
- Fixed Vertical [Slider](_Slider.md) rendering ticks in reverse order.
- Fixed Reversed [Slider](_Slider.md) rendering selection incorrectly.
...
- Fixed Crash shutting down Gallery if [TextBox](_TextBox.md) context menu was opened.
...
- Enhancement Added *VerifyAccess* to [Visual](_Visual.md) functions to detect uses from other threads.
- Enhancement New [Workflow](WorkflowTutorial.md) tutorial.
- Fixed Touch on [TextBox](_TextBox.md) not receiving focus as expected ([#1918](https://www.noesisengine.com/bugs/view.php?id=1918) [#1887](https://www.noesisengine.com/bugs/view.php?id=1887)).
...
- Fixed Support optional suffix "Extension" for [MarkupExtensions](_MarkupExtension.md) ([#1885](https://www.noesisengine.com/bugs/view.php?id=1885)).
- Fixed Error when [TextBox](_TextBox.md) caret blinks inside a [Popup](_Popup.md) ([#1907](https://www.noesisengine.com/bugs/view.php?id=1907)).
- Fixed Crash using invalid [MultiBinding](_MultiBinding.md) inside a [DataTrigger](_DataTrigger.md) ([#1904](https://www.noesisengine.com/bugs/view.php?id=1904)).
- Fixed [MultiBinding](_MultiBinding.md) inside [DataTemplate](_DataTemplate.md) not working ([#1893](https://www.noesisengine.com/bugs/view.php?id=1893)).
- Fixed [MultiBinding](_MultiBinding.md) *Converter* should be called even if inner bindings failed to resolve.
...
- Fixed Unity Crash when entering play while destroying a [ListBox](_ListBox.md) ([#1911](https://www.noesisengine.com/bugs/view.php?id=1911)).
...
- Enhancement Added new [LoadContentAction](../App.Interactivity/_LoadContentAction.md) to set the content of a [ContentControl](_ContentControl.md) by loading a XAML file ([#1864](https://www.noesisengine.com/bugs/view.php?id=1864)).
...
- Enhancement C# Added support for custom [MarkupExtensions](_MarkupExtension.md) ([#1401](https://www.noesisengine.com/bugs/view.php?id=1401)).
...
- Fixed Crash when inheriting [Binding](_Binding.md) or [MultiBinding](_MultiBinding.md) and using new class in XAML ([#1861](https://www.noesisengine.com/bugs/view.php?id=1861)).
...
- Fixed [ListBox](_ListBox.md) and [ListView](../Gui.Controls/_ListView.md) not cycling from last to first item ([#1862](https://www.noesisengine.com/bugs/view.php?id=1862)).
- Fixed [ListBoxItem](_ListBoxItem.md) automatically being focused even when a foreground element consumed the *MouseDown* ([#1866](https://www.noesisengine.com/bugs/view.php?id=1866)).
- Fixed Crash on MacBook Pro with Radeon GPUs ([#1851](https://www.noesisengine.com/bugs/view.php?id=1851)).
- Fixed Crash unregistering bindings from [Tooltip](_ToolTip.md) ([#1872](https://www.noesisengine.com/bugs/view.php?id=1872)).
- Fixed *DoubleTapped* is now properly promoted to *DoubleClick*.
- Fixed Crash closing [Tooltip](_ToolTip.md) ([#1875](https://www.noesisengine.com/bugs/view.php?id=1875)).
...
- Fixed Unity Crash on [Binding](_Binding.md) *GetConverterHelper* when serializing object ([#1867](https://www.noesisengine.com/bugs/view.php?id=1867)).
...
- Fixed [Button](_Button.md) *Click* event not raised when pressing gamepad *Accept* with *Alt* key pressed ([#1834](https://www.noesisengine.com/bugs/view.php?id=1834)).
- Fixed Crash on [TextBox](_TextBox.md) using template with no 'PART\_ContentHost' ([#1836](https://www.noesisengine.com/bugs/view.php?id=1836)).
...
- Fixed [ItemContainerGenerator](_ItemContainerGenerator.md) *StartBatch* and *StopBatch* methods should be public.
...
- Fixed Crash using [MultiBinding](_MultiBinding.md) inside [DataTrigger](_DataTrigger.md) ([#1784](https://www.noesisengine.com/bugs/view.php?id=1784), [#1812](https://www.noesisengine.com/bugs/view.php?id=1812)).
- Fixed [ListBox](_ListBox.md) selection always reverted to last focused item ([#1839](https://www.noesisengine.com/bugs/view.php?id=1839)).
- Fixed C# [FormattedText](_FormattedText.md) exposes nothing ([#1831](https://www.noesisengine.com/bugs/view.php?id=1831)).
- Fixed C# Exposed [Texture](../Render.RenderDevice/_Texture.md) properties: *Width*, *Height*, *HasMipMaps*, *IsInverted*.
- Fixed C# *TypeDescriptor* can't find a valid *TypeConverter* for [Brush](_Brush.md) ([#1817](https://www.noesisengine.com/bugs/view.php?id=1817)).
...
- Fixed [RepeatButton](_RepeatButton.md) can crash if unloaded while timer is active.
- Fixed Memory leak when using [ContextMenuService](_ContextMenuService.md) *PlacementTarget* ([#1798](https://www.noesisengine.com/bugs/view.php?id=1798)).
- Fixed [Selector](_Selector.md) not synchronizing selected index correctly when binding *SelectedValue* ([#1809](https://www.noesisengine.com/bugs/view.php?id=1809)).
- Fixed Wheel scrolling possible with [Menu](_Menu.md) opened inside a [ScrollViewer](_ScrollViewer.md).
...
- Fixed Unity Crash destroying [Selector](_Selector.md) while compiling script changes.
...
- Fixed [ContextMenu](_ContextMenu.md) ignores keyboard keys ([#1792](https://www.noesisengine.com/bugs/view.php?id=1792)).
...
- Fixed Calling Focus() on previously collapsed [TextBox](_TextBox.md) not showing caret and can't write ([#1795](https://www.noesisengine.com/bugs/view.php?id=1795)).
- Fixed Making selection changes on a collapsed [TextBox](_TextBox.md) not working.
- Fixed Shift key not extending mouse selection in [TextBox](_TextBox.md).
- Fixed [TextBox](_TextBox.md) Foreground ignored when template ScrollViewer has different Foreground ([#1791](https://www.noesisengine.com/bugs/view.php?id=1791)).
...
- Feature Tapped, DoubleTapped, Holding and RightTapped [events](TouchTutorial.md#gesture-events) implements in [UIElement](_UIElement.md) ([#1533](https://www.noesisengine.com/bugs/view.php?id=1533)).
- Enhancement Showing context menu on *Holding* event for touch devices.
- Enhancement Added *UpdateInspector()* to integration API.
- Enhancement Added *ScrollIntoView()* for [ComboBox](_ComboBox.md) ([#1778](https://www.noesisengine.com/bugs/view.php?id=1778)).
...
- Fixed Crash when adding/removing [Grid](_Grid.md) in a shared size group during measure ([#1776](https://www.noesisengine.com/bugs/view.php?id=1776)).
...
- Fixed Crash defining [ResourceDictionary](_ResourceDictionary.md) with x:Name inside Resources ([#1780](https://www.noesisengine.com/bugs/view.php?id=1780)).
...
- Fixed [Canvas](_Canvas.md) positions can't be *Infinity* ([#1756](https://www.noesisengine.com/bugs/view.php?id=1756)).
...
- Fixed Collection *Move* not supported by [ItemCollection](_ItemCollection.md) and [VirtualizingStackPanel](_VirtualizingStackPanel.md).
...
- Fixed Unity Crash destroying [Selector](_Selector.md) with data bound *ItemsSource*.
...
> - New [First Steps Tutorial](UnrealTutorial.md).

- Enhancement Sharing column or row sizes between [Grids](_Grid.md) with *ShareSizeGroup* ([#1552](https://www.noesisengine.com/bugs/view.php?id=1552)).
- Enhancement Gradients are now always interpolated in sRGB space (as in WPF).
- Enhancement Implemented [GradientBrush](_GradientBrush.md) [ColorInterpolationMode](https://www.noesisengine.com/xamltoy/372dc1a0750b543bdeee7648d87c5bed) property.
...
- Fixed *HorizontalOffset* and *VerticalOffset* to move [Tooltip](_ToolTip.md) does not work ([#1757](https://www.noesisengine.com/bugs/view.php?id=1757)).
- Fixed [Tooltip](_ToolTip.md) *PlacementTarget* not updated to owner.
- Fixed Can't set items *Row* or *Column* within an [ItemsControl](_ItemsControl.md) with [Grid](_Grid.md) items host ([#1758](https://www.noesisengine.com/bugs/view.php?id=1758)).
...
- Fixed [SkewTransform](_SkewTransform.md) does not look the same as in WPF ([#1731](https://www.noesisengine.com/bugs/view.php?id=1731)).
- Fixed Crash when clicking on a [TextBox](_TextBox.md) without a default font ([#1733](https://www.noesisengine.com/bugs/view.php?id=1733)).
- Fixed [TextBox](_TextBox.md) with IsFocusEngagementEnabled="False" does not work properly ([#1732](https://www.noesisengine.com/bugs/view.php?id=1732)).
...
- Fixed Can't use [StaticResource](_StaticResourceExtension.md) for [MultiBinding](_MultiBinding.md) inner bindings ([#1735](https://www.noesisengine.com/bugs/view.php?id=1735)).
...
- Fixed [Tooltip](_ToolTip.md) *ShowDuration* doesn't work ([#1739](https://www.noesisengine.com/bugs/view.php?id=1739)).
- Fixed *VirtualizationMode=Recycling* breaks inheritance ([#1745](https://www.noesisengine.com/bugs/view.php?id=1745)).
- Fixed Bindings not working inside [ContentPresenter](_ContentPresenter.md) when using visual content ([#1747](https://www.noesisengine.com/bugs/view.php?id=1747)).
- Fixed Crash destroying [TextBlock](_TextBlock.md) with multiple brushes ([#1749](https://www.noesisengine.com/bugs/view.php?id=1749)).
- Fixed [TabControl](_TabControl.md) selection issue ([#1751](https://www.noesisengine.com/bugs/view.php?id=1751)).
...
- Fixed [ComboBox](_ComboBox.md) selection not updating when model changes ([#1708](https://www.noesisengine.com/bugs/view.php?id=1708)).
- Fixed [Popup](_Popup.md) and [ComboBox](_ComboBox.md) do not work together nicely ([#1713](https://www.noesisengine.com/bugs/view.php?id=1713)).
- Fixed Crash when you click on [TextBox](_TextBox.md) with a not found FontFamily ([#1715](https://www.noesisengine.com/bugs/view.php?id=1715)).
- Fixed Incorrect binding error messages loading an [ItemsControl](_ItemsControl.md) ([#1718](https://www.noesisengine.com/bugs/view.php?id=1718)).
- Fixed Can't move focus to [ItemsControl](_ItemsControl.md) items using arrows ([#1719](https://www.noesisengine.com/bugs/view.php?id=1719)).
...
- Fixed Rare glitch when rendering [BlurEffect](_BlurEffect.md).
...
- Fixed Crash if [ItemsControl](_ItemsControl.md) gets destroyed before its [ItemCollection](_ItemCollection.md).
...
- Enhancement New [NoesisGUI Extensions](ExtensionsTutorial.md) tutorial.
- Enhancement Inspector improvements:
...
- Fixed Caret disappearing when [TextBox](_TextBox.md) gets scaled down.
- Fixed C# Interactivity classes causing memory leaks ([#1671](https://www.noesisengine.com/bugs/view.php?id=1671)).
- Fixed C# Unity samples using [WeakReference pattern](EventsTutorial.md#weak-events-in-c) to attach to events.
...
- Enhancement [3D Transforms tutorial](Transform3DTutorial.md).
...
- Enhancement Improvements to [Rendering Architecture](RenderingTutorial.md) document.
- Enhancement C# LogicalTreeHelper API is now as in WPF.
- Fixed C# App V-sync not enabled by default.
- Fixed C# Memory leaks when using [ResourceDictionary](_ResourceDictionary.md) in code.

# Version 3.0.0rc1

*Released 28 Apr 2020* - [Download](https://www.noesisengine.com/developers/downloads.php)

- NoesisGUI requires now activation with a [License Key](Licensing.md).
- Enhancement App Implemented *OpenUrl()* in AndroidDisplay.
- Enhancement Support for multi-touch in [Slider](_Slider.md).
...
- Enhancement [PPAA](AntialiasingTutorial.md): exposed *PPAAIn* and *PPAAOut* as XAML extensions ([#1638](https://www.noesisengine.com/bugs/view.php?id=1638)).
...
> - Correct selection of [TextBlock](_TextBlock.md) with [Inlines](_Inline.md).
...
- Fixed [DropShadowEffect](_DropShadowEffect.md) ignoring alpha channel of *Color* property (as in WPF).
...
- Enhancement Improved [Providers](ProvidersTutorial.md) tutorial with Hot-Reloading section.
...
- Fixed [Grid](_Grid.md) layout failing with span elements sometimes.
...
- Feature Added [Reloaded](EventsTutorial.md#lifetime-events) event for hot-reloading scenarios.
- Enhancement Performance and robustness improvements to XAML hot-reloading.
- Enhancement Avoid initial animations for [ToggleButton](_ToggleButton.md), [TreeView](_TreeView.md) and [Expander](_Expander.md) in Noesis Theme.
...
- Fixed C# [ResourceDictionary](_ResourceDictionary.md) Keys enumeration causing crash.
...
- Enhancement Added a [debug theme](StylingTutorial.md#default-styles) (magenta) for default styles.
...
- Fixed [TreeViewItem](_TreeViewItem.md) incorrectly using DataContext as item for the *SelectedItem* property.
...
- Fixed [TextBox](_TextBox.md) caret sometimes disappearing or placed over the characters.
- Fixed Caret remains visible after setting *IsReadOnly* to true in a [TextBox](_TextBox.md).
- Fixed [ToolBar](_ToolBar.md) overflow panel remains open when overflow items are removed.
...
- Fixed Implemented item Move() for [ItemContainerGenerator](_ItemContainerGenerator.md) and [Panel](_Panel.md) ([#1550](https://www.noesisengine.com/bugs/view.php?id=1550)).
...
- Feature [Inspector](InspectorTutorial.md) is a new tool for profiling and analyzing applications using NoesisGUI. It remotely connects to the application and allows inspecting each element, profiling perfomance, hot-reloading of asssets, access to the console and much more things.

  ![Changelog_v30_0.jpg](https://www.noesisengine.com/docs/Changelog_v30_0.jpg)
- Feature New Noesis **Theme** supporting Dark/Light and Accent color variations. All controls have been adjusted to have a more modern aspect by default. There is also a new Gallery application showcasing the new control styles.
  ...
  ![Changelog_v30_1.png](https://www.noesisengine.com/docs/Changelog_v30_1.png)
- Feature New [plugin](https://github.com/Noesis/Lottie-Noesis) for **Adobe After Effects** ([preview](https://www.noesisengine.com/xamltoy/e4c6986363164dabcb6e0ea8d8d96265)) to export Lottie animations to XAML.
  ...
  ![Changelog_v30_2.png](https://www.noesisengine.com/docs/Changelog_v30_2.png)
- Feature Hot reloading of assets. Providers expose a delegate to inform about content changes.
- Feature [BlurEffect](_BlurEffect.md) ([preview](https://www.noesisengine.com/xamltoy/26ac351d3d40525f7e4ed14f6aa3e9f4)) and [DropShadowEffect](_DropShadowEffect.md) ([preview](https://www.noesisengine.com/xamltoy/012449ce12e6c2ad5cfa09020add4791)) implemented ([#1526](https://www.noesisengine.com/bugs/view.php?id=1526), [#878](https://www.noesisengine.com/bugs/view.php?id=878)).
- Feature Implemented [PathGeometry](_PathGeometry.md) ([preview](https://www.noesisengine.com/xamltoy/637ecb0c5f601da643bdaf9e855b46f8)) allowing rich shape animations.
- Feature Added *TrimStart*, *TrimEnd* and *TrimOffset* extensions to trim geometry [Path](_Path.md) like Adobe After Effect ([preview](https://www.noesisengine.com/xamltoy/6acdc882e5c540f15a7857a884e06a42)).
- Feature [3D Transforms](Transform3DTutorial.md). We have deprecated UIElement.Projection in favor of UIElement.Transform3D. This new property allows real 3D transformations ([preview](https://www.noesisengine.com/xamltoy/8ab948fb3b5a3edaaee5bb6cd7017a8b)). [CompositeTransform3D](_CompositeTransform3D.md) and [MatrixTransform3D](_MatrixTransform3D.md) can be asigned to this property. Camera projections only happen now at root by setting a matrix in the view using SetProjectionMatrix ([#1465](https://www.noesisengine.com/bugs/view.php?id=1465)).
- Feature Support for VR rendering. *Render* function in IView now receives an extra eye projection matrix.
- Feature [MultiBinding](_MultiBinding.md) implemented.
...
- Feature Implemented StringFormat for [ContentControl](_ContentControl.md) and [HeaderedContentControl](_HeaderedContentControl.md) ([#1263](https://www.noesisengine.com/bugs/view.php?id=1263)).
...
- Enhancement Placeholder text extension for [TextBox](_TextBox.md), [PasswordBox](_PasswordBox.md) and [ComboBox](_ComboBox.md) styles.
...
- Enhancement New function [FrameworkElement](_FrameworkElement.md).ApplyTemplate().
...
> - Access to [ResourceDictionary](_ResourceDictionary.md) values using const char\* keys instead of obsolete *IResourceKey*.
...
- Fixed Unnecessary tessellations when changing items in [ToolBar](_ToolBar.md).
- Fixed [Binding](_Binding.md) with *FindAncestor* should search up the visual tree.
- Fixed Stack overflow bringing [TreeViewItem](_TreeViewItem.md) into view without *PART\_Header* template element.
- Fixed Duplicated reflection enum values for *Key* and *ModifierKeys*.
- Fixed Crash when using unknown *TargetName* in a trigger [Setter](_Setter.md).
- Fixed [FrameworkElement](_FrameworkElement.md) *FindResource* not searching in *BasedOn* styles.
- Fixed Focus visual layer not removed when focused element disabled or collapsed.
- Fixed [ScrollContentPresenter](_ScrollContentPresenter.md) registered against *ScrollChanged* event multiple times.
- Fixed [Path](_Path.md)'s geometry *FillRule* being ignored.
- Fixed [MultiDataTrigger](_MultiDataTrigger.md) incorrectly executed when all conditions except the last one matched during initialization.
- Fixed [Button](_Button.md) *IsPressed* being updated using *DescendantBounds* instead of *RenderSize* as in WPF.
- Fixed [ItemsControl](_ItemsControl.md) *ContainerFromElement* crashing for elements not inside the items control.
...
- Fixed *IsFocusEngagementEnabled* now indicates if [Control](_Control.md) supports focus engagement to match UWP.
- Fixed [ItemsControl](_ItemsControl.md) and derived no longer have *IsFocusEngagementEnabled* by default to match UWP.
