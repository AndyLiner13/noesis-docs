...
## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.solidcolorbrush.aspx)
...
| Name | Description |
| --- | --- |
| ● *Color* | Gets or sets the color of this [SolidColorBrush](/Gui.Core/_SolidColorBrush.md) |
...
| Name | Description |
| --- | --- |
|  *TryParse(str, result)* | Parses a string value to create an instance of a [SolidColorBrush](/Gui.Core/_SolidColorBrush.md) |
