Source: https://www.noesisengine.com/docs/Gui.Core._SolidColorBrush.html

# SolidColorBrush Class

## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.solidcolorbrush.aspx)
...
| Name | Description |
| --- | --- |
| ● *Color* | Gets or sets the color of this [SolidColorBrush](_SolidColorBrush.md) |
...
SolidColorBrush has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *TryParse(str, result)* | Parses a string value to create an instance of a [SolidColorBrush](_SolidColorBrush.md) |
