...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.menuitem.aspx)

Represents a selectable item inside a [Menu](_Menu.md) or [ContextMenu](_ContextMenu.md).
...
| ● *CommandParameter* | Gets or sets the parameter to pass to the Command property of a [MenuItem](_MenuItem.md) |
| ● *CommandTarget* | Gets or sets the target element on which to raise the specified command |
| ● *Icon* | Gets or sets the icon that appears in a [MenuItem](_MenuItem.md) |
| ● *InputGestureText* | Sets the text describing an input gesture that will call the command tied to the specified item |
| ● *IsCheckable* | Gets a value that indicates whether a [MenuItem](_MenuItem.md) can be checked |
| ● *IsChecked* | Gets or sets a value that indicates whether the [MenuItem](_MenuItem.md) is checked |
| ● *IsHighlighted* | Gets a value that indicates whether a [MenuItem](_MenuItem.md) is highlighted |
| ● *IsPressed* | Gets a value that indicates whether a [MenuItem](_MenuItem.md) is pressed |
| ● *IsSubmenuOpen* | Gets or sets a value that indicates whether the submenu of the [MenuItem](_MenuItem.md) is open |
| ● *Role* | Gets a value that indicates the role of a [MenuItem](_MenuItem.md) |
| ● *StaysOpenOnClick* | Gets or sets a value that indicates that the submenu in which this [MenuItem](_MenuItem.md) is located should not close when this item is clicked |
...
| ▸ *Click* | Occurs when a [MenuItem](_MenuItem.md) is clicked |
...
| ▸ *Unchecked* | Occurs when a [MenuItem](_MenuItem.md) is unchecked |
