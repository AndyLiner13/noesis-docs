Source: https://www.noesisengine.com/docs/Gui.Core._MenuItem.html

# MenuItem Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.menuitem.aspx)

Represents a selectable item inside a [Menu](/Gui.Core/_Menu.md) or [ContextMenu](/Gui.Core/_ContextMenu.md).
...
| ● *CommandParameter* | Gets or sets the parameter to pass to the Command property of a [MenuItem](/Gui.Core/_MenuItem.md) |
| ● *CommandTarget* | Gets or sets the target element on which to raise the specified command |
| ● *Icon* | Gets or sets the icon that appears in a [MenuItem](/Gui.Core/_MenuItem.md) |
| ● *InputGestureText* | Sets the text describing an input gesture that will call the command tied to the specified item |
| ● *IsCheckable* | Gets a value that indicates whether a [MenuItem](/Gui.Core/_MenuItem.md) can be checked |
| ● *IsChecked* | Gets or sets a value that indicates whether the [MenuItem](/Gui.Core/_MenuItem.md) is checked |
| ● *IsHighlighted* | Gets a value that indicates whether a [MenuItem](/Gui.Core/_MenuItem.md) is highlighted |
| ● *IsPressed* | Gets a value that indicates whether a [MenuItem](/Gui.Core/_MenuItem.md) is pressed |
| ● *IsSubmenuOpen* | Gets or sets a value that indicates whether the submenu of the [MenuItem](/Gui.Core/_MenuItem.md) is open |
| ● *Role* | Gets a value that indicates the role of a [MenuItem](/Gui.Core/_MenuItem.md) |
| ● *StaysOpenOnClick* | Gets or sets a value that indicates that the submenu in which this [MenuItem](/Gui.Core/_MenuItem.md) is located should not close when this item is clicked |
...
| Name | Description |
| --- | --- |
| ▸ *Checked* | Occurs when a menu item is checked |
| ▸ *Click* | Occurs when a [MenuItem](/Gui.Core/_MenuItem.md) is clicked |
...
| ▸ *Unchecked* | Occurs when a [MenuItem](/Gui.Core/_MenuItem.md) is unchecked |
