Source: https://www.noesisengine.com/docs/Gui.Core._Slider.html

# Slider Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.slider.aspx)

Represents a control that lets the user select from a range of values by moving a [Thumb](/Gui.Core/_Thumb.md) control along a [Track](/Gui.Core/_Track.md).
...
• [RangeBase](/Gui.Core/_RangeBase.md)
...
| Name | Description |
| --- | --- |
| ● *Delay* | Gets or sets the amount of time in milliseconds that a [RepeatButton](/Gui.Core/_RepeatButton.md) waits, while it is pressed, before a command to move the [Thumb](/Gui.Core/_Thumb.md) executes, such as a *DecreaseLarge* command |
| ● *Interval* | Gets or sets the amount of time in milliseconds between increase or decrease commands when a user clicks the [RepeatButton](/Gui.Core/_RepeatButton.md) of a [Slider](/Gui.Core/_Slider.md) |
| ● *IsDirectionReversed* | Gets or sets the direction of increasing value |
| ● *IsMoveToPointEnabled* | Gets or sets a value that indicates whether the [Thumb](/Gui.Core/_Thumb.md) of a [Slider](/Gui.Core/_Slider.md) moves immediately to the location of the mouse click that occurs while the mouse pointer pauses on the [Slider](/Gui.Core/_Slider.md) track |
| ● *IsSelectionRangeEnabled* | Gets or sets a value that indicates whether the [Slider](/Gui.Core/_Slider.md) displays a selection range along the [Slider](/Gui.Core/_Slider.md) |
| ● *IsSnapToTickEnabled* | Gets or sets a value that indicates whether the [Slider](/Gui.Core/_Slider.md) automatically moves the [Thumb](/Gui.Core/_Thumb.md) to the closest tick mark |
| ● *Orientation* | Gets or sets the orientation of a [Slider](/Gui.Core/_Slider.md) |
| ● *SelectionEnd* | Gets or sets the largest value of a specified selection for a [Slider](/Gui.Core/_Slider.md) |
| ● *SelectionStart* | Gets or sets the smallest value of a specified selection for a [Slider](/Gui.Core/_Slider.md) |
| ● *TickFrequency* | Gets or sets the interval between tick marks |
| ● *TickPlacement* | Gets or sets the position of tick marks with respect to the [Track](/Gui.Core/_Track.md) of the [Slider](/Gui.Core/_Slider.md) |
| ● *Ticks* | Gets or sets the positions of the tick marks to display for a [Slider](/Gui.Core/_Slider.md) |

● Dependency Property   ○ Reflection Property

## From [RangeBase](/Gui.Core/_RangeBase.md)

| Name | Description |
| --- | --- |
| ● *LargeChange* | Gets or sets a value to be added to or subtracted from the Value of a [RangeBase](/Gui.Core/_RangeBase.md) control |
...
| ● *SmallChange* | Gets or sets a value to be added to or subtracted from the Value of a [RangeBase](/Gui.Core/_RangeBase.md) control |
| ● *Value* | Gets or sets the current magnitude of the range control |
...
Slider has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *GetTrack()* | Gets the [Track](/Gui.Core/_Track.md) for a [Slider](/Gui.Core/_Slider.md) control |
