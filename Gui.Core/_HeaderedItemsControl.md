...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.headereditemscontrol.aspx)
...
• [MenuItem](_MenuItem.md)

• [ToolBar](_ToolBar.md)

• [TreeViewItem](_TreeViewItem.md)
