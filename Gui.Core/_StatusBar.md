Source: https://www.noesisengine.com/docs/Gui.Core._StatusBar.html

# StatusBar Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.statusbar.aspx)

Represents a control that displays items and information in a horizontal bar (typically at the bottom) in an application window.
