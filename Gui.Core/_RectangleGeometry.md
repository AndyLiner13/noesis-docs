Source: https://www.noesisengine.com/docs/Gui.Core._RectangleGeometry.html

# RectangleGeometry Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.rectanglegeometry.aspx)
...
| Name | Description |
| --- | --- |
| ● *RadiusX* | Gets or sets the x-radius of the ellipse used to round the corners of the rectangle |
| ● *RadiusY* | Gets or sets the y-radius of the ellipse used to round the corners of the rectangle |
...
RectangleGeometry has no attached properties
...
RectangleGeometry has no events