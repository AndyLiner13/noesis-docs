Source: https://www.noesisengine.com/docs/Gui.Core._ScrollBar.html

# ScrollBar Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.scrollbar.aspx)

Represents a control that provides a scroll bar that has a sliding [Thumb](/Gui.Core/_Thumb.md) whose position corresponds to a value.
...
| Name | Description |
| --- | --- |
| ● *Orientation* | Gets or sets whether the [ScrollBar](/Gui.Core/_ScrollBar.md) is displayed horizontally or vertically |
| ○ *Track* | Gets the [Track](/Gui.Core/_Track.md) for a [ScrollBar](/Gui.Core/_ScrollBar.md) control |
...
ScrollBar has no attached properties
...
| Name | Description |
| --- | --- |
| ▸ *Scroll* | Occurs one or more times as content scrolls in a [ScrollBar](/Gui.Core/_ScrollBar.md) when the user moves the [Thumb](/Gui.Core/_Thumb.md) by using the mouse |
