Source: https://www.noesisengine.com/docs/Gui.Core._HeaderedContentControl.html

# HeaderedContentControl Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.headeredcontentcontrol.aspx)
...
• [Expander](/Gui.Core/_Expander.md)

• [GroupBox](/Gui.Core/_GroupBox.md)

• [TabItem](/Gui.Core/_TabItem.md)
...
HeaderedContentControl has no attached properties
