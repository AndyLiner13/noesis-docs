...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.documents.adornerlayer)
...
|  *GetAdornerLayer(visual)* | Returns the first adorner layer in the visual tree above a specified [Visual](_Visual.md) |
|  *Remove(adorner)* | Removes the specified [Adorner](_Adorner.md) from the adorner layer |
