Source: https://www.noesisengine.com/docs/Gui.Core._BitmapImage.html

# BitmapImage Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.media.imaging.bitmapimage.aspx)

Provides a [BitmapSource](/Gui.Core/_BitmapSource.md) created from an image file located at the specifed [Uri](/Gui.Providers/_Uri.md).
...
| Name | Description |
| --- | --- |
| ● *UriSource* | Gets or sets the image [Uri](/Gui.Providers/_Uri.md) source |
