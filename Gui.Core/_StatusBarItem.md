...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.statusbaritem.aspx)

Represents an item of a [StatusBar](_StatusBar.md) control.
