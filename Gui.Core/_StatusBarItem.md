Source: https://www.noesisengine.com/docs/Gui.Core._StatusBarItem.html

# StatusBarItem Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.statusbaritem.aspx)

Represents an item of a [StatusBar](/Gui.Core/_StatusBar.md) control.
...
StatusBarItem has no attached properties
