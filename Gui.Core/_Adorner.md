Source: https://www.noesisengine.com/docs/Gui.Core._Adorner.html

# Adorner Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.documents.adorner)

Abstract class that represents a [FrameworkElement](/Gui.Core/_FrameworkElement.md) that decorates another element.
