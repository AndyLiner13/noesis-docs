...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.pen.aspx)
...
| Name | Description |
| --- | --- |
| ● *Brush* | Gets or sets the [Brush](_Brush.md) used to fill the outline produced by this [Pen](_Pen.md) |
| ● *DashCap* | Gets or sets a value that specifies how the ends of each dash are drawn |
| ● *DashStyle* | Gets or sets a value that describes the pattern of dashes generated by this [Pen](_Pen.md) |
...
| ● *Thickness* | Gets or sets the thickness of the stroke produced by this [Pen](_Pen.md) |
