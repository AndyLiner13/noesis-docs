...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.transform.aspx)

Defines functionality that enables transformations in a 2D plane.

Transformations include rotation ([RotateTransform](_RotateTransform.md)), scale ([ScaleTransform](_ScaleTransform.md)), skew ([SkewTransform](_SkewTransform.md)), and translation ([TranslateTransform](_TranslateTransform.md)).
...
• [CompositeTransform](_CompositeTransform.md)

• [MatrixTransform](_MatrixTransform.md)

• [RotateTransform](_RotateTransform.md)

• [ScaleTransform](_ScaleTransform.md)

• [SkewTransform](_SkewTransform.md)

• [TransformGroup](_TransformGroup.md)

• [TranslateTransform](_TranslateTransform.md)
