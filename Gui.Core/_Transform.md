Source: https://www.noesisengine.com/docs/Gui.Core._Transform.html

# Transform Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.transform.aspx)

Defines functionality that enables transformations in a 2D plane.

Transformations include rotation ([RotateTransform](/Gui.Core/_RotateTransform.md)), scale ([ScaleTransform](/Gui.Core/_ScaleTransform.md)), skew ([SkewTransform](/Gui.Core/_SkewTransform.md)), and translation ([TranslateTransform](/Gui.Core/_TranslateTransform.md)).
...
• [CompositeTransform](/Gui.Core/_CompositeTransform.md)

• [MatrixTransform](/Gui.Core/_MatrixTransform.md)

• [RotateTransform](/Gui.Core/_RotateTransform.md)

• [ScaleTransform](/Gui.Core/_ScaleTransform.md)

• [SkewTransform](/Gui.Core/_SkewTransform.md)

• [TransformGroup](/Gui.Core/_TransformGroup.md)

• [TranslateTransform](/Gui.Core/_TranslateTransform.md)
...
Transform has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *TryParse(str, result)* | Parses a string value to create an instance of a [MatrixTransform](/Gui.Core/_MatrixTransform.md) |
