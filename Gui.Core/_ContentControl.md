Source: https://www.noesisengine.com/docs/Gui.Core._ContentControl.html

# ContentControl Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.contentcontrol.aspx)
...
• [Label](/Gui.Core/_Label.md)

• [ListBoxItem](/Gui.Core/_ListBoxItem.md)

• [ScrollViewer](/Gui.Core/_ScrollViewer.md)

• [StatusBarItem](/Gui.Core/_StatusBarItem.md)

• [ToolTip](/Gui.Core/_ToolTip.md)

• [UserControl](/Gui.Core/_UserControl.md)

• [Window](/App.ApplicationLauncher/_Window.md)
...
ContentControl has no attached properties
