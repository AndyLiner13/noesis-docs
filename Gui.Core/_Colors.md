Source: https://www.noesisengine.com/docs/Gui.Core._Colors.html

# Colors Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.media.colors.aspx)
...
| ○ *Cornsilk* | Gets the system-defined color that has an ARGB value of #FFFFF8DC |
...
| ○ *DarkSeaGreen* | Gets the system-defined color that has an ARGB value of #FF8FBC8F |
...
| ○ *Firebrick* | Gets the system-defined color that has an ARGB value of #FFB22222 |
| ○ *FloralWhite* | Gets the system-defined color that has an ARGB value of #FFFFFAF0 |
...
| ○ *Gold* | Gets the system-defined color that has an ARGB value of #FFFFD700 |
...
| ○ *LavenderBlush* | Gets the system-defined color that has an ARGB value of #FFFFF0F5 |
| ○ *LawnGreen* | Gets the system-defined color that has an ARGB value of #FF7CFC00 |
| ○ *LemonChiffon* | Gets the system-defined color that has an ARGB value of #FFFFFACD |
...
| ○ *LightPink* | Gets the system-defined color that has an ARGB value of #FFFFB6C1 |
| ○ *LightSalmon* | Gets the system-defined color that has an ARGB value of #FFFFA07A |
...
| ○ *LightYellow* | Gets the system-defined color that has an ARGB value of #FFFFFFE0 |
...
| ○ *OldLace* | Gets the system-defined color that has an ARGB value of #FFFDF5E6 |
...
| ○ *Orange* | Gets the system-defined color that has an ARGB value of #FFFFA500 |
...
| ○ *Yellow* | Gets the system-defined color that has an ARGB value of #FFFFFF00 |
...
Colors has no attached properties

# Methods

Colors has no methods

# Events

Colors has no events