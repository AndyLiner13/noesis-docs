Source: https://www.noesisengine.com/docs/Gui.Core._CompositeTransform3D.html

# CompositeTransform3D Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/uwp/api/windows.ui.xaml.media.media3d.compositetransform3d)
...
| Name | Description |
| --- | --- |
| ● *CenterX* | Gets or sets the x-coordinate of the transformation center in pixels |
| ● *CenterY* | Gets or sets the y-coordinate of the transformation center in pixels |
| ● *CenterZ* | Gets or sets the z-coordinate of the transformation center in pixels |
...
| ● *ScaleZ* | Gets or sets the z-axis scale factor |
| ● *TranslateX* | Gets or sets the distance to translate along the x-axis in pixels |
| ● *TranslateY* | Gets or sets the distance to translate along the y-axis in pixels |
| ● *TranslateZ* | Gets or sets the distance to translate along the z-axis in pixels |

● Dependency Property   ○ Reflection Property

## From [Transform3D](/Gui.Core/_Transform3D.md)
...
CompositeTransform3D has no attached properties
...
CompositeTransform3D has no events