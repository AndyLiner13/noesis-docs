...
| Property | Description |
|----------|-------------|
| Orientation | Gets or sets whether the ScrollBar is displayed horizontally or vertically |
| Track | Gets the Track for a ScrollBar control |
...
| Event | Description |
|-------|-------------|
| Scroll | Occurs one or more times as content scrolls in a ScrollBar when the user moves the Thumb by using the mouse |