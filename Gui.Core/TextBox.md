...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.textbox.aspx)

Represents a control that can be used to display or edit unformatted text.

## Inheritance Hierarchy

 • [DispatcherObject](https://www.noesisengine.com/docs/Gui.DependencySystem._DispatcherObject.html) • [DependencyObject](https://www.noesisengine.com/docs/Gui.DependencySystem._DependencyObject.html) • [Visual](https://www.noesisengine.com/docs/Gui.Core._Visual.html) • [UIElement](https://www.noesisengine.com/docs/Gui.Core._UIElement.html) • [FrameworkElement](https://www.noesisengine.com/docs/Gui.Core._FrameworkElement.html) • [Control](https://www.noesisengine.com/docs/Gui.Core._Control.html) • [BaseTextBox](https://www.noesisengine.com/docs/Gui.Core._BaseTextBox.html) • TextBox

## Properties

### From [BaseTextBox](https://www.noesisengine.com/docs/Gui.Core._BaseTextBox.html)
...
| ExtentHeight | Vertical size of scrollable content; 0.0 if TextBox is non-scrolling |
| ExtentWidth | Horizontal size of scrollable content; 0.0 if TextBox is non-scrolling |
| HorizontalOffset | Actual HorizontalOffset contains the ScrollViewer's current horizontal offset. This is a computed value, depending on the state of ScrollViewer, its Viewport, Extent and previous scrolling commands. |
...
| PanningMode | Gets or sets the way TextBox reacts to touch manipulation |
...
| VerticalOffset | Actual VerticalOffset contains the ScrollViewer's current vertical offset. This is a computed value, depending on the state of ScrollViewer, its Viewport, Extent and previous scrolling commands. |
| VerticalScrollBarVisibility | Gets or sets a value that indicates whether a vertical scroll bar is shown |
| ViewportHeight | Vertical size of scroll area; 0.0 if TextBox is non-scrolling |
| ViewportWidth | Horizontal size of scroll area; 0.0 if TextBox is non-scrolling |

### From [Control](https://www.noesisengine.com/docs/Gui.Core._Control.html)
...
| Typography | Gets the currently effective typography variations for the text contents of this TextBox |
...
| Clear() | Clear all the content in the TextBox control |
...
| GetCharacterIndexFromPoint(point, snapToText) | Return the 0-based character index of the given point. If there is no character at that point and snapToText is false, return -1. Point is specified in TextBox coordinates |
| GetCompositionUnderline(index) | Gets the specified IME composition underline |
| GetFirstVisibleLineIndex() | Return the index of the first line that is currently visible in the TextBox, or -1 if no layout information is available |
| GetLastVisibleLineIndex() | Return the index of the last line that is currently visible in the TextBox, or -1 if no layout information is available |
...
| GetTextView() | Gets the visual that renders the text of the TextBox |
...
| PreviewMouseDoubleClick | Occurs when a user clicks the mouse button two more times |
