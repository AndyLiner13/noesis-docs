Source: https://www.noesisengine.com/docs/Gui.Core._EventTrigger.html

# EventTrigger Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.eventtrigger.aspx)
...
| Name | Description |
| --- | --- |
| ○ *Actions* | Gets the collection of [BeginStoryboard](/Gui.Animation/_BeginStoryboard.md) objects that this [EventTrigger](/App.Interactivity/_EventTrigger.md) maintains |
| ○ *RoutedEvent* | Gets or sets the name of the event that initiates the trigger |
...
EventTrigger has no attached properties
