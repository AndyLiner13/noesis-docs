Source: https://www.noesisengine.com/docs/Gui.Core._Popup.html

# Popup Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.popup.aspx)
...
| Name | Description |
| --- | --- |
| ● *AllowsTransparency* | Gets or sets a value that indicates whether a [Popup](/Gui.Core/_Popup.md) control can contain transparent content |
| ● *Child* | Gets or sets content of the [Popup](/Gui.Core/_Popup.md) control |
...
| ● *IsOpen* | Gets or sets a value that indicates whether is visible or not |
| ● *Placement* | Gets or sets the orientation of the control when it opens, and specifies how the control behaves when it overlaps screen boundaries |
| ● *PlacementRectangle* | Gets or sets the rectangular area relative to which the control is positioned when it opens |
| ● *PlacementTarget* | Gets or sets the [UIElement](/Gui.Core/_UIElement.md) relative to which the control is positioned when it opens |
| ● *PopupAnimation* | Gets or sets an animation for the opening and closing of a [Popup](/Gui.Core/_Popup.md) control |
| ● *StaysOpen* | Gets or sets a value that indicates whether the [Popup](/Gui.Core/_Popup.md) control closes when the control is no longer in focus. True if the [Popup](/Gui.Core/_Popup.md) control closes when IsOpen property is set to false; False if the [Popup](/Gui.Core/_Popup.md) control closes when a mouse or keyboard event occurs outside the [Popup](/Gui.Core/_Popup.md) control. The default is true. |
...
Popup has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *IsDescendantOf(ancestor, child)* | Determines if an element is descendant of another in a tree with Popups |
...
| Name | Description |
| --- | --- |
| ◆ *Closed* | Occurs when the IsOpen property changes to false |
| ◆ *Opened* | Occurs when the IsOpen property changes to true |
