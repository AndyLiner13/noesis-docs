...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.popup.aspx)
...
| Name | Description |
| --- | --- |
| ● *AllowsTransparency* | Gets or sets a value that indicates whether a [Popup](_Popup.md) control can contain transparent content |
| ● *Child* | Gets or sets content of the [Popup](_Popup.md) control |
...
| ● *PlacementTarget* | Gets or sets the [UIElement](_UIElement.md) relative to which the control is positioned when it opens |
| ● *PopupAnimation* | Gets or sets an animation for the opening and closing of a [Popup](_Popup.md) control |
| ● *StaysOpen* | Gets or sets a value that indicates whether the [Popup](_Popup.md) control closes when the control is no longer in focus. True if the [Popup](_Popup.md) control closes when IsOpen property is set to false; False if the [Popup](_Popup.md) control closes when a mouse or keyboard event occurs outside the [Popup](_Popup.md) control. The default is true. |
