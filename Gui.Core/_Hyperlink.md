...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.documents.hyperlink.aspx)
...
| Name | Description |
| --- | --- |
| ● *Command* | Gets or sets a command to associate with the [Hyperlink](_Hyperlink.md) |
...
| ● *NavigateUri* | Gets or sets a [Uri](../Gui.Providers/_Uri.md) to navigate to when the [Hyperlink](_Hyperlink.md) is activated |
| ● *TargetName* | Gets or sets the name of a target window or frame for the [Hyperlink](_Hyperlink.md) |
...
| Name | Description |
| --- | --- |
| ▸ *Click* | Occurs when the left mouse button is clicked on a [Hyperlink](_Hyperlink.md) |
