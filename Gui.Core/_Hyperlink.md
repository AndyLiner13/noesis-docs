Source: https://www.noesisengine.com/docs/Gui.Core._Hyperlink.html

# Hyperlink Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.documents.hyperlink.aspx)
...
| Name | Description |
| --- | --- |
| ● *Command* | Gets or sets a command to associate with the [Hyperlink](/Gui.Core/_Hyperlink.md) |
| ● *CommandParameter* | Gets or sets command parameters associated with the command specified |
| ● *CommandTarget* | Gets or sets a target element on which to execute the command specified |
| ● *NavigateUri* | Gets or sets a [Uri](/Gui.Providers/_Uri.md) to navigate to when the [Hyperlink](/Gui.Core/_Hyperlink.md) is activated |
| ● *TargetName* | Gets or sets the name of a target window or frame for the [Hyperlink](/Gui.Core/_Hyperlink.md) |

● Dependency Property   ○ Reflection Property

## From [Span](/Gui.Core/_Span.md)
...
Hyperlink has no attached properties
...
| Name | Description |
| --- | --- |
| ▸ *Click* | Occurs when the left mouse button is clicked on a [Hyperlink](/Gui.Core/_Hyperlink.md) |
| ▸ *RequestNavigate* | Occurs when navigation events are requested |
