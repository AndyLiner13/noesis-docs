...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.contextmenu.aspx)
...
| ● *IsOpen* | Gets or sets a value that indicates whether the [ContextMenu](_ContextMenu.md) is visible |
| ● *Placement* | Gets or sets the Placement property of a [ContextMenu](_ContextMenu.md) |
| ● *PlacementRectangle* | Gets or sets the area relative to which the context menu is positioned when it opens |
| ● *PlacementTarget* | Gets or sets the [UIElement](_UIElement.md) relative to which the [ContextMenu](_ContextMenu.md) is positioned when it opens |
| ● *StaysOpen* | Gets or sets a value that indicates whether the [ContextMenu](_ContextMenu.md) should close automatically |
...
| Name | Description |
| --- | --- |
| ▸ *Closed* | Occurs when a particular instance of a [ContextMenu](_ContextMenu.md) closes |
