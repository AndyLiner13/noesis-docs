Source: https://www.noesisengine.com/docs/Gui.Core._ContextMenu.html

# ContextMenu Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.contextmenu.aspx)
...
| ● *IsOpen* | Gets or sets a value that indicates whether the [ContextMenu](/Gui.Core/_ContextMenu.md) is visible |
| ● *Placement* | Gets or sets the Placement property of a [ContextMenu](/Gui.Core/_ContextMenu.md) |
| ● *PlacementRectangle* | Gets or sets the area relative to which the context menu is positioned when it opens |
| ● *PlacementTarget* | Gets or sets the [UIElement](/Gui.Core/_UIElement.md) relative to which the [ContextMenu](/Gui.Core/_ContextMenu.md) is positioned when it opens |
| ● *StaysOpen* | Gets or sets a value that indicates whether the [ContextMenu](/Gui.Core/_ContextMenu.md) should close automatically |
...
| Name | Description |
| --- | --- |
| ▸ *Closed* | Occurs when a particular instance of a [ContextMenu](/Gui.Core/_ContextMenu.md) closes |
