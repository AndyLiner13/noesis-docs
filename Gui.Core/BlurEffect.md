...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.effects.blureffect)
...
- [Effect](https://www.noesisengine.com/docs/Gui.Core._Effect.html)
- BlurEffect
...
| Property | Description |
|----------|-------------|
| Radius | Gets or sets a value that indicates the radius of the blur effect. |

## Attached Properties

BlurEffect has no attached properties
