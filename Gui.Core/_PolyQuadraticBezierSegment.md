...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.polyquadraticbeziersegment)
...
| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [PolyQuadraticBezierSegment](_PolyQuadraticBezierSegment.md) to the path |
