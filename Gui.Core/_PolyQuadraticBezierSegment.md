Source: https://www.noesisengine.com/docs/Gui.Core._PolyQuadraticBezierSegment.html

# PolyQuadraticBezierSegment Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.polyquadraticbeziersegment)
...
• [PathSegment](/Gui.Core/_PathSegment.md)
...
| Name | Description |
| --- | --- |
| ● *Points* | Gets or sets the end point of the line segment. |

● Dependency Property   ○ Reflection Property

## From [PathSegment](/Gui.Core/_PathSegment.md)
...
PolyQuadraticBezierSegment has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [PolyQuadraticBezierSegment](/Gui.Core/_PolyQuadraticBezierSegment.md) to the path |
...
PolyQuadraticBezierSegment has no events