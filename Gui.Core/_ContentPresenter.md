Source: https://www.noesisengine.com/docs/Gui.Core._ContentPresenter.html

# ContentPresenter Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.contentpresenter.aspx)

Displays the content of [ContentControl](/Gui.Core/_ContentControl.md).
...
• [ScrollContentPresenter](/Gui.Core/_ScrollContentPresenter.md)
