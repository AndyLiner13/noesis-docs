...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.contentpresenter.aspx)

Displays the content of [ContentControl](_ContentControl.md).
...
• [ScrollContentPresenter](_ScrollContentPresenter.md)
