...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.gradientbrush.aspx)

Defines an abstract class that describes a gradient, composed of gradient stops. Classes that inherit from [GradientBrush](_GradientBrush.md) describe different ways of interpreting gradient stops.
...
• [LinearGradientBrush](_LinearGradientBrush.md)

• [RadialGradientBrush](_RadialGradientBrush.md)
