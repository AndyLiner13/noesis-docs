...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.frameworkelement.aspx)

Provides GUI framework-level features for user interface elements.

[FrameworkElement](_FrameworkElement.md) extends [UIElement](_UIElement.md) and adds the following capabilities:
...
• [Decorator](_Decorator.md)

• [Image](_Image.md)

• [ItemsPresenter](_ItemsPresenter.md)
...
• [TextBlock](_TextBlock.md)

• [TextElement](_TextElement.md)

• [TickBar](_TickBar.md)

• [ToolBarTray](_ToolBarTray.md)
