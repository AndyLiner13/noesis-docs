Source: https://www.noesisengine.com/docs/Gui.Core._FrameworkElement.html

# FrameworkElement Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.frameworkelement.aspx)

Provides GUI framework-level features for user interface elements.

[FrameworkElement](/Gui.Core/_FrameworkElement.md) extends [UIElement](/Gui.Core/_UIElement.md) and adds the following capabilities:
...
• [Adorner](/Gui.Core/_Adorner.md)

• [AdornerLayer](/Gui.Core/_AdornerLayer.md)

• [BaseDefinition](/Gui.Core/_BaseDefinition.md)

• [BaseGridViewRowPresenter](/Gui.Controls/_BaseGridViewRowPresenter.md)

• [BoxShadow](/App.Shaders/_BoxShadow.md)

• [ContentPresenter](/Gui.Core/_ContentPresenter.md)

• [Control](/Gui.Core/_Control.md)

• [Decorator](/Gui.Core/_Decorator.md)

• [Image](/Gui.Core/_Image.md)

• [ItemsPresenter](/Gui.Core/_ItemsPresenter.md)

• [MediaElement](/App.MediaElement/_MediaElement.md)

• [Mesh](/Gui.Core/_Mesh.md)

• [Panel](/Gui.Core/_Panel.md)

• [Popup](/Gui.Core/_Popup.md)

• [RiveControl](/App.RiveBase/_RiveControl.md)

• [Shape](/Gui.Core/_Shape.md)

• [TextBlock](/Gui.Core/_TextBlock.md)

• [TextElement](/Gui.Core/_TextElement.md)

• [TickBar](/Gui.Core/_TickBar.md)

• [ToolBarTray](/Gui.Core/_ToolBarTray.md)

• [Track](/Gui.Core/_Track.md)

• [Viewbox](/Gui.Core/_Viewbox.md)
...
FrameworkElement has no attached properties
