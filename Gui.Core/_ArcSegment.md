...
## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.arcsegment)
...
| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [ArcSegment](/Gui.Core/_ArcSegment.md) to the path |
