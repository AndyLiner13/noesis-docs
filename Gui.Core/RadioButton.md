...
### From [BaseButton](https://www.noesisengine.com/docs/Gui.Core._BaseButton.html)
...
| Indeterminate | Occurs when the state of a ToggleButton is neither on nor off. |
