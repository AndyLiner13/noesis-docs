Source: https://www.noesisengine.com/docs/Gui.Core._TranslateTransform.html

# TranslateTransform Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.translatetransform.aspx)
...
| Name | Description |
| --- | --- |
| ● *X* | Gets or sets the x-axis displacement |
| ● *Y* | Gets or sets the y-axis displacement |
...
TranslateTransform has no attached properties
...
TranslateTransform has no events