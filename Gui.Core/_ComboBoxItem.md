Source: https://www.noesisengine.com/docs/Gui.Core._ComboBoxItem.html

# ComboBoxItem Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.comboboxitem.aspx)

Implements a selectable item inside a [ComboBox](/Gui.Core/_ComboBox.md).
...
ComboBoxItem has no attached properties
