...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.comboboxitem.aspx)

Implements a selectable item inside a [ComboBox](_ComboBox.md).
...
## From [ListBoxItem](_ListBoxItem.md)
