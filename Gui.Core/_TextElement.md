Source: https://www.noesisengine.com/docs/Gui.Core._TextElement.html

# TextElement Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.documents.textelement.aspx)
...
TextElement has no attached properties
