Source: https://www.noesisengine.com/docs/Gui.Core._Shape.html

# Shape Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.shapes.shape.aspx)
...
Shape has no attached properties
