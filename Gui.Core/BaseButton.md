...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.buttonbase.aspx)
...
- [ContentControl](https://www.noesisengine.com/docs/Gui.Core._ContentControl.html)
- BaseButton
- [Button](https://www.noesisengine.com/docs/Gui.Core._Button.html)
- [GridViewColumnHeader](https://www.noesisengine.com/docs/Gui.Controls._GridViewColumnHeader.html)
- [RepeatButton](https://www.noesisengine.com/docs/Gui.Core._RepeatButton.html)
- [ToggleButton](https://www.noesisengine.com/docs/Gui.Core._ToggleButton.html)
