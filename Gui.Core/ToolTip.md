...
| IsOpen | Gets or sets a value that indicates whether a ToolTip is visible |
| Placement | Gets or sets the orientation of the ToolTip control when it opens, and specifies how the ToolTip control behaves when it overlaps screen boundaries |
| PlacementRectangle | Gets or sets the rectangular area relative to which the ToolTip control is positioned when it opens |
| PlacementTarget | Gets or sets the UIElement relative to which the ToolTip is positioned when it opens |
| StaysOpen | Gets or sets a value that indicates whether an open ToolTip remains open until the user clicks the mouse when the mouse is not over the ToolTip |
...
| SetResourceReference(dp, name) | Sets up a resource reference in the target property to search for a specified name |
...
| Method | Description |
|--------|-------------|
| GetPopup() | Gets Popup where ToolTip is shown |
...
| Event | Description |
|-------|-------------|
| Closed | Occurs when a ToolTip is closed and is no longer visible |
| Opened | Occurs when a ToolTip becomes visible |