...
|----------|-------------|
| HasHeader | Gets a value that indicates whether this HeaderedItemsControl has a header |
...
| HeaderTemplate | Gets or sets the DataTemplate used to display the contents of the control's header |
| HeaderTemplateSelector | Gets or sets a DataTemplateSelector that provides custom logic for choosing the template used to display the header |
