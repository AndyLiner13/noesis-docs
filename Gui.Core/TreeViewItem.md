...
|----------|-------------|
| IsExpanded | Gets or sets whether the nested items in a TreeViewItem are expanded or collapsed |
| IsSelected | Gets or sets whether a TreeViewItem control is selected |
| IsSelectionActive | Gets a value that indicates whether the containing TreeView has keyboard focus |
...
| SetResourceReference(dp, name) | Sets up a resource reference in the target property to search for the specified name |
