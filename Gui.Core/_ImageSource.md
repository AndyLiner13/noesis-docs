Source: https://www.noesisengine.com/docs/Gui.Core._ImageSource.html

# ImageSource Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.imagesource.aspx)
...
• [DynamicTextureSource](/Gui.Core/_DynamicTextureSource.md)
...
ImageSource has no attached properties
