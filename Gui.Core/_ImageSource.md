...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.imagesource.aspx)
...
• [DynamicTextureSource](_DynamicTextureSource.md)
