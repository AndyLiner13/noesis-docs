...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.listbox.aspx)
...
| ● *SelectionMode* | Gets or sets the selection behavior for a [ListBox](_ListBox.md) |
