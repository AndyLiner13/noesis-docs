Source: https://www.noesisengine.com/docs/Gui.Core._PathSegment.html

# PathSegment Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.pathsegment)
...
• [ArcSegment](/Gui.Core/_ArcSegment.md)

• [BezierSegment](/Gui.Core/_BezierSegment.md)

• [LineSegment](/Gui.Core/_LineSegment.md)

• [PolyBezierSegment](/Gui.Core/_PolyBezierSegment.md)

• [PolyLineSegment](/Gui.Core/_PolyLineSegment.md)

• [PolyQuadraticBezierSegment](/Gui.Core/_PolyQuadraticBezierSegment.md)

• [QuadraticBezierSegment](/Gui.Core/_QuadraticBezierSegment.md)

# Properties

| Name | Description |
| --- | --- |
| ● *IsSmoothJoin* | Gets or sets a value that indicates whether the join between this [PathSegment](/Gui.Core/_PathSegment.md) and the previous [PathSegment](/Gui.Core/_PathSegment.md) is treated as a corner when it is stroked with a [Pen](/Gui.Core/_Pen.md) |
| ● *IsStroked* | Gets or sets a value that determines how the intersecting areas contained in this [PathSegment](/Gui.Core/_PathSegment.md) are combined |
...
PathSegment has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [PathSegment](/Gui.Core/_PathSegment.md) to the path |
