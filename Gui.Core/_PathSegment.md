...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.pathsegment)
...
• [ArcSegment](_ArcSegment.md)

• [BezierSegment](_BezierSegment.md)

• [LineSegment](_LineSegment.md)

• [PolyBezierSegment](_PolyBezierSegment.md)

• [PolyLineSegment](_PolyLineSegment.md)

• [PolyQuadraticBezierSegment](_PolyQuadraticBezierSegment.md)

• [QuadraticBezierSegment](_QuadraticBezierSegment.md)
