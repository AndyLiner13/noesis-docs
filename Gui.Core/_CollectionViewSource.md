...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.data.collectionviewsource.aspx)

Proxy of [CollectionView](_CollectionView.md) to be used from XAML files.
...
| ● *View* | Gets the view object that is currently associated with this instance of [CollectionViewSource](_CollectionViewSource.md) |
