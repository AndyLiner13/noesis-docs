Source: https://www.noesisengine.com/docs/Gui.Core._ShaderEffect.html

# ShaderEffect Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.effects.shadereffect)

Provides a custom bitmap effect by using a pixel shader.

Derive from the [ShaderEffect](/Gui.Core/_ShaderEffect.md) class to implement a custom effect based on a single pixel shader.
...
ShaderEffect has no attached properties
