...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.togglebutton.aspx)
...
• [CheckBox](_CheckBox.md)

• [RadioButton](_RadioButton.md)
