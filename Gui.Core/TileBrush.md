...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.tilebrush.aspx)
...
### From [Brush](https://www.noesisengine.com/docs/Gui.Core._Brush.html)
...
TileBrush has no attached properties
