Source: https://www.noesisengine.com/docs/Gui.Core._ProgressBar.html

# ProgressBar Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.progressbar.aspx)
...
| Name | Description |
| --- | --- |
| ● *IsIndeterminate* | Gets or sets whether the [ProgressBar](/Gui.Core/_ProgressBar.md) shows actual values or generic, continuous progress feedback |
| ● *Orientation* | Gets or sets the orientation of a [ProgressBar](/Gui.Core/_ProgressBar.md): horizontal or vertical. |
...
ProgressBar has no attached properties
