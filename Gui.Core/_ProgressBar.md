...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.progressbar.aspx)
...
| Name | Description |
| --- | --- |
| ● *IsIndeterminate* | Gets or sets whether the [ProgressBar](_ProgressBar.md) shows actual values or generic, continuous progress feedback |
| ● *Orientation* | Gets or sets the orientation of a [ProgressBar](_ProgressBar.md): horizontal or vertical. |
