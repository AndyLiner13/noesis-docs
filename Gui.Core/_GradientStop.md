Source: https://www.noesisengine.com/docs/Gui.Core._GradientStop.html

# GradientStop Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.gradientstop.aspx)
...
| ● *Offset* | Gets or sets the location of the gradient stop within the gradient vector |
...
GradientStop has no attached properties
