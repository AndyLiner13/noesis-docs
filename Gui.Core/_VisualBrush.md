Source: https://www.noesisengine.com/docs/Gui.Core._VisualBrush.html
...
| Name | Description |
| --- | --- |
| ● *Visual* | Gets or sets the brush's content. Remark that current implementation only works when visual refers to an element that is part of the logical tree |
...
VisualBrush has no attached properties
