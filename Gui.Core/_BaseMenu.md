Source: https://www.noesisengine.com/docs/Gui.Core._BaseMenu.html

# BaseMenu Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.menubase.aspx)
...
• [ContextMenu](/Gui.Core/_ContextMenu.md)

• [Menu](/Gui.Core/_Menu.md)
