...
| Property | Description |
|----------|-------------|
| ColumnDefinitions | Gets a ColumnDefinitionCollection defined on this instance of Grid |
| RowDefinitions | Gets a RowDefinitionCollection defined on this instance of Grid |
...
| Property | Description |
|----------|-------------|
| Column | Gets or sets a value that indicates which column child within a Grid should appear in |
| ColumnSpan | Gets or sets a value that indicates the number of columns that child spans within a Grid |
| IsSharedSizeScope | Gets or sets a value that indicates that multiple Grid elements are sharing size information |
| Row | Gets or sets a value that indicates which row child within a Grid should appear in |
| RowSpan | Gets or sets a value that indicates the number of rows that child spans within a Grid |
