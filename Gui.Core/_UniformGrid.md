Source: https://www.noesisengine.com/docs/Gui.Core._UniformGrid.html

# UniformGrid Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.uniformgrid.aspx)
...
| Name | Description |
| --- | --- |
| ● *Columns* | Gets or set the number of columns that are in the grid |
