...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.itemspresenter.aspx)

Used within the template of an ItemControl to specify the place in the control's visual tree where the ItemsPanel defined by the [ItemsControl](_ItemsControl.md) is to be added.
