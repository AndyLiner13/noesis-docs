...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.dashstyle.aspx)

Represents the sequence of dashes and gaps that will be applied by a [Pen](https://www.noesisengine.com/docs/Gui.Core._Pen.html).
