Source: https://www.noesisengine.com/docs/Gui.Core._Image.html

# Image Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.image.aspx)
...
| Name | Description |
| --- | --- |
| ● *Source* | Gets or sets image source |
| ● *Stretch* | Gets or sets a value that describes how an [Image](/Gui.Core/_Image.md) should be stretched to fill the destination rectangle |
...
Image has no attached properties
