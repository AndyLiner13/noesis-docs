...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.image.aspx)
...
| ● *Stretch* | Gets or sets a value that describes how an [Image](_Image.md) should be stretched to fill the destination rectangle |
