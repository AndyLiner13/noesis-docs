...
- Child: Gets or sets the single child of a Viewbox element
- Stretch: Gets or sets the Viewbox Stretch mode, which determines how content fits into the available space
- StretchDirection: Gets or sets the StretchDirection, which determines how scaling is applied to the contents of a Viewbox
