...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.gridsplitter.aspx)

Represents the control that redistributes space between columns or rows of a [Grid](_Grid.md) control.
...
| Name | Description |
| --- | --- |
| ● *DragIncrement* | Gets or sets the distance that user must drag the [GridSplitter](_GridSplitter.md) control to resize columns or rows. |
| ● *KeyboardIncrement* | Gets or sets [GridSplitter](_GridSplitter.md)'s step size when moving it with arrow keys. |
| ● *PreviewStyle* | Gets or sets the [Style](_Style.md) of the [GridSplitter](_GridSplitter.md) control preview which is displayed when the ShowsPreview property is set to true. |
| ● *ResizeBehavior* | Gets or sets whichs columns or rows to resize relative to the column or row in which the [GridSplitter](_GridSplitter.md) control is definied. |
| ● *ResizeDirection* | Gets or sets whether to resize columns or rows. |
| ● *ShowsPreview* | Gets or sets whether column or row size should be updated as the [GridSplitter](_GridSplitter.md) is being dragged. |

● Dependency Property   ○ Reflection Property

## From [Thumb](_Thumb.md)

| Name | Description |
| --- | --- |
| ● *IsDragging* | Gets whether the [Thumb](_Thumb.md) control has logical focus and mouse capture and the left mouse button is pressed |
...
| Name | Description |
| --- | --- |
| ▸ *DragCompleted* | Occurs when the [Thumb](_Thumb.md) control loses mouse capture |
| ▸ *DragDelta* | Occurs one or more times as the mouse changes position when a [Thumb](_Thumb.md) control has logical focus and mouse capture |
| ▸ *DragStarted* | Occurs when a [Thumb](_Thumb.md) control receives logical focus and mouse capture |
