Source: https://www.noesisengine.com/docs/Gui.Core._GridSplitter.html

# GridSplitter Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.gridsplitter.aspx)

Represents the control that redistributes space between columns or rows of a [Grid](/Gui.Core/_Grid.md) control.
...
| Name | Description |
| --- | --- |
| ● *DragIncrement* | Gets or sets the distance that user must drag the [GridSplitter](/Gui.Core/_GridSplitter.md) control to resize columns or rows. |
| ● *KeyboardIncrement* | Gets or sets [GridSplitter](/Gui.Core/_GridSplitter.md)'s step size when moving it with arrow keys. |
| ● *PreviewStyle* | Gets or sets the [Style](/Gui.Core/_Style.md) of the [GridSplitter](/Gui.Core/_GridSplitter.md) control preview which is displayed when the ShowsPreview property is set to true. |
| ● *ResizeBehavior* | Gets or sets whichs columns or rows to resize relative to the column or row in which the [GridSplitter](/Gui.Core/_GridSplitter.md) control is definied. |
| ● *ResizeDirection* | Gets or sets whether to resize columns or rows. |
| ● *ShowsPreview* | Gets or sets whether column or row size should be updated as the [GridSplitter](/Gui.Core/_GridSplitter.md) is being dragged. |

● Dependency Property   ○ Reflection Property

## From [Thumb](/Gui.Core/_Thumb.md)

| Name | Description |
| --- | --- |
| ● *IsDragging* | Gets whether the [Thumb](/Gui.Core/_Thumb.md) control has logical focus and mouse capture and the left mouse button is pressed |
...
GridSplitter has no attached properties
...
| Name | Description |
| --- | --- |
|  *CancelDrag()* | Cancels current dragging operation |
...
| Name | Description |
| --- | --- |
| ▸ *DragCompleted* | Occurs when the [Thumb](/Gui.Core/_Thumb.md) control loses mouse capture |
| ▸ *DragDelta* | Occurs one or more times as the mouse changes position when a [Thumb](/Gui.Core/_Thumb.md) control has logical focus and mouse capture |
| ▸ *DragStarted* | Occurs when a [Thumb](/Gui.Core/_Thumb.md) control receives logical focus and mouse capture |
