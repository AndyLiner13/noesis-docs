...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.columndefinition.aspx)

Defines column-specific properties that apply to [Grid](_Grid.md) elements.
...
• [BaseDefinition](_BaseDefinition.md)
...
| ● *Width* | Gets or sets column width defined by a [GridLength](_GridLength.md) value. Default is 1\* |

● Dependency Property   ○ Reflection Property

## From [BaseDefinition](_BaseDefinition.md)

| Name | Description |
| --- | --- |
| ● *SharedSizeGroup* | Gets or sets a value that identifies a [ColumnDefinition](_ColumnDefinition.md) or [RowDefinition](_RowDefinition.md) as a member of a defined group that shares sizing properties. |
...
| Name | Description |
| --- | --- |
|  *GetActualWidth()* | Gets a value that represents the actual calculated width of a [ColumnDefinition](_ColumnDefinition.md) |
