Source: https://www.noesisengine.com/docs/Gui.Core._ColumnDefinition.html

# ColumnDefinition Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.columndefinition.aspx)

Defines column-specific properties that apply to [Grid](/Gui.Core/_Grid.md) elements.
...
| ● *Width* | Gets or sets column width defined by a [GridLength](/Gui.Core/_GridLength.md) value. Default is 1\* |

● Dependency Property   ○ Reflection Property

## From [BaseDefinition](/Gui.Core/_BaseDefinition.md)

| Name | Description |
| --- | --- |
| ● *SharedSizeGroup* | Gets or sets a value that identifies a [ColumnDefinition](/Gui.Core/_ColumnDefinition.md) or [RowDefinition](/Gui.Core/_RowDefinition.md) as a member of a defined group that shares sizing properties. |
...
| Name | Description |
| --- | --- |
|  *GetActualWidth()* | Gets a value that represents the actual calculated width of a [ColumnDefinition](/Gui.Core/_ColumnDefinition.md) |
