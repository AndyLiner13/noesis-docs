Source: https://www.noesisengine.com/docs/Gui.Core._Effect.html

# Effect Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.effects.effect)

Provides a custom bitmap effect.

Derive from the [Effect](/Gui.Core/_Effect.md) class to implement a custom bitmap effect. In most cases, you will derive from [ShaderEffect](/Gui.Core/_ShaderEffect.md).
...
• [BlurEffect](/Gui.Core/_BlurEffect.md)

• [DropShadowEffect](/Gui.Core/_DropShadowEffect.md)
...
Effect has no attached properties
