...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.effects.effect)

Provides a custom bitmap effect.

Derive from the [Effect](_Effect.md) class to implement a custom bitmap effect. In most cases, you will derive from [ShaderEffect](_ShaderEffect.md).
...
• [BlurEffect](_BlurEffect.md)

• [DropShadowEffect](_DropShadowEffect.md)

• [ShaderEffect](_ShaderEffect.md)
