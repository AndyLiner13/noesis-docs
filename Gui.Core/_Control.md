Source: https://www.noesisengine.com/docs/Gui.Core._Control.html

# Control Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.control.aspx)
...
• [Separator](/Gui.Core/_Separator.md)
...
Control has no attached properties
