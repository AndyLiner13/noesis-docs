...
- IsContainerVirtualizable: Gets or sets a value that indicates whether this VirtualizingPanel should virtualize an item
- IsVirtualizing: Gets or sets a value that indicates if virtualization is turned on or off in the ItemsControl
