...
![github](https://www.noesisengine.com/docs/github.png) [Tutorial Data](https://github.com/Noesis/Tutorials/tree/master/Samples/Touch)
...
The next example creates a [TextBox](_TextBox.md) and uses *PanningMode* as an attached property. It sets *PanningMode* to *VerticalOnly*.
...
[UIElement](_UIElement.md) defines the following events that you can subscribe to so your application can respond to touch:
...
In our [Application Framework](ApplicationTutorial.md#command-line-switches) the command line '--emulate\_touch' can be used to enable the emulation of touch input from mouse events.
...
Tapped, DoubleTapped, RightTapped and Holding are taken from the UWP equivalents. Not being part of WPF, these events are implemented as [extensions](ExtensionsTutorial.md#gesture-events).
