Source: https://www.noesisengine.com/docs/Gui.Core._GroupBox.html

# GroupBox Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.forms.groupbox.aspx)
...
GroupBox has no attached properties
