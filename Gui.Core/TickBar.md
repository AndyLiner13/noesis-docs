...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.tickbar.aspx)

Represents a control that draws a set of tick marks for a [Slider](https://www.noesisengine.com/docs/Gui.Core._Slider.html) control.
...
|----------|-------------|
| Fill | Gets or sets the Brush that is used to draw the tick marks |
| IsDirectionReversed | Gets or sets the direction of increasing value of the tick marks |
| IsSelectionRangeEnabled | Gets or sets whether the TickBar displays a selection range |
...
| Placement | Gets or sets where tick marks appear relative to a Track of a Slider control |
| ReservedSpace | Gets or sets a space buffer for the area that contains the tick marks that are specified for a TickBar |
