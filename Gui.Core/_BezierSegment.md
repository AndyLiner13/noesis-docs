...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.beziersegment)
...
| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [BezierSegment](_BezierSegment.md) to the path |
