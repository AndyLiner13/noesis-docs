Source: https://www.noesisengine.com/docs/Gui.Core._BezierSegment.html

# BezierSegment Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.beziersegment)
...
| ● *Point3* | Gets or sets the third control point of the curve. |
...
BezierSegment has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [BezierSegment](/Gui.Core/_BezierSegment.md) to the path |
