Source: https://www.noesisengine.com/docs/Gui.Core._ScaleTransform.html

# ScaleTransform Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.scaletransform.aspx)
...
| Name | Description |
| --- | --- |
| ● *CenterX* | Gets or sets the x-coordinate of the scale center point |
| ● *CenterY* | Gets or sets the y-coordinate of the scale center point |
...
ScaleTransform has no attached properties
