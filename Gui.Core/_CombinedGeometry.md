...
## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.combinedgeometry.aspx)

Represents a 2D geometric shape defined by the combination of two [Geometry](/Gui.Core/_Geometry.md) objects.
...
| Name | Description |
| --- | --- |
| ● *Geometry1* | Gets or sets the first [Geometry](/Gui.Core/_Geometry.md) object of this [CombinedGeometry](/Gui.Core/_CombinedGeometry.md) object. |
| ● *Geometry2* | Gets or sets the second [Geometry](/Gui.Core/_Geometry.md) object of this [CombinedGeometry](/Gui.Core/_CombinedGeometry.md) object. |
