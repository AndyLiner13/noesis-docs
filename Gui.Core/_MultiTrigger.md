Source: https://www.noesisengine.com/docs/Gui.Core._MultiTrigger.html

# MultiTrigger Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.multitrigger.aspx)
...
MultiTrigger has no attached properties
