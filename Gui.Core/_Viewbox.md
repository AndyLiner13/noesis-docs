Source: https://www.noesisengine.com/docs/Gui.Core._Viewbox.html

# Viewbox Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.viewbox.aspx)
...
| Name | Description |
| --- | --- |
| ○ *Child* | Gets or sets the single child of a [Viewbox](/Gui.Core/_Viewbox.md) element |
| ● *Stretch* | Gets or sets the [Viewbox](/Gui.Core/_Viewbox.md) *Stretch* mode, which determines how content fits into the available space |
| ● *StretchDirection* | Gets or sets the *StretchDirection*, which determines how scaling is applied to the contents of a [Viewbox](/Gui.Core/_Viewbox.md) |
...
Viewbox has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *GetStretchScale(elementSize, availableSize, stretch, stretchDirection)* | Returns the scale necessary to stretch element size to the available size |
