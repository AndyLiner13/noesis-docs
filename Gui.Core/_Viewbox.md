...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.viewbox.aspx)
...
| Name | Description |
| --- | --- |
| ○ *Child* | Gets or sets the single child of a [Viewbox](_Viewbox.md) element |
| ● *Stretch* | Gets or sets the [Viewbox](_Viewbox.md) *Stretch* mode, which determines how content fits into the available space |
| ● *StretchDirection* | Gets or sets the *StretchDirection*, which determines how scaling is applied to the contents of a [Viewbox](_Viewbox.md) |
