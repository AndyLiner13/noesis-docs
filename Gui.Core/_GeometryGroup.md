Source: https://www.noesisengine.com/docs/Gui.Core._GeometryGroup.html

# GeometryGroup Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.geometrygroup.aspx)

Represents a composite geometry, composed of other [Geometry](/Gui.Core/_Geometry.md) objects.

A [GeometryGroup](/Gui.Core/_GeometryGroup.md) creates a composite geometry from any number of geometry objects. [GeometryGroup](/Gui.Core/_GeometryGroup.md) uses the *FillRule* property to specify how its geometry objects are combined.
...
| Name | Description |
| --- | --- |
| ● *Children* | Gets or sets the GeometryCollection that contains the objects that define this [GeometryGroup](/Gui.Core/_GeometryGroup.md) |
| ● *FillRule* | Gets or sets how the intersecting areas of the objects contained in this [GeometryGroup](/Gui.Core/_GeometryGroup.md) are combined |
