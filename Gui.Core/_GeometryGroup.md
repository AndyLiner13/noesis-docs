...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.geometrygroup.aspx)

Represents a composite geometry, composed of other [Geometry](_Geometry.md) objects.

A [GeometryGroup](_GeometryGroup.md) creates a composite geometry from any number of geometry objects. [GeometryGroup](_GeometryGroup.md) uses the *FillRule* property to specify how its geometry objects are combined.
...
| Name | Description |
| --- | --- |
| ● *Children* | Gets or sets the GeometryCollection that contains the objects that define this [GeometryGroup](_GeometryGroup.md) |
| ● *FillRule* | Gets or sets how the intersecting areas of the objects contained in this [GeometryGroup](_GeometryGroup.md) are combined |
