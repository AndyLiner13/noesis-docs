...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.panel.aspx)

Provides a base class for all [Panel](_Panel.md) elements. Use [Panel](_Panel.md) elements to position and arrange child objects.
...
[Panel](_Panel.md) contains a collection of [UIElement](_UIElement.md) objects, which are in the Children property. Adding a [UIElement](_UIElement.md) child to a [Panel](_Panel.md) implicitly adds it to the [UIElementCollection](_UIElementCollection.md) for the [Panel](_Panel.md) element.

[Panel](_Panel.md) elements do not receive mouse events if a Background is not defined. If you need to handle mouse events but do not want a background for your [Panel](_Panel.md), use Transparent.
...
• [DockPanel](_DockPanel.md)

• [Grid](_Grid.md)

• [StackPanel](_StackPanel.md)

• [TabPanel](_TabPanel.md)

• [ToolBarOverflowPanel](_ToolBarOverflowPanel.md)

• [UniformGrid](_UniformGrid.md)

• [VirtualizingPanel](_VirtualizingPanel.md)

• [WrapPanel](_WrapPanel.md)
