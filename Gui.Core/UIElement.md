...
Much of the input (keyboard, mouse and touch) and focusing behavior for elements in general is also defined in the UIElement class.
...
UIElement has no attached properties
