...
![Changelog_v32_8.png](/Changelog_v32_8/png.md)
...
- Fixed Crash using invalid property in [DataTemplate](/Gui.Core/_DataTemplate.md) trigger (#BS1327, #BS1328, #BS1329).
- Fixed Circular reference in [ResourceDictionary](/Gui.Core/_ResourceDictionary.md) causing stack overflow ([#4369](https://www.noesisengine.com/bugs/view.php?id=4369)).
...
- Fixed Crash processing a [NullExtension](/Gui.Core/_NullExtension.md) without active property (#BS1473-#BS1497).
- Fixed View calling renderer *ResolveRenderTarget* without matching *SetRenderTarget*.
- Fixed [VisualBrush](/Gui.Core/_VisualBrush.md) sometimes rendering black.
...
- Feature Implemented [VirtualizingWrapPanel](/Gui.Core/_VirtualizingWrapPanel.md) ([#2346](https://www.noesisengine.com/bugs/view.php?id=2346)).
- Feature Support for building AOT projects with .NET 8+.
- Enhancement Improve draw batching performance using SIMD.
- Enhancement Add [Mesh](/Gui.Core/_Mesh.md) element for rendering [MeshData](/Gui.Core/_MeshData.md).
- Enhancement Support *XamlReader.Load* from Stream ([#1471](https://www.noesisengine.com/bugs/view.php?id=1471)).
- Enhancement Speed up [DataTrigger](/Gui.Core/_DataTrigger.md) initialization by 20% ([#4218](https://www.noesisengine.com/bugs/view.php?id=4218)).
- Enhancement Guarantee [UpdateTexture](/Gui.Core/RenderDeviceNotes.md#noesisgui-3-2) never called during render pass ([#3981](https://www.noesisengine.com/bugs/view.php?id=3981)).
...
- Fixed Update [VirtualizingStackPanel](/Gui.Core/_VirtualizingStackPanel.md) cached item sizes on remove/move.
...
- Fixed Focus leaving [TabItem](/Gui.Core/_TabItem.md) header unexpectedly.
- Fixed [ContentPresenter](/Gui.Core/_ContentPresenter.md) template recreated unnecessarily on *Content* change.
- Fixed [TextBox](/Gui.Core/_TextBox.md) caret invisible when focused on load.
- Fixed Crash on shutdown if extended object already disposed.
- Fixed Glitches with nested [VisualBrushes](/Gui.Core/_VisualBrush.md) ([#4237](https://www.noesisengine.com/bugs/view.php?id=4237)).
- Fixed Wrong *LayoutTransform* size with *Skew* or *Rotate*.
- Fixed [ToolTip](/Gui.Core/_ToolTip.md) shown incorrectly when switching with BetweenShowDelay=0.
- Fixed [ImageBrush](/Gui.Core/_ImageBrush.md) using [DynamicTextureSource](/Gui.Core/_DynamicTextureSource.md) not rendering ([#4238](https://www.noesisengine.com/bugs/view.php?id=4238)).
...
- Fixed Crash using [TextBox](/Gui.Core/_TextBox.md) *GetRangeBounds* when focused.
- Fixed [ContentPresenter](/Gui.Core/_ContentPresenter.md) context not updating after measure ([#4386](https://www.noesisengine.com/bugs/view.php?id=4386)).
...
- Enhancement Unreal Context menu added for textures to apply [premultiply-alpha](/Gui.Core/UnrealTutorial.md#textures).
- Enhancement Unity Added support for Unity 6.1 (Built-in, URP, HDRP).
- Enhancement Unity [First Steps tutorial](/Gui.Core/Unity3DTutorial.md) thoroughly reviewed.
- Enhancement Unity Added [Widget3D](https://github.com/Noesis/Tutorials/tree/master/Samples/Widget3D) sample to package.
- Enhancement LangServer Added snippet for root [ResourceDictionary](/Gui.Core/_ResourceDictionary.md).
...
- Enhancement Virtualization cache added to [VirtualizingStackPanel](/Gui.Core/_VirtualizingStackPanel.md) (disabled by default).
...
- Enhancement Improved [PPAA antialiasing](/Gui.Core/AntialiasingTutorial.md#per-primitive-antialiasing) quality.
- Feature Added [GeometryGroup](/Gui.Core/_GeometryGroup.md) ([#1777](https://www.noesisengine.com/bugs/view.php?id=1777), [#1948](https://www.noesisengine.com/bugs/view.php?id=1948)).
- Feature Implemented [FrameworkElement](/Gui.Core/_FrameworkElement.md) *SetResourceReference* ([#3991](https://www.noesisengine.com/bugs/view.php?id=3991)).
- Feature App Added [BoxShadow](/Gui.Core/ExtensionsTutorial.md#boxshadow) for analytic blurred rectangles.
...
- Fixed Crash when closing [Menu](/Gui.Core/_Menu.md) after template reload.
- Fixed [Popup](/Gui.Core/_Popup.md) not capturing mouse when *StaysOpen* was false.
- Fixed [Popup](/Gui.Core/_Popup.md) invalidating *Binding* after source destruction.
- Fixed Dropdown in [ComboBox](/Gui.Core/_ComboBox.md) misbehaving when larger than space ([#2825](https://www.noesisengine.com/bugs/view.php?id=2825)).
- Fixed [MenuItems](/Gui.Core/_MenuItem.md) not hiding submenus on mouse leave outside [Menu](/Gui.Core/_Menu.md) / [ContextMenu](/Gui.Core/_ContextMenu.md).
- Fixed [DataTrigger](/Gui.Core/_DataTrigger.md) triggering on *Collapsed* elements ([#3928](https://www.noesisengine.com/bugs/view.php?id=3928)).
- Fixed Crash rendering text with [VisualBrush](/Gui.Core/_VisualBrush.md) without source.
- Fixed Crash when using a [VisualBrush](/Gui.Core/_VisualBrush.md) in text.
- Fixed Crash updating [ToolTip](/Gui.Core/_ToolTip.md) from removed template.
- Fixed InlineCollection changes cause text to disappear ([#3954](https://www.noesisengine.com/bugs/view.php?id=3954)).
- Fixed [TextBlock](/Gui.Core/_TextBlock.md) hit testing issue when *IsEnabled* is false ([#3969](https://www.noesisengine.com/bugs/view.php?id=3969)).
- Fixed Setters not affecting [TextBox](/Gui.Core/_TextBox.md) in template after typing.
- Fixed Crash with Placement=Custom in [Popup](/Gui.Core/_Popup.md) or [ToolTip](/Gui.Core/_ToolTip.md).
...
- Fixed Crash setting [InlineUIContainer](/Gui.Core/_InlineUIContainer.md) child to null.
...
- Fixed Infinite loop using [DataTemplate](/Gui.Core/_DataTemplate.md) within its own tree.
...
- Fixed Crash removing item from [ToolBar](/Gui.Core/_ToolBar.md) panel.
...
- Fixed Multiline [TextBox](/Gui.Core/_TextBox.md) mishandling rn line endings ([#4126](https://www.noesisengine.com/bugs/view.php?id=4126)).
- Fixed Division by zero in *RayThroughBounds* ([#4131](https://www.noesisengine.com/bugs/view.php?id=4131)).
- Fixed Random circles in [Path](/Gui.Core/_Path.md) with curves and *StrokeDashArray* ([#3911](https://www.noesisengine.com/bugs/view.php?id=3911)).
...
- Fixed [PathFigure](/Gui.Core/_PathFigure.md) not updating on *Segments* change ([#4073](https://www.noesisengine.com/bugs/view.php?id=4073)).
- Fixed Duplicate entries in [ItemsControl](/Gui.Core/_ItemsControl.md) after tree reattachment ([#4160](https://www.noesisengine.com/bugs/view.php?id=4160)).
...
- Fixed [TextBox](/Gui.Core/_TextBox.md) allows pasting beyond *MaxLength*.
...
- Fixed C# Native converters like [BooleanToVisibilityConverter](/Gui.Core/_BooleanToVisibilityConverter.md) unsupported.
- Fixed Unity ";Component" [Image](/Gui.Core/_Image.md) paths not found ([#3960](https://www.noesisengine.com/bugs/view.php?id=3960)).
- Fixed Unity [AdornerLayer](/Gui.Core/_AdornerLayer.md) not exposed for [AdornerDecorator](/Gui.Core/_AdornerDecorator.md) and [ScrollContentPresenter](/Gui.Core/_ScrollContentPresenter.md).
...
- Enhancement Performance improvements to [TextBlock](/Gui.Core/_TextBlock.md) layout regeneration.
...
- Enhancement LangServer Support for [SolidColorBrush](/Gui.Core/_SolidColorBrush.md) in *CapabilityColor*.
...
- Fixed [ItemContainerGenerator](/Gui.Core/_ItemContainerGenerator.md) with unrealized containers fails to *Move* elements sometimes.
- Fixed Division by zero with TickFrequency=0 in [Slider](/Gui.Core/_Slider.md).
...
- Fixed Crash loading an element with a [ContextMenu](/Gui.Core/_ContextMenu.md) with IsOpen=True.
- Fixed Division by zero when [ItemsControl](/Gui.Core/_ItemsControl.md) viewport is infinity.
- Fixed OneWay binding in [ToggleButton](/Gui.Core/_ToggleButton.md) stops working after click ([#2434](https://www.noesisengine.com/bugs/view.php?id=2434), [#3009](https://www.noesisengine.com/bugs/view.php?id=3009), [#3429](https://www.noesisengine.com/bugs/view.php?id=3429)).
- Fixed VGL incorrectly assuming batch hashes were non-colliding ([#3826](https://www.noesisengine.com/bugs/view.php?id=3826)).
- Fixed [TextBlock](/Gui.Core/_TextBlock.md) not invalidated when an inline image is set ([#3846](https://www.noesisengine.com/bugs/view.php?id=3846)).
- Fixed Hot reloading does not work inside [TabControl](/Gui.Core/_TabControl.md) *ContentTemplate* ([#3853](https://www.noesisengine.com/bugs/view.php?id=3853)).
...
- Fixed Unity Vulkan crash wrapping [TextureSource](/Gui.Core/_TextureSource.md) ([#3795](https://www.noesisengine.com/bugs/view.php?id=3795)).
...
- Fixed LangServer Crashing when a [ResourceDictionary](/Gui.Core/_ResourceDictionary.md) with *MergedDictionaries* set to a type which doesn't exist.
...
- Fixed [ComboBox](/Gui.Core/_ComboBox.md) can show multiple items selected at the same time ([#3334](https://www.noesisengine.com/bugs/view.php?id=3334)).
- Fixed *GetLocalValue* not returning correct value for properties with a read-only callback.
- Fixed Division by zero crash in [ItemsControl](/Gui.Core/_ItemsControl.md).
...
- Fixed Crash accessing destroyed [MenuItem](/Gui.Core/_MenuItem.md) when closing a [ContextMenu](/Gui.Core/_ContextMenu.md) ([#3763](https://www.noesisengine.com/bugs/view.php?id=3763)).
...
- Fixed Asserts destroying some [Popup](/Gui.Core/_Popup.md) and [TextBlock](/Gui.Core/_TextBlock.md) elements ([#3783](https://www.noesisengine.com/bugs/view.php?id=3783)).
- Fixed Crash calling *ToString* if [ContentControl](/Gui.Core/_ContentControl.md) Content was pointing to the control itself.
- Fixed OneWayToSource binding to [ContextMenu](/Gui.Core/_ContextMenu.md) IsOpen causes [AdornerDecorator](/Gui.Core/_AdornerDecorator.md) errors and stop working ([#3798](https://www.noesisengine.com/bugs/view.php?id=3798)).
...
- Fixed Crash in [LineDecoratorBehavior](/App.Interactivity/_LineDecorationBehavior.md) when adorned [TextBlock](/Gui.Core/_TextBlock.md) not yet arranged.
...
- Fixed [ListBox](/Gui.Core/_ListBox.md) items can be selected by receiving a *MouseUp* without a *MouseDown*.
...
- Fixed Crash opening a virtualized [ComboBox](/Gui.Core/_ComboBox.md) ([#3676](https://www.noesisengine.com/bugs/view.php?id=3676)).
- Fixed [ToolTips](/Gui.Core/_ToolTip.md) not working inside text inlines.
- Fixed [Slider](/Gui.Core/_Slider.md) *Ticks* property does not support dragging and snapping ([#3703](https://www.noesisengine.com/bugs/view.php?id=3703)).
...
- Fixed Memory leak setting DataContext=this and using a [ContentPresenter](/Gui.Core/_ContentPresenter.md) as root of the template.
- Fixed [MultiTrigger](/Gui.Core/_MultiTrigger.md) failing when several conditions use the same property.
...
- Fixed [Panel](/Gui.Core/_Panel.md) with DirectionalNavigation=None incorrectly receiving focus.
- Fixed Scroll position changing after focus was lost and returned ([#2717](https://www.noesisengine.com/bugs/view.php?id=2717)).
- Fixed View update enters infinite loop when adding to a [Panel](/Gui.Core/_Panel.md) the same element twice ([#3742](https://www.noesisengine.com/bugs/view.php?id=3742)).
- Fixed Crash measuring unconnected [Grid](/Gui.Core/_Grid.md) with a *SharedSizeGroup* ([#3741](https://www.noesisengine.com/bugs/view.php?id=3741)).
- Fixed [Slider](/Gui.Core/_Slider.md) with not positive min value slightly fluctuates after decreasing min value ([#3663](https://www.noesisengine.com/bugs/view.php?id=3663)).
- Fixed [Visual](/Gui.Core/_Visual.md) child of adorner is not rendered ([#3549](https://www.noesisengine.com/bugs/view.php?id=3549)).
...
- Feature Licenses are no longer necessary for [evaluations](/Gui.Core/Licensing.md#evaluation) lasting up to 10 minutes per session.
- Feature Implemented support for [Variable Fonts](/Gui.Core/TextTutorial.md#variable-fonts).
- Feature Support [VisualBrush](/Gui.Core/_VisualBrush.md) as an *OpacityMask* ([#2330](https://www.noesisengine.com/bugs/view.php?id=2330), [#1316](https://www.noesisengine.com/bugs/view.php?id=1316), [#711](https://www.noesisengine.com/bugs/view.php?id=711), [#650](https://www.noesisengine.com/bugs/view.php?id=650)).
...
- Enhancement LangServer Added support [StaticResource](/Gui.Core/_StaticResourceExtension.md) and [DynamicResource](/Gui.Core/_DynamicResourceExtension.md) ([#3178](https://www.noesisengine.com/bugs/view.php?id=3178)).
- Fixed [LocExtension](/App.ApplicationLauncher/_LocExtension.md) only supported in [FrameworkElement](/Gui.Core/_FrameworkElement.md) element properties ([#2847](https://www.noesisengine.com/bugs/view.php?id=2847)).
...
- Fixed [ListBox](/Gui.Core/_ListBox.md) and [ListView](/Gui.Controls/_ListView.md) not receiving mouse events when hovering outside the items.
- Fixed Boxing init crashing when multithreading disabled.
- Fixed Crash using [VisualBrush](/Gui.Core/_VisualBrush.md) inside 3D transformed elements.
...
- Fixed Crash in [TabControl](/Gui.Core/_TabControl.md) related to key handling ([#3239](https://www.noesisengine.com/bugs/view.php?id=3239)).
...
- Fixed [ToolTip](/Gui.Core/_ToolTip.md) is not affected by *WorldSpaceUI* scale ([#2721](https://www.noesisengine.com/bugs/view.php?id=2721)).
- Fixed *Width="Auto"* not working in [Expander](/Gui.Core/_Expander.md) when [UniformGrid](/Gui.Core/_UniformGrid.md) is a child ([#3247](https://www.noesisengine.com/bugs/view.php?id=3247)).
- Fixed Offscreen jittering ([#3277](https://www.noesisengine.com/bugs/view.php?id=3277)).
- Fixed Can't set *MinHeight* thumb of [ScrollBar](/Gui.Core/_ScrollBar.md) ([#3224](https://www.noesisengine.com/bugs/view.php?id=3224)).
...
- Fixed [AdornerLayer](/Gui.Core/_AdornerLayer.md) incorrectly applying transform 3D to itself.
- Fixed Division by zero in [Grid](/Gui.Core/_Grid.md) with 0\* column and span elements.
- Fixed [RangeBase](/Gui.Core/_RangeBase.md) can assert sometimes initializing *Minimum*, *Maximum* and *Value* properties.
...
- Fixed [TreeView](/Gui.Core/_TreeView.md) not updating *IsSelectionActive* property.
...
- Fixed Can't disable [ToolTip](/Gui.Core/_ToolTip.md) animation ([#1142](https://www.noesisengine.com/bugs/view.php?id=1142)).
- Fixed Width of element inside [VirtualizingStackPanel](/Gui.Core/_VirtualizingStackPanel.md) not updated correctly ([#2700](https://www.noesisengine.com/bugs/view.php?id=2700)).
...
- Fixed [TextBlock](/Gui.Core/_TextBlock.md) is limited to a text length of 65536 glyphs ([#3253](https://www.noesisengine.com/bugs/view.php?id=3253) [#3132](https://www.noesisengine.com/bugs/view.php?id=3132)).
...
- Fixed Crash accessing *Keyboard* on disconnected [TabItem](/Gui.Core/_TabItem.md) ([#3097](https://www.noesisengine.com/bugs/view.php?id=3097)).
- Fixed [TextBox](/Gui.Core/_TextBox.md) caret incorrectly rendered in world space UI ([#3407](https://www.noesisengine.com/bugs/view.php?id=3407)).
...
- Enhancement Implemented support for [Custom Language Servers](/Gui.Core/LanguageServer.md#custom-language-server).
- Enhancement Added XAML Preview support to Unity and Unreal in [Language Server](/Gui.Core/LanguageServer.md).
- Enhancement Support for *Assembly* and *Scheme* [providers](/Gui.Core/ProvidersTutorial.md#scheme-assemby-providers).
...
- Enhancement Implemented [LineDecorationBehavior](/App.Interactivity/_LineDecorationBehavior.md) extension for [TextBlock](/Gui.Core/_TextBlock.md) ([#2658](https://www.noesisengine.com/bugs/view.php?id=2658)).
...
- Enhancement Added support for [XY Focus Navigation](/Gui.Core/ExtensionsTutorial.md#xy-focus-navigation) ([#2406](https://www.noesisengine.com/bugs/view.php?id=2406)).
- Enhancement Significant performance improvements to [Delegates](/Gui.Core/CppArchitectureGuide.md#delegates).
...
- Fixed [ContextMenu](/Gui.Core/_ContextMenu.md) calling *CanExecute* on menu items before connecting to the tree.
...
- Fixed [Run](/Gui.Core/_Run.md) background not rendered when *Foreground* is transparent.
- Fixed Crash when disconnecting a [Visual](/Gui.Core/_Visual.md) with null children.
- Fixed Wrong viewport set when using horizontal [VirtualizingStackPanel](/Gui.Core/_VirtualizingStackPanel.md).
- Fixed [InlineUIContainer](/Gui.Core/_InlineUIContainer.md) child stays connected to the view when removed from container.
- Fixed Read access violation in *D3D12RenderDevice::UploadUniforms* ([#2924](https://www.noesisengine.com/bugs/view.php?id=2924)).
- Fixed Incorrect tiling of [ImageBrushes](/Gui.Core/_ImageBrush.md) with *Stretch=None* when using DPI scale.
...
- Fixed Selected item in [ComboBox](/Gui.Core/_ComboBox.md) not updating display text when content changes ([#2985](https://www.noesisengine.com/bugs/view.php?id=2985)).
- Fixed Crash calling *GetRangeBounds* in [TextBox](/Gui.Core/_TextBox.md) with debug pink template ([#2980](https://www.noesisengine.com/bugs/view.php?id=2980)).
...
- Fixed Namespace processing in [Language Server](/Gui.Core/LanguageServer.md) ([#2773](https://www.noesisengine.com/bugs/view.php?id=2773)).
...
- Fixed Crash when using complex [Path](/Gui.Core/_Path.md) tags ([#2706](https://www.noesisengine.com/bugs/view.php?id=2706)).
- Fixed Crash when having a [Popup](/Gui.Core/_Popup.md) with *IsOpen=True* in a template ([#2849](https://www.noesisengine.com/bugs/view.php?id=2849)).
- Fixed [TextBox](/Gui.Core/_TextBox.md) using graphemes to handle caret index and selection ([#2748](https://www.noesisengine.com/bugs/view.php?id=2748)).
- Fixed Empty [InlineUIContainer](/Gui.Core/_InlineUIContainer.md) not being correctly represented in [FormattedText](/Gui.Core/_FormattedText.md) ([#2856](https://www.noesisengine.com/bugs/view.php?id=2856)).
- Fixed Offscreen text blurriness ([#2965](https://www.noesisengine.com/bugs/view.php?id=2965)).
- Fixed Crash when [ToolTip](/Gui.Core/_ToolTip.md) gets destroyed while closing it ([#2840](https://www.noesisengine.com/bugs/view.php?id=2840)).
...
- Fixed Crash when [Trigger](/Gui.Core/_Trigger.md) destroyed while invoking actions.
...
- Fixed Unity Crash when using [ImageBrush](/Gui.Core/_ImageBrush.md) RenderTexture with D3D12 ([#2776](https://www.noesisengine.com/bugs/view.php?id=2776)).
...
- Fixed C# Crash using the *BindingCollection* of a [MultiBinding](/Gui.Core/_MultiBinding.md) ([#2693](https://www.noesisengine.com/bugs/view.php?id=2693)).
...
- Enhancement Implemented [Shader Compiler](/Gui.Core/ApplicationTutorial.md#shader-compiler) in the [App Framework](/Gui.Core/ApplicationTutorial.md).
- Enhancement New [BrushShaders](https://github.com/Noesis/Tutorials/tree/master/Samples/BrushShaders) example.
- Enhancement Implemented [FocusManager](/Gui.Core/_FocusManager.md) ([#811](https://www.noesisengine.com/bugs/view.php?id=811), [#1982](https://www.noesisengine.com/bugs/view.php?id=1982)).
...
- Enhancement Improvements on [VisualBrush](/Gui.Core/_VisualBrush.md) atlas allocations when sharing source visual.
- Enhancement C++ Added *TranslatePoint* method to [UIElement](/Gui.Core/_UIElement.md) in C++ ([#2668](https://www.noesisengine.com/bugs/view.php?id=2668))
...
- Fixed [ComboBox](/Gui.Core/_ComboBox.md) dropdown not updating its position when moving the control in 3D ([#2570](https://www.noesisengine.com/bugs/view.php?id=2570)).
- Fixed Bindings don't work in [ToolTip](/Gui.Core/_ToolTip.md) after opening it a second time ([#1977](https://www.noesisengine.com/bugs/view.php?id=1977)).
- Fixed [ComboBox](/Gui.Core/_ComboBox.md) drop down entries in wrong world space position ([#2570](https://www.noesisengine.com/bugs/view.php?id=2570)).
...
- Fixed Crash when setting *Stretch* to *Fill* on [Path](/Gui.Core/_Path.md) with [BackgroundEffectBehavior](/App.Interactivity/_BackgroundEffectBehavior.md) ([#2608](https://www.noesisengine.com/bugs/view.php?id=2608)).
- Fixed Issues with [ScrollViewer](/Gui.Core/_ScrollViewer.md) and keyboard focus ([#2597](https://www.noesisengine.com/bugs/view.php?id=2597)).
- Fixed Directional focus can't be moved to controls inside [ItemsControl](/Gui.Core/_ItemsControl.md) items ([#2599](https://www.noesisengine.com/bugs/view.php?id=2599)).
...
- Fixed Added *ResolvedSource* property to [BindingExpression](/Gui.Core/_BindingExpression.md).
...
- Fixed Improve [PropertyPath](/Gui.Core/_PropertyPath.md) error messages for boxed values ([#2627](https://www.noesisengine.com/bugs/view.php?id=2627)).
...
- Fixed [MenuItem](/Gui.Core/_MenuItem.md) *IsChecked* binding not working properly ([#2656](https://www.noesisengine.com/bugs/view.php?id=2656)).
...
- Fixed [BrushShader](/Gui.Core/_BrushShader.md) textures not processed with unset constant buffer ([#2538](https://www.noesisengine.com/bugs/view.php?id=2538)).
...
- Fixed [ControlStoryboardAction](/App.Interactivity/_ControlStoryboardAction.md) inside [ControlTemplates](/Gui.Core/_ControlTemplate.md) only works for one instance ([#2653](https://www.noesisengine.com/bugs/view.php?id=2653)).
...
- Fixed Unity [EventTrigger](/Gui.Core/_EventTrigger.md) failing with *NullReferenceException* when event not found ([#2671](https://www.noesisengine.com/bugs/view.php?id=2671)).
...
- Fixed Unity [TextBox](/Gui.Core/_TextBox.md) and [PasswordBox](/Gui.Core/_PasswordBox.md) not receiving focus in WebGL ([#2609](https://www.noesisengine.com/bugs/view.php?id=2609)).
...
- Fixed Unity Performance improvements of [VisualTreeHelper](/Gui.Core/_VisualTreeHelper.md) *HitTest* version with callbacks ([#2677](https://www.noesisengine.com/bugs/view.php?id=2677)).
...
- Enhancement New [Linear Rendering](/Gui.Core/LinearRenderingTutorial.md) tutorial.
...
- Enhancement Unreal Support for texture [Material parameters](/Gui.Core/UnrealTutorial.md#materials) ([#2547](https://www.noesisengine.com/bugs/view.php?id=2547)).
- Enhancement Unreal Added linear *Point4D* properties for vector [Material parameters](/Gui.Core/UnrealTutorial.md#materials).
...
- Fixed [ApplicationCommands](/Gui.Core/_ApplicationCommands.md) can be referenced only by name ([#2574](https://www.noesisengine.com/bugs/view.php?id=2574)).
- Fixed [KeyboardNavigation](/Gui.Core/_KeyboardNavigation.md) failing to focus "off-screen" controls inside a [ScrollViewers](/Gui.Core/_ScrollViewer.md) ([#2242](https://www.noesisengine.com/bugs/view.php?id=2242)).
...
- Fixed [Selector](/Gui.Core/_Selector.md) only updates selection if the removed item is the first selected item ([#2582](https://www.noesisengine.com/bugs/view.php?id=2582)).
...
- Enhancement Updated [Unity](/Gui.Core/Unity3DTutorial.md) and [Unreal](/Gui.Core/UnrealTutorial.md) tutorials.
...
- Fixed [ToolBar](/Gui.Core/_ToolBar.md) overflow is empty ([#2534](https://www.noesisengine.com/bugs/view.php?id=2534)).
- Fixed [ImageBrush](/Gui.Core/_ImageBrush.md) not taking into account image dpi scale.
- Fixed Missing [ImageSource](/Gui.Core/_ImageSource.md) converter in [CroppedBitmap](/Gui.Core/_CroppedBitmap.md) Source property.
...
- Fixed Assert setting Header in [HeaderedItemsControl](/Gui.Core/_HeaderedItemsControl.md) with [DataTrigger](/Gui.Core/_DataTrigger.md) ([#2494](https://www.noesisengine.com/bugs/view.php?id=2494)).

# Version 3.2.0b2

*Released 2 Feb 2023* - [Download](https://www.noesisengine.com/developers/downloads.php)

- Feature [Inspector](/Gui.Core/InspectorTutorial.md) and [VSCode](https://marketplace.visualstudio.com/items?itemName=NoesisTechnologies.noesisgui-tools) extension are now available for macOS ([#1894](https://www.noesisengine.com/bugs/view.php?id=1894)).
- Enhancement New [Tic-Tac-Toe](https://github.com/Noesis/Tutorials/tree/master/Samples/TicTacToe) example.
- Enhancement New [Localization](/Gui.Core/LocalizationTutorial.md) tutorial.
...
- Fixed Crash in TSF when collapsing focused [TextBox](/Gui.Core/_TextBox.md) ([#2492](https://www.noesisengine.com/bugs/view.php?id=2492)).
...
- Feature Implemented a new *Text Shaping* algorithm ([#1788](https://www.noesisengine.com/bugs/view.php?id=1788) [#1412](https://www.noesisengine.com/bugs/view.php?id=1412) [#2091](https://www.noesisengine.com/bugs/view.php?id=2091)) which includes:
  ...
  - [Unicode Bidirectional Algorithm](/Gui.Core/BidiTutorial.md).
  - Emoji sequences.
...
- Feature New [RiveControl](/App.RiveBase/_RiveControl.md) for rendering content created with [Rive](https://rive.app/). The Rive Editor brings familiar design and animation tools to create interactive content for your apps and games. We also created an example on [GitHub](https://github.com/Noesis/Tutorials/tree/master/Samples/Rive/C%2B%2B) showcasing this integration.
  ...
  ![Changelog_v32_3.jpg](/Changelog_v32_3/jpg.md)
- Feature Implemented [BackgroundEffect](/App.Interactivity/_BackgroundEffectBehavior.md) behavior, which can be used to apply an [effect](/Gui.Core/ShadersTutorial.md), such as [blur](/Gui.Core/_BlurEffect.md), to all elements behind a panel. We designed it to allow effects to be applied to the UI and rendered scene together, in both Unreal and Unity. We have created an example on [GitHub](https://github.com/Noesis/Tutorials/tree/master/Samples/BackgroundBlur) showcasing this behavior.

  ![Changelog_v32_4.jpg](/Changelog_v32_4/jpg.md)

- Feature Support for [Single Pass Stereo Rendering](/Gui.Core/Transform3DTutorial.md#single-pass-stereo). UI elements are rendered simultaneously to the left and right eye buffers. This is more efficient for the CPU as both eye share the work required by traversing and culling the visual tree.

  - *IRenderer* provides a new *Render()* method for sending both stereo projection matrices to the GPU.![Changelog_v32_5.jpg](/Changelog_v32_5/jpg.md)
...
- Feature Added *World Space UI*. UI elements are integrated and occluded in the 3D-scene. This enables new world UI use-cases, and removes the need for render textures in most situations.
  ...
  - Added *Tracked Device* input events to *IView*.![Changelog_v32_6.jpg](/Changelog_v32_6/jpg.md)
...
- Feature Curves are now rendered and uploaded to the GPU with a much faster and more precise algorithm. This new technique also handles strokes with higher quality by using offset quadratics. All curves are now internally converted to quadratic Beziers ([#1522](https://www.noesisengine.com/bugs/view.php?id=1522)). *[Image from Baldur's Gate 3 - Larian Studios]*
  ...
  ![Changelog_v32_7.jpg](/Changelog_v32_7/jpg.md)
- Feature [Hot Reload](/Gui.Core/HotReloadTutorial.md) algorithm has been reimplemented. Edited XAML files are now parsed for changes, and those changes are sent to the running app. UI state is preserved, only controls and properties affected by changes are updated.
...
- Feature [Typography](/Gui.Core/_Typography.md) class implemented ([#2397](https://www.noesisengine.com/bugs/view.php?id=2397)).
  ...
  ```
- Feature Added *GetMemoryBase* to [Stream](/Gui.Core/ProvidersTutorial.md) class to support memory mapped files.
- Feature App *LocalXamlProvider* and *LocalTextureProvider* are now raising [Reloaded](/Gui.Core/ProvidersTutorial.md#hot-reload) events.
- Feature App All our examples are now compatible with *Hot Reload* by passing the [command line](/Gui.Core/HotReloadTutorial.md#hot-reload-in-sdk-samples) '--root data\_path'. This switch overrides the default embedded provider with a local provider.
...
- Feature [RichText](/App.ApplicationLauncher/_RichText.md) is a new attached property for [TextBlock](/Gui.Core/_TextBlock.md) which formats *BBCode* into *Inlines*.
...
- Enhancement [PasswordBox](/Gui.Core/_PasswordBox.md) showing the last typed character for <n> seconds ([#2356](https://www.noesisengine.com/bugs/view.php?id=2356)).
- Enhancement IntegrationAPI Added *GUI::DisableSocketInit* to avoid sockets initialization in *Profile* builds.
- Enhancement New [Events](/Gui.Core/EventsTutorial.md) and [Code-Behind](/Gui.Core/CodeBehindTutorial.md) tutorials.
- Enhancement New [NS\_CONNECT\_FIELD](/Gui.Core/CodeBehindTutorial.md#x-name-directive) macro for easier x:Name Code-behind connection.
...
- Enhancement API Breaking Changes:
  ...
  - If you are implementing a custom *RenderDevice*, please read our [RenderDevice API](/Gui.Core/RenderDeviceNotes.md) document.
  - Added support for setting *BlendingMode* in *DrawingContext*.
    ...
    context->Pop();
    ```
  - Trimming properties *TrimStart*, *TrimEnd* and *TrimOffset* moved from [Pen](/Gui.Core/_Pen.md) to [Geometry](/Gui.Core/_Geometry.md).
...
## [Version 3.1](/Gui.Core/Changelog_v31.md)

## [Version 3.0](/Gui.Core/Changelog_v30.md)
