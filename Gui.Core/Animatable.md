...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.animation.animatable.aspx)
...
- Animatable
- [AttachableObject](https://www.noesisengine.com/docs/App.Interactivity._AttachableObject.html)
- [BaseFreezableCollection](https://www.noesisengine.com/docs/Gui.Core._BaseFreezableCollection.html)
- [BaseView](https://www.noesisengine.com/docs/Gui.Controls._BaseView.html)
- [Brush](https://www.noesisengine.com/docs/Gui.Core._Brush.html)
- [BrushShader](https://www.noesisengine.com/docs/Gui.Core._BrushShader.html)
- [ComparisonCondition](https://www.noesisengine.com/docs/App.Interactivity._ComparisonCondition.html)
- [ConditionalExpression](https://www.noesisengine.com/docs/App.Interactivity._ConditionalExpression.html)
- [Geometry](https://www.noesisengine.com/docs/Gui.Core._Geometry.html)
- [GradientBrush](https://www.noesisengine.com/docs/Gui.Core._GradientBrush.html)
- [ImageSource](https://www.noesisengine.com/docs/Gui.Core._ImageSource.html)
- [KeyFrame](https://www.noesisengine.com/docs/Gui.Animation._KeyFrame.html)
- [MatrixTransform](https://www.noesisengine.com/docs/Gui.Core._MatrixTransform.html)
- [MatrixTransform3D](https://www.noesisengine.com/docs/Gui.Core._MatrixTransform3D.html)
- [RotateTransform](https://www.noesisengine.com/docs/Gui.Core._RotateTransform.html)
- [ScaleTransform](https://www.noesisengine.com/docs/Gui.Core._ScaleTransform.html)
- [SkewTransform](https://www.noesisengine.com/docs/Gui.Core._SkewTransform.html)
- [Storyboard](https://www.noesisengine.com/docs/Gui.Animation._Storyboard.html)
...
- [Transform](https://www.noesisengine.com/docs/Gui.Core._Transform.html)
- [Transform3D](https://www.noesisengine.com/docs/Gui.Core._Transform3D.html)
- [TransformGroup](https://www.noesisengine.com/docs/Gui.Core._TransformGroup.html)
- [TranslateTransform](https://www.noesisengine.com/docs/Gui.Core._TranslateTransform.html)
- [VisualState](https://www.noesisengine.com/docs/Gui.Animation._VisualState.html)
- [VisualStateGroup](https://www.noesisengine.com/docs/Gui.Animation._VisualStateGroup.html)
- [VisualTransition](https://www.noesisengine.com/docs/Gui.Animation._VisualTransition.html)
...
Animatable has no attached properties
