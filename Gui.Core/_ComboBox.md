Source: https://www.noesisengine.com/docs/Gui.Core._ComboBox.html

# ComboBox Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.combobox.aspx)
...
| ● *IsEditable* | Gets or sets a value that enables or disables editing of text in text box of the [ComboBox](/Gui.Core/_ComboBox.md) |
...
| ● *StaysOpenOnEdit* | Gets or sets whether a [ComboBox](/Gui.Core/_ComboBox.md) that is open and displays a drop-down control will remain open when a user clicks the [TextBox](/Gui.Core/_TextBox.md). |
...
| Name | Description |
| --- | --- |
|  *ScrollIntoView(item)* | Causes the item to scroll into view. If it is not visible, it is aligned either at the top or bottom of the viewport. Note this will only work if drop down is open. |
