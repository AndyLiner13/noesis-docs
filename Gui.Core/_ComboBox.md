...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.combobox.aspx)
...
| ● *IsEditable* | Gets or sets a value that enables or disables editing of text in text box of the [ComboBox](_ComboBox.md) |
...
| ● *StaysOpenOnEdit* | Gets or sets whether a [ComboBox](_ComboBox.md) that is open and displays a drop-down control will remain open when a user clicks the [TextBox](_TextBox.md). |
