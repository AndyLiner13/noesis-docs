Source: https://www.noesisengine.com/docs/Gui.Core._VirtualizingWrapPanel.html

# VirtualizingWrapPanel Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace)

A high-performance [WrapPanel](/Gui.Core/_WrapPanel.md) that supports UI virtualization, designed for use in both horizontal and vertical layouts.

This panel arranges its child elements sequentially in a wrapping fashion, either horizontally or vertically, and only creates UI elements that are visible within the viewport, reducing memory usage and improving rendering performance for large collections.
...
![VirtualizingWrapPanel0.png](/VirtualizingWrapPanel0/png.md)
...
• [VirtualizingPanel](/Gui.Core/_VirtualizingPanel.md)
...
| Name | Description |
| --- | --- |
| ● *ItemHeight* | Gets or sets a value that specifies the height of all items contained in the panel |
| ● *ItemWidth* | Gets or sets a value that specifies the width of all items contained in the panel |
| ● *Orientation* | Gets or sets orientation of children elements |
...
## From [Panel](/Gui.Core/_Panel.md)

| Name | Description |
| --- | --- |
| ● *Background* | Gets or sets panel background |
| ○ *Children* | Gets children collection |
| ● *IsItemsHost* | Gets or sets a value that indicates that this [Panel](/Gui.Core/_Panel.md) is a container for user interface (UI) items that are generated by an [ItemsControl](/Gui.Core/_ItemsControl.md). |
...
## From [VirtualizingPanel](/Gui.Core/_VirtualizingPanel.md)

| Name | Description |
| --- | --- |
| ● *CacheLength* | Gets or sets the size of the cache before and after the viewport when is virtualizing |
| ● *CacheLengthUnit* | Gets or sets the type of unit that is used by the CacheLength property |
| ● *IsContainerVirtualizable* | Gets or sets a value that indicates whether this [VirtualizingPanel](/Gui.Core/_VirtualizingPanel.md) should virtualize an item |
| ● *IsVirtualizing* | Gets or sets a value that indicates if virtualization is turned on or off in the [ItemsControl](/Gui.Core/_ItemsControl.md) |
| ● *ScrollUnit* | Gets or sets a value that indicates if scrolling is measured as items or as pixels |
| ● *VirtualizationMode* | Gets or sets how a panel in an [ItemsControl](/Gui.Core/_ItemsControl.md) virtualizes its child items |
...
| Name | Description |
| --- | --- |
|  *BringIndexIntoView(index)* | Generates the item at the specified index and calls BringIntoView on it |
|  *GetItemContainerGenerator()* | The generator associated with this panel |
