...
A high-performance [WrapPanel](_WrapPanel.md) that supports UI virtualization, designed for use in both horizontal and vertical layouts.
...
![VirtualizingWrapPanel0.png](https://www.noesisengine.com/docs/VirtualizingWrapPanel0.png)
...
• [VirtualizingPanel](_VirtualizingPanel.md)
...
## From [Panel](_Panel.md)

| Name | Description |
| --- | --- |
| ● *Background* | Gets or sets panel background |
| ○ *Children* | Gets children collection |
| ● *IsItemsHost* | Gets or sets a value that indicates that this [Panel](_Panel.md) is a container for user interface (UI) items that are generated by an [ItemsControl](_ItemsControl.md). |
...
## From [VirtualizingPanel](_VirtualizingPanel.md)
...
| ● *IsContainerVirtualizable* | Gets or sets a value that indicates whether this [VirtualizingPanel](_VirtualizingPanel.md) should virtualize an item |
| ● *IsVirtualizing* | Gets or sets a value that indicates if virtualization is turned on or off in the [ItemsControl](_ItemsControl.md) |
| ● *ScrollUnit* | Gets or sets a value that indicates if scrolling is measured as items or as pixels |
| ● *VirtualizationMode* | Gets or sets how a panel in an [ItemsControl](_ItemsControl.md) virtualizes its child items |
