Source: https://www.noesisengine.com/docs/Gui.Core._TileBrush.html

# TileBrush Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.tilebrush.aspx)
...
• [ImageBrush](/Gui.Core/_ImageBrush.md)

• [VisualBrush](/Gui.Core/_VisualBrush.md)
