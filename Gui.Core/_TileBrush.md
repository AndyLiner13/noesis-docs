...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.tilebrush.aspx)
...
• [ImageBrush](_ImageBrush.md)

• [VisualBrush](_VisualBrush.md)
