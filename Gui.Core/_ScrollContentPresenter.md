Source: https://www.noesisengine.com/docs/Gui.Core._ScrollContentPresenter.html

# ScrollContentPresenter Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.scrollcontentpresenter.aspx)

Displays the content of a [ScrollViewer](/Gui.Core/_ScrollViewer.md) control.
...
• [ContentPresenter](/Gui.Core/_ContentPresenter.md)
...
| Name | Description |
| --- | --- |
| ○ *AdornerLayer* | Gets adorner layer |
| ● *CanContentScroll* | Indicates whether the content, if it supports IScrollInfo, should be allowed to control scrolling |
...
| ○ *ScrollOwner* | Gets or sets a [ScrollViewer](/Gui.Core/_ScrollViewer.md) element that controls scrolling behavior |
...
## From [ContentPresenter](/Gui.Core/_ContentPresenter.md)
...
| ● *ContentTemplateSelector* | Gets or sets the [DataTemplateSelector](/Gui.Core/_DataTemplateSelector.md), which allows the application writer to provide custom logic for choosing the template that is used to display the content of the control. |
...
ScrollContentPresenter has no attached properties
...
|  *MakeVisible(visual, rect)* | Forces content to scroll until the coordinate space of a [Visual](/Gui.Core/_Visual.md) object is visible |
|  *MouseWheelDown(delta)* | Scrolls down within content after a user spins the wheel button on a mouse. Delta value indicates the number of turns made on the mouse wheel. Number of lines advanced on each wheel turn can be configured in the operating system |
|  *MouseWheelLeft(delta)* | Scrolls left within content after a user spins the wheel button on a mouse. Delta value indicates the number of turns made on the mouse wheel. Number of lines advanced on each wheel turn can be configured in the operating system |
|  *MouseWheelRight(delta)* | Scrolls right within content after a user spins the wheel button on a mouse. Delta value indicates the number of turns made on the mouse wheel. Number of lines advanced on each wheel turn can be configured in the operating system |
|  *MouseWheelUp(delta)* | Scrolls up within content after a user spins the wheel button on a mouse. Delta value indicates the number of turns made on the mouse wheel. Number of lines advanced on each wheel turn can be configured in the operating system |
