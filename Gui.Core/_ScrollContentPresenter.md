...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.scrollcontentpresenter.aspx)

Displays the content of a [ScrollViewer](_ScrollViewer.md) control.
...
• [ContentPresenter](_ContentPresenter.md)
...
| ○ *ScrollOwner* | Gets or sets a [ScrollViewer](_ScrollViewer.md) element that controls scrolling behavior |
...
## From [ContentPresenter](_ContentPresenter.md)
...
| ● *ContentTemplateSelector* | Gets or sets the [DataTemplateSelector](_DataTemplateSelector.md), which allows the application writer to provide custom logic for choosing the template that is used to display the content of the control. |
...
|  *MakeVisible(visual, rect)* | Forces content to scroll until the coordinate space of a [Visual](_Visual.md) object is visible |
