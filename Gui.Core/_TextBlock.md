Source: https://www.noesisengine.com/docs/Gui.Core._TextBlock.html

# TextBlock Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.textblock.aspx)

Provides a lightweight control for displaying small amounts of text content.

A [TextBlock](/Gui.Core/_TextBlock.md) can contain a string in its *Text* property or *Inline* flow content elements, such as [Bold](/Gui.Core/_Bold.md), [Hyperlink](/Gui.Core/_Hyperlink.md), and [InlineUIContainer](/Gui.Core/_InlineUIContainer.md), in its *Inlines* property.

[TextBlock](/Gui.Core/_TextBlock.md) is designed to be lightweight, and is geared specifically at integrating small portions of flow content into a user interface (UI). [TextBlock](/Gui.Core/_TextBlock.md) is optimized for single-line display, and provides good performance for displaying up to a few lines of content.

Horizontally aligning text within a [TextBlock](/Gui.Core/_TextBlock.md) is done with the *TextAlignment* property. Aligning the [TextBlock](/Gui.Core/_TextBlock.md) within the layout of the page is done with the *HorizontalAlignment* and *VerticalAlignment* properties.
...
| Name | Description |
| --- | --- |
| ● *Background* | Gets or sets the [Brush](/Gui.Core/_Brush.md) used to fill the background of content area. |
| ● *CharacterSpacing* | Gets or sets the uniform spacing between characters, in units of 1/1000 of an em. |
| ○ *FirstInlineIsFromText* | Indicates if first inline is generated from Text property |
| ● *FontFamily* | Gets or sets the preferred top-level font family for the [TextBlock](/Gui.Core/_TextBlock.md). |
| ● *FontSize* | Gets or sets the top-level font size for the [TextBlock](/Gui.Core/_TextBlock.md). |
| ● *FontStretch* | Gets or sets the top-level font stretch for the [TextBlock](/Gui.Core/_TextBlock.md). |
| ● *FontStyle* | Gets or sets the top-level font style for the [TextBlock](/Gui.Core/_TextBlock.md). |
| ● *FontWeight* | Gets or sets the top-level font weight for the [TextBlock](/Gui.Core/_TextBlock.md). |
| ● *Foreground* | Gets or sets the [Brush](/Gui.Core/_Brush.md) to apply to the text contents of the [TextBlock](/Gui.Core/_TextBlock.md). |
| ○ *FormattedText* | Returns the object used to layout and render text for this [TextBlock](/Gui.Core/_TextBlock.md) |
| ○ *Inlines* | Gets an InlineCollection containing the top-level [Inline](/Gui.Core/_Inline.md) elements that comprise the contents of the [TextBlock](/Gui.Core/_TextBlock.md) |
| ● *LineHeight* | Gets or sets the height of each line of content |
| ● *LineStackingStrategy* | Gets or sets the mechanism by which a line box is determined for each line of text |
...
| ● *Text* | Gets or sets text string |
| ● *TextAlignment* | Gets or sets text alignment |
| ● *TextDecorations* | Gets or sets the text decoration to apply to the text |
| ● *TextTrimming* | Gets or sets the text trimming behavior to employ when content overflows the content area |
| ● *TextWrapping* | Gets or sets text wrapping |
| ○ *Typography* | Gets the currently effective typography variations for the text contents of this [TextBlock](/Gui.Core/_TextBlock.md) |
...
TextBlock has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *HasInlines()* | Indicates if this [TextBlock](/Gui.Core/_TextBlock.md) contains any inlines (avoids creating Inlines if not needed) |
