...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.textblock.aspx)

Provides a lightweight control for displaying small amounts of text content.

A [TextBlock](_TextBlock.md) can contain a string in its *Text* property or *Inline* flow content elements, such as [Bold](_Bold.md), [Hyperlink](_Hyperlink.md), and [InlineUIContainer](_InlineUIContainer.md), in its *Inlines* property.

[TextBlock](_TextBlock.md) is designed to be lightweight, and is geared specifically at integrating small portions of flow content into a user interface (UI). [TextBlock](_TextBlock.md) is optimized for single-line display, and provides good performance for displaying up to a few lines of content.

Horizontally aligning text within a [TextBlock](_TextBlock.md) is done with the *TextAlignment* property. Aligning the [TextBlock](_TextBlock.md) within the layout of the page is done with the *HorizontalAlignment* and *VerticalAlignment* properties.
...
| Name | Description |
| --- | --- |
| ● *Background* | Gets or sets the [Brush](_Brush.md) used to fill the background of content area. |
...
| ● *FontFamily* | Gets or sets the preferred top-level font family for the [TextBlock](_TextBlock.md). |
| ● *FontSize* | Gets or sets the top-level font size for the [TextBlock](_TextBlock.md). |
| ● *FontStretch* | Gets or sets the top-level font stretch for the [TextBlock](_TextBlock.md). |
| ● *FontStyle* | Gets or sets the top-level font style for the [TextBlock](_TextBlock.md). |
| ● *FontWeight* | Gets or sets the top-level font weight for the [TextBlock](_TextBlock.md). |
| ● *Foreground* | Gets or sets the [Brush](_Brush.md) to apply to the text contents of the [TextBlock](_TextBlock.md). |
| ○ *FormattedText* | Returns the object used to layout and render text for this [TextBlock](_TextBlock.md) |
| ○ *Inlines* | Gets an InlineCollection containing the top-level [Inline](_Inline.md) elements that comprise the contents of the [TextBlock](_TextBlock.md) |
...
| ○ *Typography* | Gets the currently effective typography variations for the text contents of this [TextBlock](_TextBlock.md) |
...
| Name | Description |
| --- | --- |
|  *HasInlines()* | Indicates if this [TextBlock](_TextBlock.md) contains any inlines (avoids creating Inlines if not needed) |
