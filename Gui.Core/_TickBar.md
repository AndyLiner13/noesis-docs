...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.tickbar.aspx)

Represents a control that draws a set of tick marks for a [Slider](_Slider.md) control.
...
| Name | Description |
| --- | --- |
| ● *Fill* | Gets or sets the [Brush](_Brush.md) that is used to draw the tick marks |
| ● *IsDirectionReversed* | Gets or sets the direction of increasing value of the tick marks |
| ● *IsSelectionRangeEnabled* | Gets or sets whether the [TickBar](_TickBar.md) displays a selection range |
...
| ● *Placement* | Gets or sets where tick marks appear relative to a [Track](_Track.md) of a [Slider](_Slider.md) control |
| ● *ReservedSpace* | Gets or sets a space buffer for the area that contains the tick marks that are specified for a [TickBar](_TickBar.md) |
