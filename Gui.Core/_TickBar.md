Source: https://www.noesisengine.com/docs/Gui.Core._TickBar.html

# TickBar Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.tickbar.aspx)

Represents a control that draws a set of tick marks for a [Slider](/Gui.Core/_Slider.md) control.
...
| Name | Description |
| --- | --- |
| ● *Fill* | Gets or sets the [Brush](/Gui.Core/_Brush.md) that is used to draw the tick marks |
| ● *IsDirectionReversed* | Gets or sets the direction of increasing value of the tick marks |
| ● *IsSelectionRangeEnabled* | Gets or sets whether the [TickBar](/Gui.Core/_TickBar.md) displays a selection range |
...
| ● *Placement* | Gets or sets where tick marks appear relative to a [Track](/Gui.Core/_Track.md) of a [Slider](/Gui.Core/_Slider.md) control |
| ● *ReservedSpace* | Gets or sets a space buffer for the area that contains the tick marks that are specified for a [TickBar](/Gui.Core/_TickBar.md) |
...
| ● *Ticks* | Gets or sets the positions of the tick marks. For example, "0.5 1.0 43" or "0.5,1.0,43" |
...
TickBar has no attached properties
