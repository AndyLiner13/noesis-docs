...
| ContentTemplate | Gets or sets the template used to display the content of the ContentControl |
| ContentTemplateSelector | Gets or sets a DataTemplateSelector that provides custom logic for choosing the template used to display the content |
| HasContent | Gets a value that indicates whether the ContentControl contains content |
...
| PPAAMode | Gets or sets a value indicating whether antialiasing geometry is generated for this element. This property is inherited down by the visual tree |
...
| IsDeferredScrollingEnabled | Gets or sets a value that indicates whether the ScrollViewer should scroll contents immediately during a thumb drag or defer until a drag completes |
| PanningDeceleration | Gets or sets the rate ScrollViewer slows in pixel per squared millisecond when in inertia |
| PanningMode | Gets or sets the way ScrollViewer reacts to touch manipulation |
...
| ScrollToHorizontalOffset(offset) | Scrolls the content within the ScrollViewer to the specified horizontal offset position. |
...
| ScrollToVerticalOffset(offset) | Scrolls the content within the ScrollViewer to the specified vertical offset position. |
