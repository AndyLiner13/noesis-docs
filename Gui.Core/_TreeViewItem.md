Source: https://www.noesisengine.com/docs/Gui.Core._TreeViewItem.html

# TreeViewItem Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.treeviewitem.aspx)

Implements a selectable item in a [TreeView](/Gui.Core/_TreeView.md) control.
...
| Name | Description |
| --- | --- |
| ● *IsExpanded* | Gets or sets whether the nested items in a [TreeViewItem](/Gui.Core/_TreeViewItem.md) are expanded or collapsed |
| ● *IsSelected* | Gets or sets whether a [TreeViewItem](/Gui.Core/_TreeViewItem.md) control is selected |
| ● *IsSelectionActive* | Gets a value that indicates whether the containing [TreeView](/Gui.Core/_TreeView.md) has keyboard focus |
...
| ▸ *Selected* | Occurs when the IsSelected property of a [TreeViewItem](/Gui.Core/_TreeViewItem.md) changes from false to true |
| ▸ *Unselected* | Occurs when the IsSelected property of a [TreeViewItem](/Gui.Core/_TreeViewItem.md) changes from true to false |
