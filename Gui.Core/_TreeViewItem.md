...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.treeviewitem.aspx)

Implements a selectable item in a [TreeView](_TreeView.md) control.
...
| Name | Description |
| --- | --- |
| ● *IsExpanded* | Gets or sets whether the nested items in a [TreeViewItem](_TreeViewItem.md) are expanded or collapsed |
| ● *IsSelected* | Gets or sets whether a [TreeViewItem](_TreeViewItem.md) control is selected |
| ● *IsSelectionActive* | Gets a value that indicates whether the containing [TreeView](_TreeView.md) has keyboard focus |
...
| ▸ *Selected* | Occurs when the IsSelected property of a [TreeViewItem](_TreeViewItem.md) changes from false to true |
| ▸ *Unselected* | Occurs when the IsSelected property of a [TreeViewItem](_TreeViewItem.md) changes from true to false |
