...
|----------|-------------|
| Background | Gets or sets border background |
| BorderBrush | Gets or sets border brush |
| BorderThickness | Gets or sets border thickness |
| CornerRadius | Gets or sets corner radius |
| Padding | Gets or sets the amount of space between a border and its child element |
...
Border has no attached properties

## Methods

### From [Decorator](https://www.noesisengine.com/docs/Gui.Core._Decorator.html)
