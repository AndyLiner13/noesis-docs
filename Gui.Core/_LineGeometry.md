Source: https://www.noesisengine.com/docs/Gui.Core._LineGeometry.html

# LineGeometry Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.linegeometry.aspx)
...
LineGeometry has no attached properties
