Source: https://www.noesisengine.com/docs/Gui.Core._BaseFreezableCollection.html

# BaseFreezableCollection Class

## namespace [Noesis](_ClassHierarchy.md#noesis-namespace)

Base class implementation for a [FreezableCollection](_FreezableCollection.md).
