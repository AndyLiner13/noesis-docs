Source: https://www.noesisengine.com/docs/Gui.Core._DashStyle.html

# DashStyle Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.dashstyle.aspx)

Represents the sequence of dashes and gaps that will be applied by a [Pen](/Gui.Core/_Pen.md).
...
| Name | Description |
| --- | --- |
| ● *Dashes* | Gets or sets the collection of dashes and gaps in this [DashStyle](/Gui.Core/_DashStyle.md) |
...
DashStyle has no attached properties
