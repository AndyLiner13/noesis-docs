...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.dashstyle.aspx)

Represents the sequence of dashes and gaps that will be applied by a [Pen](_Pen.md).
...
| Name | Description |
| --- | --- |
| ● *Dashes* | Gets or sets the collection of dashes and gaps in this [DashStyle](_DashStyle.md) |
