...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.track.aspx)

Represents a control primitive that handles the positioning and sizing of a [Thumb](_Thumb.md) control and two [RepeatButton](_RepeatButton.md) controls that are used to set a Value.
...
| Name | Description |
| --- | --- |
| ○ *DecreaseRepeatButton* | Gets the [RepeatButton](_RepeatButton.md) that decreases the *Value* property of the [Track](_Track.md) |
| ○ *IncreaseRepeatButton* | Gets the [RepeatButton](_RepeatButton.md) that increases the *Value* property of the [Track](_Track.md) class |
| ● *IsDirectionReversed* | Gets or sets if the direction of increasing *Value* is reversed from the default direction |
| ● *Maximum* | Gets or sets the maximum possible *Value* of the [Track](_Track.md) |
| ● *Minimum* | Gets or sets the minimum possible *Value* of the [Track](_Track.md) |
| ● *Orientation* | Defines the different orientations that a control or layout can have |
| ○ *Thumb* | Gets the [Thumb](_Thumb.md) control that is used to change the *Value* of a [Track](_Track.md) |
| ● *Value* | Gets or sets the current value of the [Track](_Track.md) as determined by the position of the [Thumb](_Thumb.md) |
...
| Name | Description |
| --- | --- |
|  *ValueFromDistance(horizontal, vertical)* | Calculates the change in the *Value* of the [Track](_Track.md) when the [Thumb](_Thumb.md) moves |
|  *ValueFromPoint(point)* | Calculates the distance value from a specified point along the [Track](_Track.md) |
