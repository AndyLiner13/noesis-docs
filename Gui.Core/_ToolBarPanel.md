...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.toolbarpanel.aspx)

Arranges [ToolBar](_ToolBar.md) items inside a [ToolBar](_ToolBar.md).
...
• [StackPanel](_StackPanel.md)

• *ToolBarPanel*

# Properties

## From [StackPanel](_StackPanel.md)
