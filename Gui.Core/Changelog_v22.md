...
- Feature Added *Placeholder* text extension for [TextBlock](/Gui.Core/_TextBlock.md) and [PasswordBox](/Gui.Core/_PasswordBox.md) templates.
...
- Feature Unity New Visual Studio [Project Template](/Gui.Core/Unity3DTutorial.md#blend).
...
- Fixed Crash using [InlineUIContainer](/Gui.Core/_InlineUIContainer.md) inside style ([#1594](https://www.noesisengine.com/bugs/view.php?id=1594)).
...
- Fixed Crash changing *IsDropDownOpen* while destroying [ComboBox](/Gui.Core/_ComboBox.md).
- Fixed [ComboBox](/Gui.Core/_ComboBox.md) closing dropdown when changing item collection.
- Fixed [ComboBox](/Gui.Core/_ComboBox.md) moving focus to dropdown or edit box when not focused.
...
- Fixed Changes to *Row* and *Column* in [Grid](/Gui.Core/_Grid.md) while measuring being ignored ([#1582](https://www.noesisengine.com/bugs/view.php?id=1582)).
...
- Fixed [Style](/Gui.Core/_Style.md) resource not applied to GridViewColumn's *DisplayMemberBinding* ([#1570](https://www.noesisengine.com/bugs/view.php?id=1570)).
...
- Fixed [Separator](/Gui.Core/_Separator.md) control not rendering ([#1602](https://www.noesisengine.com/bugs/view.php?id=1602)).
...
- Fixed Unity Exception creating multiple [TextureSource](/Gui.Core/_TextureSource.md) ([#1607](https://www.noesisengine.com/bugs/view.php?id=1607)).
...
- Enhancement Unity Added note to [Blend tutorial](/Gui.Core/BlendTutorial.unity.md#blend-project) conflicts with Visual Studio project name.
...
- Enhancement Improved [documentation](/Gui.Core/MarkupExtensions.md#staticextension) about x:Static extension ([#1353](https://www.noesisengine.com/bugs/view.php?id=1353)).
- Enhancement Added support in x:Static extension for *RoutedEvents* defined in classes.
- Enhancement [ContentPresenter](/Gui.Core/_ContentPresenter.md) checking if content already connected to another visual parent.
...
- Fixed Assert when closing a [MenuItem](/Gui.Core/_MenuItem.md).
- Fixed [ContentControl](/Gui.Core/_ContentControl.md) content object not released after Content property nulled ([#1495](https://www.noesisengine.com/bugs/view.php?id=1495)).
...
- Fixed [ToolTip](/Gui.Core/_ToolTip.md) not disappearing when the mouse leaving hosting window ([#1511](https://www.noesisengine.com/bugs/view.php?id=1511)).
...
- Fixed TSF candidate window shown even if focus is not in a [TextBox](/Gui.Core/_TextBox.md) ([#1514](https://www.noesisengine.com/bugs/view.php?id=1514)).
...
- Fixed Crash destroying [Visual](/Gui.Core/_Visual.md) with [UIElementCollection](/Gui.Core/_UIElementCollection.md) dependency property with children.
- Fixed Crash destroying [UIElementCollection](/Gui.Core/_UIElementCollection.md) or [VisualCollection](/Gui.Core/_VisualCollection.md) parent before collection.
- Fixed Resource lookup not searching in all *BasedOn* style chain.
- Fixed Infinite layout loop when using same [Visual](/Gui.Core/_Visual.md) as Content in 2 [ContentPresenters](/Gui.Core/_ContentPresenter.md) ([#1529](https://www.noesisengine.com/bugs/view.php?id=1529)).
- Fixed Partially resolved [Binding](/Gui.Core/_Binding.md) path incorrectly notifying of read-only error.
- Fixed Access violation exception when clicking in a [ListBox](/Gui.Core/_ListBox.md) item ([#1528](https://www.noesisengine.com/bugs/view.php?id=1528)).
...
- Fixed [DataTrigger](/Gui.Core/_DataTrigger.md) not working when trigger value is null.
...
- Fixed Cannot stop manipulation inertia in [ScrollViewer](/Gui.Core/_ScrollViewer.md) ([#866](https://www.noesisengine.com/bugs/view.php?id=866), [#1405](https://www.noesisengine.com/bugs/view.php?id=1405), [#1072](https://www.noesisengine.com/bugs/view.php?id=1072)).
...
- Fixed Can't write more than one character in an editable [ComboBox](/Gui.Core/_ComboBox.md) ([#1477](https://www.noesisengine.com/bugs/view.php?id=1477)).
- Fixed Double clicking on [TreeViewItem](/Gui.Core/_TreeViewItem.md) collapses root node ([#1466](https://www.noesisengine.com/bugs/view.php?id=1466)).
- Fixed [TextBlock](/Gui.Core/_TextBlock.md) *LineStackingStrategy* property value not inherited ([#1460](https://www.noesisengine.com/bugs/view.php?id=1460)).
- Fixed Crash closing [ToolTip](/Gui.Core/_ToolTip.md) with bindings.
- Fixed [Selector](/Gui.Core/_Selector.md) resetting *SelectedIndex* and *SelectedItem* bound properties on *DataContext* changes.
- Fixed [BindingOperations](/Gui.Core/_BindingOperations.md) *GetBindingExpression* working only for local values.
...
- Fixed Unity Fatal error in Xaml parser trying to create an [UIElementCollection](/Gui.Core/_UIElementCollection.md) ([#1461](https://www.noesisengine.com/bugs/view.php?id=1461)).
...
- Fixed [ToolTipService](/Gui.Core/_ToolTipService.md) *SetToolTip* with null element crashing ([#1423](https://www.noesisengine.com/bugs/view.php?id=1423)).
- Fixed Resources DataContext not behaving as in WPF ([#1004](https://www.noesisengine.com/bugs/view.php?id=1004)).
- Fixed [ToolBarOverflowPanel](/Gui.Core/_ToolBarOverflowPanel.md) incorrectly doing layout sometimes.
- Fixed Routed commands cannot be defined in XAML ([#1122](https://www.noesisengine.com/bugs/view.php?id=1122)).
- Fixed Unity Editor crashing on [TextBox](/Gui.Core/_TextBox.md) *Focus()* ([#1447](https://www.noesisengine.com/bugs/view.php?id=1447)).
- Fixed C# DataBinding to *Uri* properties not working ([#1449](https://www.noesisengine.com/bugs/view.php?id=1449)).
- Fixed C# [BitmapImage](/Gui.Core/_BitmapImage.md) support for spaces in path broken in 2.2.1 ([#1455](https://www.noesisengine.com/bugs/view.php?id=1455)).
- Fixed C# [BitmapImage](/Gui.Core/_BitmapImage.md) strips leading "/" in paths on Linux ([#1456](https://www.noesisengine.com/bugs/view.php?id=1456)).
- Fixed LoadXAML crashing with *DataTemplate* as root element ([#1439](https://www.noesisengine.com/bugs/view.php?id=1439)).
- Fixed [ContextMenu](/Gui.Core/_ContextMenu.md) and [ToolTip](/Gui.Core/_ToolTip.md) stays unclosed when window deactivated ([#1438](https://www.noesisengine.com/bugs/view.php?id=1438)).
- Fixed [ToolTip](/Gui.Core/_ToolTip.md) *InitialShowDelay* incorrectly reset when mouse moved over element.
...
- Fixed [PasswordBox](/Gui.Core/_PasswordBox.md) not showing caret when placed inside a [ScrollViewer](/Gui.Core/_ScrollViewer.md).
...
- Enhancement Unity Package [installing](/Gui.Core/Unity3DTutorial.md#examples) Blend solution for included samples.
...
- Fixed Incorrect collapsed state in [Expander](/Gui.Core/_Expander.md) template for NocturnalStyle theme ([#1432](https://www.noesisengine.com/bugs/view.php?id=1432)).
- Fixed [TextBox](/Gui.Core/_TextBox.md) and [PasswordBox](/Gui.Core/_PasswordBox.md) not showing caret after *Deactivate* ([#1431](https://www.noesisengine.com/bugs/view.php?id=1431)).
...
- Enhancement New document: [NoesisGUI in comparison with WPF/UWP](/Gui.Core/WPFComparison.md).
- Enhancement Fixed imprecisions in [KeyboardNavigation](/Gui.Core/_KeyboardNavigation.md).
...
- Enhancement [ScrollViewer](/Gui.Core/_ScrollViewer.md) inside [TextBox](/Gui.Core/_TextBox.md), [PasswordBox](/Gui.Core/_PasswordBox.md) and [ComboBox](/Gui.Core/_ComboBox.md) no longer *Focusable* in our default theme.
...
- Fixed [ScrollViewer](/Gui.Core/_ScrollViewer.md) not overriding *IsTabStop* to false as in WPF.
- Fixed C# EmbeddedFontProvider failing in Android for fonts placed inside folders.
- Fixed Clicking on [TextBox](/Gui.Core/_TextBox.md) not opening virtual keyboard when received focus from gamepad.
- Fixed Weird focusing on [TabControl](/Gui.Core/_TabControl.md) ([#1121](https://www.noesisengine.com/bugs/view.php?id=1121)).
- Fixed Improved [TabControl](/Gui.Core/_TabControl.md) gamepad navigation.
- Fixed [ScrollViewer](/Gui.Core/_ScrollViewer.md) not getting focus when clicked.

# Version 2.2.0b10

- Enhancement C++ GetName and GetOwnerType removed from ICommand.
- Enhancement C# Improvements to Drag and Drop API.
- Enhancement Improvements to [DataBinding](/Gui.Core/DataBindingTutorial.md), [CustomControl](/Gui.Core/CustomControlTutorial.md) and [Commands](/Gui.Core/CommandsTutorial.md) tutorials.
...
- Enhancement Improvements to [First contact with Blend](/Gui.Core/BlendTutorial.unity.md) Unity tutorial.
...
- Fixed [VirtualizingStackPanel](/Gui.Core/_VirtualizingStackPanel.md) crash when using [Style](/Gui.Core/_Style.md) to set scroll properties.
...
- Enhancement Unity Dependencies to [UserControls](/Gui.Core/_UserControl.md) automatically generated.
...
- Enhancement Improvements to *GetXamlDependencies* supporting more scenarios and [UserControls](/Gui.Core/_UserControl.md).
...
- Enhancement Implemented [AlternationConverter](/Gui.Core/_AlternationConverter.md).
- Enhancement [MarkupExtension](/Gui.Core/_MarkupExtension.md) *ProvideValue* argument is now ValueTargetProvider\*.
...
- Fixed [ContentPresenter](/Gui.Core/_ContentPresenter.md) placed as root of template can't resolve bindings ([#1335](https://www.noesisengine.com/bugs/view.php?id=1335)).
...
- Fixed [TextBox](/Gui.Core/_TextBox.md) caret and selection not updated when changing *Text* property.
- Fixed [BindingExpression](/Gui.Core/_BindingExpression.md) *UpdateTarget()* not working when used inside *PropertyChangedCallback*.
- Fixed Chained removed elements in [Panel](/Gui.Core/_Panel.md) crashing ([#1391](https://www.noesisengine.com/bugs/view.php?id=1391)).
- Fixed Incorrect [Border](/Gui.Core/_Border.md) geometry for stroke thickness greater than available size.
- Fixed [TabControl](/Gui.Core/_TabControl.md) changing *ViewModel* selected tab when *ItemsSource* reset.
- Fixed [MenuItem](/Gui.Core/_MenuItem.md) crashing when template not including items host.
- Fixed Crash arranging [TabControl](/Gui.Core/_TabControl.md) with collapsed tabs.
- Fixed Default style triggers registered twice when using BasedOn.
- Fixed Rare crash destroying faces in render thread.
- Fixed Bug in [StreamGeometry](/Gui.Core/_StreamGeometry.md) parser ([#1359](https://www.noesisengine.com/bugs/view.php?id=1359)).
...
- Feature Implemented [Binding](/Gui.Core/_Binding.md) *Delay* property ([#1367](https://www.noesisengine.com/bugs/view.php?id=1367)).
- Feature Implemented *AlternationCount* property for [ItemsControl](/Gui.Core/_ItemsControl.md).
- Enhancement Support for custom numeric formats in [StringFormat](/Gui.Core/DataBindingTutorial.md#standard-numeric-format-strings) ([#877](https://www.noesisengine.com/bugs/view.php?id=877) [#996](https://www.noesisengine.com/bugs/view.php?id=996) [#1368](https://www.noesisengine.com/bugs/view.php?id=1368)).
...
- Enhancement [TextBox](/Gui.Core/_TextBox.md) events *TextChanged* and *SelectionChanged* behaving like WPF.
...
- Enhancement C# [Geometry](/Gui.Core/_Geometry.md) *Parse* function exposed ([#1356](https://www.noesisengine.com/bugs/view.php?id=1356)).
...
- Enhancement C# [Grid](/Gui.Core/_Grid.md) and [UniformGrid](/Gui.Core/_UniformGrid.md) properties exposed as int matching WPF.
- Enhancement C# *StreamGeometryContext* API matching WPF ([#833](https://www.noesisengine.com/bugs/view.php?id=833)).
- Fixed [Grid](/Gui.Core/_Grid.md) layout not always correct when using Min/Max limits in columns or rows.
...
- Fixed [TextBlock](/Gui.Core/_TextBlock.md) TextTrimming="CharacterEllipsis very often is faulty ([#1275](https://www.noesisengine.com/bugs/view.php?id=1275)).
- Fixed [TextBlock](/Gui.Core/_TextBlock.md) measure failing in rare cases ([#1249](https://www.noesisengine.com/bugs/view.php?id=1249)).
- Fixed Wrong binding values when [ItemsControl](/Gui.Core/_ItemsControl.md) container disconnected ([#1317](https://www.noesisengine.com/bugs/view.php?id=1317)).
...
- Fixed MouseWheel incorrectly handled with nested [ScrollViewer](/Gui.Core/_ScrollViewer.md).
...
- Fixed C# [VisualTreeHelper](/Gui.Core/_VisualTreeHelper.md) methods should receive a [DependencyObject](/Gui.DependencySystem/_DependencyObject.md) ([#1043](https://www.noesisengine.com/bugs/view.php?id=1043)).
- Fixed C# [GridLength](/Gui.Core/_GridLength.md) struct not exposed ([#739](https://www.noesisengine.com/bugs/view.php?id=739)).
...
- Fixed C# [ItemCollection](/Gui.Core/_ItemCollection.md) should implement *IEnumerable* ([#1044](https://www.noesisengine.com/bugs/view.php?id=1044)).
- Fixed C# Exception "Native type is not registered" getting [ToolTip](/Gui.Core/_ToolTip.md)'s Parent ([#1143](https://www.noesisengine.com/bugs/view.php?id=1143)).
- Fixed C# Crash removing *SelectedItem* from string collection bound to [ListBox](/Gui.Core/_ListBox.md) ([#1371](https://www.noesisengine.com/bugs/view.php?id=1371)).

# Version 2.2.0b4

- Android arm64 New platform supported.
- Enhancement System fonts implemented for iOS and Android.
- Enhancement Exposed *CanHorizontallyScroll* and similar [ScrollContentPresenter](/Gui.Core/_ScrollContentPresenter.md) properties to XAML ([#1281](https://www.noesisengine.com/bugs/view.php?id=1281)).
...
- Fixed C# Crash destroying [UIElement](/Gui.Core/_UIElement.md) with event handlers.
...
- Fixed [TabPanel](/Gui.Core/_TabPanel.md) invoking *Arrange* on collapsed children tabs.
...
- Fixed [ComboBox](/Gui.Core/_ComboBox.md) selecting wrong item when drop down needs scroll.
- Fixed *StaysOpen* set to *False* not keeping popup opened when interacting.
- Fixed Controls in [Expander](/Gui.Core/_Expander.md) *Header* not responding ([#1165](https://www.noesisengine.com/bugs/view.php?id=1165)).
- Fixed Incorrect layout of [Grid](/Gui.Core/_Grid.md) ([#1350](https://www.noesisengine.com/bugs/view.php?id=1350)).
- Fixed [ContentPresenter](/Gui.Core/_ContentPresenter.md) failing to show data bound *Content* ([#1344](https://www.noesisengine.com/bugs/view.php?id=1344)).
...
- Enhancement [CheckBox](/Gui.Core/_CheckBox.md) and [RadioButton](/Gui.Core/_RadioButton.md) default templates now use a [Grid](/Gui.Core/_Grid.md) to layout like in WPF.
...
- Fixed Incorrect color channel order in [CachedBitmap](/Gui.Core/_BitmapSource.md).
- Fixed TrueType Collections (.ttc) not working.
- Fixed Wrong [BulletDecorator](/Gui.Core/_BulletDecorator.md) layout compared to WPF.
- Fixed Multi-line text resetting scroll offset when typing text.
- Fixed *ChangePropertyAction* not working when defined inside a [Style](/Gui.Core/_Style.md).
...
- Fixed [DataTemplate](/Gui.Core/_DataTemplate.md) lookup not working for boxed items.
...
- Enhancement New tutorial about [Drag-and-Drop](/Gui.Core/DragDrop.md).
...
- Enhancement Support for null items in [ItemsControl](/Gui.Core/_ItemsControl.md).
...
- Fixed [ScrollContentPresenter](/Gui.Core/_ScrollContentPresenter.md) *MakeVisible* changing scroll even if element was visible.
- Fixed [StackPanel](/Gui.Core/_StackPanel.md) *MakeVisible* failing when having different item sizes.
- Fixed *GetHashCode()* for pointers not compiling in *Emscripten*.
- Fixed [ItemsControl](/Gui.Core/_ItemsControl.md) comparing items using pointers instead of *Equals*.
...
- Feature Support for *Microsoft Color Fonts* ([CPAL/COLR](https://docs.microsoft.com/en-us/windows/desktop/directwrite/color-fonts)). Emojis! 😊
  ...
  ```
- Feature Implemented [InlineUIContainer](/Gui.Core/_InlineUIContainer.md).
...
- Enhancement Implemented [Binding](/Gui.Core/_Binding.md) *TargetNullValue* property.
- Enhancement [BaseValueConverter](/Gui.Core/_BaseValueConverter.md) derived classes can use *StaticResources* in XAML to set own properties.
- Enhancement Warning messages in [VirtualizingPanel](/Gui.Core/_VirtualizingPanel.md) when virtualization cannot be activated.
...
- Enhancement [ItemsControl](/Gui.Core/_ItemsControl.md) *BringIntoView* renamed to *OnBringItemIntoView*.
...
- Enhancement Exposed scroll functions in [BaseTextBox](/Gui.Core/_BaseTextBox.md).
- Enhancement Implemented [TextBox](/Gui.Core/_TextBox.md) functions: *Select*, *Clear*, *GetCharacterIndexFromPoint*, *GetCharacterIndexFromLineIndex*, *GetLineIndexFromCharacterIndex*, *GetLineLength*, *GetFirstVisibleLineIndex*, *GetLastVisibleLineIndex* and *ScrollToLine*.
- Enhancement Implemented all tab placements for [TabControl](/Gui.Core/_TabControl.md).
...
- Enhancement Exposed [FrameworkElement](/Gui.Core/_FrameworkElement.md) *InputScope* to specify the kind of input from On-Screen Keyboards.
- Enhancement Added *HideCaret* to [TextBox](/Gui.Core/_TextBox.md) and [PasswordBox](/Gui.Core/_PasswordBox.md) to disable caret when required.
...
- Enhancement Support for [TextBlock](/Gui.Core/_TextBlock.md) *LineHeight* and *LineStackingStrategy*.
- Enhancement Improvements to [ResourceDictionary](/Gui.Core/_ResourceDictionary.md) when changing *Source*.
...
- Fixed Ghost lines when rendering [VisualBrush](/Gui.Core/_VisualBrush.md).
- Fixed [TextBox](/Gui.Core/_TextBox.md) scroll bars incorrectly showing beam cursor.
- Fixed Changes to [ScrollViewer](/Gui.Core/_ScrollViewer.md) *HorizontalScrollBarVisibility* and *VerticalScrollBarVisibility* not affecting measure.
- Fixed [TextBox](/Gui.Core/_TextBox.md) not updating *HorizontalScrollBarVisibility* when *TextWrapping* changed.
- Fixed *TextTrimming* ellipses not stroked.
- Fixed '\r' counted as a letter during text formatting.
- Fixed [DataTrigger](/Gui.Core/_DataTrigger.md) failing when trigger and binding value were the same.
- Fixed Memory corruption in [DataTrigger](/Gui.Core/_DataTrigger.md) with self binding.
- Fixed Trigger animations using frozen resources not properly removed.
- Fixed [UIElement](/Gui.Core/_UIElement.md) *IsKeyboardFocused* and *IsKeyboardFocusWithin* returning incorrect values on uninitialized objects.
- Fixed Memory leak in delegate implementation.
- Fixed Glyph rendering could show glitches sometimes.
- Fixed [ContextMenu](/Gui.Core/_ContextMenu.md) not closing properly when using complex templates.
- Fixed Cannot show [ContextMenu](/Gui.Core/_ContextMenu.md) programmatically defined in *Resources*.
- Fixed Added copy-paste context menu for [TextBox](/Gui.Core/_TextBox.md).
- Fixed [ListView](/Gui.Controls/_ListView.md) layout problems when showing horizontal scrollbar.
- Fixed [TextBox](/Gui.Core/_TextBox.md) ignoring alignment with empty text.
- Fixed Inherited properties not updated when control removed from tree.
- Fixed [Selector](/Gui.Core/_Selector.md) not destroying items when using *ObservableCollection.Clear*.
- Fixed [ScrollViewer](/Gui.Core/_ScrollViewer.md) *ScrollChanged* arguments not calculated correctly with *Infinite* viewport.
- Fixed [ResourceDictionary](/Gui.Core/_ResourceDictionary.md) not searching merged dictionaries in the correct order.
- Fixed C# [ResourceDictionary](/Gui.Core/_ResourceDictionary.md) not exposing *IDictionary*.
...
- Fixed Incorrect line scroll in [VirtualizingStackPanel](/Gui.Core/_VirtualizingStackPanel.md) when virtualization disabled.
- Fixed *Nullable* properties incorrectly binding *TwoWay* bindings.
- Fixed [ToolTip](/Gui.Core/_ToolTip.md) not hidden after focusing new element.
- Fixed *Infinite* loop in view *Layout* algorithm.
- Fixed [PasswordBox](/Gui.Core/_PasswordBox.md) *PasswordChar* not allowing Unicode chars.
- Fixed [PasswordBox](/Gui.Core/_PasswordBox.md) *GotFocus* not respecting SelectAll.
- Fixed Nested *OpacityMask* incorrectly displayed.
- Fixed Self binding not using converter with null *DataContext*.
- Fixed *DataContext* in [ContentPresenter](/Gui.Core/_ContentPresenter.md) ignoring null *Content*.
...
- Fixed [DataTrigger](/Gui.Core/_DataTrigger.md) not working when condition value is null.
- Fixed Dropdown [Popup](/Gui.Core/_Popup.md) remains visible while scrolling parent.
- Fixed [ToolTip](/Gui.Core/_ToolTip.md) incorrectly added as logical or visual child.
- Fixed Sometimes [MenuItem](/Gui.Core/_MenuItem.md) *IsPressed* was not updated.
- Fixed [MenuItem](/Gui.Core/_MenuItem.md) without *Header* not closed when clicked.
- Fixed Keyboard keeps referencing focused element when removed from tree.
- Fixed [TreeViewItem](/Gui.Core/_TreeViewItem.md) *BringIntoView* not behaving as in WPF.
