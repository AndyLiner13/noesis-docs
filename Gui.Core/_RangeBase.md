Source: https://www.noesisengine.com/docs/Gui.Core._RangeBase.html

# RangeBase Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.rangebase.aspx)
...
• [ProgressBar](/Gui.Core/_ProgressBar.md)

• [ScrollBar](/Gui.Core/_ScrollBar.md)

• [Slider](/Gui.Core/_Slider.md)
...
RangeBase has no attached properties
