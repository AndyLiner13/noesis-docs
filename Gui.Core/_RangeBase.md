...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.rangebase.aspx)
...
• [ProgressBar](_ProgressBar.md)

• [ScrollBar](_ScrollBar.md)
