Source: https://www.noesisengine.com/docs/Gui.Core._KeyGesture.html

# KeyGesture Class

## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.input.keygesture.aspx)
...
| ○ *Key* | Gets the key associated with this [KeyGesture](_KeyGesture.md) |
| ○ *Modifiers* | Gets the modifier keys associated with this [KeyGesture](_KeyGesture.md) |
