...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.expander.aspx)
...
• [HeaderedContentControl](_HeaderedContentControl.md)
...
| Name | Description |
| --- | --- |
| ● *ExpandDirection* | Gets or sets the direction in which the [Expander](_Expander.md) content window opens |
| ● *IsExpanded* | Gets or sets whether the [Expander](_Expander.md) content window is visible |

● Dependency Property   ○ Reflection Property

## From [HeaderedContentControl](_HeaderedContentControl.md)
...
| ● *HeaderTemplate* | Gets or sets the [DataTemplate](_DataTemplate.md) used to display the content of the control's header |
...
| Name | Description |
| --- | --- |
| ▸ *Collapsed* | Occurs when the content window of an [Expander](_Expander.md) control closes and only the Header is visible |
| ▸ *Expanded* | Occurs when the content window of an [Expander](_Expander.md) control opens to display both its header and content |
