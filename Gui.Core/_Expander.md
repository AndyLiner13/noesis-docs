Source: https://www.noesisengine.com/docs/Gui.Core._Expander.html

# Expander Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.expander.aspx)
...
• [HeaderedContentControl](/Gui.Core/_HeaderedContentControl.md)
...
| Name | Description |
| --- | --- |
| ● *ExpandDirection* | Gets or sets the direction in which the [Expander](/Gui.Core/_Expander.md) content window opens |
| ● *IsExpanded* | Gets or sets whether the [Expander](/Gui.Core/_Expander.md) content window is visible |

● Dependency Property   ○ Reflection Property

## From [HeaderedContentControl](/Gui.Core/_HeaderedContentControl.md)

| Name | Description |
| --- | --- |
| ● *HasHeader* | Gets a value that indicates whether the header is a null reference |
| ● *Header* | Gets or sets the data used for the header of each control |
| ● *HeaderStringFormat* | Gets or sets the format used to display the header of the control as a string |
| ● *HeaderTemplate* | Gets or sets the [DataTemplate](/Gui.Core/_DataTemplate.md) used to display the content of the control's header |
...
Expander has no attached properties
...
| Name | Description |
| --- | --- |
| ▸ *Collapsed* | Occurs when the content window of an [Expander](/Gui.Core/_Expander.md) control closes and only the Header is visible |
| ▸ *Expanded* | Occurs when the content window of an [Expander](/Gui.Core/_Expander.md) control opens to display both its header and content |
