Source: https://www.noesisengine.com/docs/Gui.Core._Trigger.html

# Trigger Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.trigger.aspx)
...
| ○ *Setters* | Gets a collection of [Setter](/Gui.Core/_Setter.md) objects, which describe the property values to apply when the specified condition has been met. |
