...
| Property | Description |
|----------|-------------|
| IsIndeterminate | Gets or sets whether the ProgressBar shows actual values or generic, continuous progress feedback |
| Orientation | Gets or sets the orientation of a ProgressBar: horizontal or vertical. |
...
| PreviewMouseDown | Occurs when any mouse button is pressed while the mouse pointer is over this element |
