# BaseFreezableCollection Class

## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace)

Base class implementation for a [FreezableCollection](https://www.noesisengine.com/docs/Gui.Core._FreezableCollection.html).
...
BaseFreezableCollection has no attached properties
...
BaseFreezableCollection has no events