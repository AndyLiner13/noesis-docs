Source: https://www.noesisengine.com/docs/Gui.Core._TabPanel.html

# TabPanel Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.tabpanel.aspx)

Handles the layout of the [TabItem](/Gui.Core/_TabItem.md) objects on a [TabControl](/Gui.Core/_TabControl.md).
