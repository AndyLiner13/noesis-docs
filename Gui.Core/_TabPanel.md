...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.tabpanel.aspx)

Handles the layout of the [TabItem](_TabItem.md) objects on a [TabControl](_TabControl.md).
