...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.textblock.aspx)

Provides a lightweight control for displaying small amounts of text content.

A TextBlock can contain a string in its Text property or Inline flow content elements, such as [Bold](https://www.noesisengine.com/docs/Gui.Core._Bold.html), [Hyperlink](https://www.noesisengine.com/docs/Gui.Core._Hyperlink.html), and [InlineUIContainer](https://www.noesisengine.com/docs/Gui.Core._InlineUIContainer.html), in its Inlines property.
...
| FontFamily | Gets or sets the preferred top-level font family for the TextBlock. |
| FontSize | Gets or sets the top-level font size for the TextBlock. |
| FontStretch | Gets or sets the top-level font stretch for the TextBlock. |
| FontStyle | Gets or sets the top-level font style for the TextBlock. |
| FontWeight | Gets or sets the top-level font weight for the TextBlock. |
| Foreground | Gets or sets the Brush to apply to the text contents of the TextBlock. |
| FormattedText | Returns the object used to layout and render text for this TextBlock |
| Inlines | Gets an InlineCollection containing the top-level Inline elements that comprise the contents of the TextBlock |
...
| Stroke | Gets or sets the Brush used to stroke the text |
...
| Typography | Gets the currently effective typography variations for the text contents of this TextBlock |
...
| Method | Description |
|--------|-------------|
| HasInlines() | Indicates if this TextBlock contains any inlines (avoids creating Inlines if not needed) |
