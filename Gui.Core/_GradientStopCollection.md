Source: https://www.noesisengine.com/docs/Gui.Core._GradientStopCollection.html

# GradientStopCollection Class

## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.media.gradientstopcollection.aspx)

Represents a collection of [GradientStop](_GradientStop.md) objects that can be individually accessed by index.
...
• [FreezableCollection](_FreezableCollection.md)
...
GradientStopCollection has no attached properties

# Methods

## From [FreezableCollection](_FreezableCollection.md)
...
GradientStopCollection has no events