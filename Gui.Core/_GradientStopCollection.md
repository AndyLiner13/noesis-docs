...
## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.media.gradientstopcollection.aspx)

Represents a collection of [GradientStop](/Gui.Core/_GradientStop.md) objects that can be individually accessed by index.
