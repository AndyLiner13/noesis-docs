Source: https://www.noesisengine.com/docs/Gui.Core._Transform3D.html

# Transform3D Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/uwp/api/windows.ui.xaml.media.media3d.transform3d)

Provides a base class for all three-dimensional transformations, including translation, rotation, and scale transformations.
...
Transform3D has no attached properties
