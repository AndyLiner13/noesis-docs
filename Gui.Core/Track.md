...
| Property | Description |
|----------|-------------|
| DecreaseRepeatButton | Gets the RepeatButton that decreases the Value property of the Track |
| IncreaseRepeatButton | Gets the RepeatButton that increases the Value property of the Track class |
| IsDirectionReversed | Gets or sets if the direction of increasing Value is reversed from the default direction |
| Maximum | Gets or sets the maximum possible Value of the Track |
| Minimum | Gets or sets the minimum possible Value of the Track |
| Orientation | Defines the different orientations that a control or layout can have |
| Thumb | Gets the Thumb control that is used to change the Value of a Track |
| Value | Gets or sets the current value of the Track as determined by the position of the Thumb |
...
| Method | Description |
|--------|-------------|
| ValueFromDistance(horizontal, vertical) | Calculates the change in the Value of the Track when the Thumb moves |
| ValueFromPoint(point) | Calculates the distance value from a specified point along the Track |
