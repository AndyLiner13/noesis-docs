Source: https://www.noesisengine.com/docs/Gui.Core._ToolBarOverflowPanel.html

# ToolBarOverflowPanel Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.toolbaroverflowpanel.aspx)

Used to arrange overflow [ToolBar](/Gui.Core/_ToolBar.md) items.
...
| Name | Description |
| --- | --- |
| ● *WrapWidth* | Gets or sets the recommended width for this panel before items flow to the next line |
