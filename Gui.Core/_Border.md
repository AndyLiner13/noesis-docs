Source: https://www.noesisengine.com/docs/Gui.Core._Border.html

# Border Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.border.aspx)
