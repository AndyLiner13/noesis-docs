Source: https://www.noesisengine.com/docs/Gui.Core._BulletDecorator.html

# BulletDecorator Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.bulletdecorator.aspx)
...
| Name | Description |
| --- | --- |
| ● *Background* | Gets or sets the background color for a [BulletDecorator](/Gui.Core/_BulletDecorator.md) control. |
| ○ *Bullet* | Gets or sets the object to use as the bullet in a [BulletDecorator](/Gui.Core/_BulletDecorator.md). |
...
BulletDecorator has no attached properties

# Methods

## From [Decorator](/Gui.Core/_Decorator.md)
