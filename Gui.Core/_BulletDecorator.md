...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.bulletdecorator.aspx)
...
| Name | Description |
| --- | --- |
| ● *Background* | Gets or sets the background color for a [BulletDecorator](_BulletDecorator.md) control. |
| ○ *Bullet* | Gets or sets the object to use as the bullet in a [BulletDecorator](_BulletDecorator.md). |
