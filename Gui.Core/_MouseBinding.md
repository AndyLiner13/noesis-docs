Source: https://www.noesisengine.com/docs/Gui.Core._MouseBinding.html

# MouseBinding Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.input.mousebinding.aspx)

Binds a [MouseGesture](/Gui.Core/_MouseGesture.md) to a Command.

When defining a [MouseBinding](/Gui.Core/_MouseBinding.md) in XAML, there are two ways to specify the [MouseGesture](/Gui.Core/_MouseGesture.md). The first way to establish a [MouseBinding](/Gui.Core/_MouseBinding.md) in XAML is to define the Gesture attribute of the [MouseBinding](/Gui.Core/_MouseBinding.md) element, which enables a syntax to specify mouse actions and modifiers as a single string; for example, "CTRL+LeftClick". The second way is to define the MouseAction attribute of the [MouseBinding](/Gui.Core/_MouseBinding.md) element. Both ways of setting the [MouseGesture](/Gui.Core/_MouseGesture.md) are equivalent and modify the same underlying object, but there will be a conflict if both are used.
...
| Name | Description |
| --- | --- |
| ● *Modifiers* | Gets the modifier keys (one or more Alt, Ctrl, Shift) of the associated [MouseGesture](/Gui.Core/_MouseGesture.md) |
| ● *MouseAction* | Gets or sets the MouseAction of the [MouseGesture](/Gui.Core/_MouseGesture.md) associated with this [MouseBinding](/Gui.Core/_MouseBinding.md) |

● Dependency Property   ○ Reflection Property

## From [InputBinding](/Gui.Core/_InputBinding.md)

| Name | Description |
| --- | --- |
| ● *Command* | Gets or sets the ICommand associated with this [InputBinding](/Gui.Core/_InputBinding.md) |
...
| ○ *Gesture* | Gets or sets the [InputGesture](/Gui.Core/_InputGesture.md) associated with this input binding |
...
MouseBinding has no attached properties
