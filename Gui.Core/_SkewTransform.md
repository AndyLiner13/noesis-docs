Source: https://www.noesisengine.com/docs/Gui.Core._SkewTransform.html

# SkewTransform Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.skewtransform.aspx)

Represents a 2D skew. It is useful for creating the illusion of 3-dimensional depth in a 2D object.
...
| ● *CenterX* | ets or sets the x-coordinate of the transform center |
...
SkewTransform has no attached properties
