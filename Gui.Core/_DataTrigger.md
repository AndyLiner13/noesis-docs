...
| ○ *Setters* | Gets a collection of [Setter](/Gui.Core/_Setter.md) objects, which describe the property values to apply when the data item meets the specified condition. |
