...
- Enhancement Implement [UIElement](/Gui.Core/_UIElement.md) *LayoutUpdated* event ([#1041](https://www.noesisengine.com/bugs/view.php?id=1041)).
...
- Enhancement Support for extra texture in custom [Brush Shaders](/Gui.Core/_BrushShader.md) ([#2435](https://www.noesisengine.com/bugs/view.php?id=2435)).
...
- Fixed When using IME, [TextBox](/Gui.Core/_TextBox.md) cursor shown even though focus has moved to another [TextBox](/Gui.Core/_TextBox.md) ([#2367](https://www.noesisengine.com/bugs/view.php?id=2367)).
...
- Fixed Crash destroying [ItemsPresenter](/Gui.Core/_ItemsPresenter.md) before its [ScrollContentPresenter](/Gui.Core/_ScrollContentPresenter.md) ([#2384](https://www.noesisengine.com/bugs/view.php?id=2384)).
- Fixed Inline bindings not working when used inside a template [ToolTip](/Gui.Core/_ToolTip.md).
- Fixed Inlines connected to the *View* twice when added in [TextBlock's](/Gui.Core/_TextBox.md) *AncestorChanged* event.
...
- Fixed Assert hit when showing/hiding the scrollbars in a [ScrollViewer](/Gui.Core/_ScrollViewer.md) ([#2390](https://www.noesisengine.com/bugs/view.php?id=2390)).
...
- Fixed Crash when clearing a collection that was bound in a [DataTemplate](/Gui.Core/_DataTemplate.md).
- Fixed Crash removing a [ScrollViewer](/Gui.Core/_ScrollViewer.md) with a pending layout invalidation.
- Fixed Duplicate user control x:Name causes incorrect binding ([#2401](https://www.noesisengine.com/bugs/view.php?id=2401)).
- Fixed [ScrollViewer](/Gui.Core/_ScrollViewer.md) not applying *PanningMode* when set with style in a template ([#2400](https://www.noesisengine.com/bugs/view.php?id=2400)).
...
- Fixed Crash reloading xaml using the same name in a template [Grid](/Gui.Core/_Grid.md) and outer [Grid](/Gui.Core/_Grid.md) elements ([#2419](https://www.noesisengine.com/bugs/view.php?id=2419)).
- Fixed [GridSplitter](/Gui.Core/_GridSplitter.md) crash pressing *Escape* key without doing a resize.
...
- Fixed [TreeViewItem](/Gui.Core/_TreeViewItem.md) preventing directional navigation outside of the [TreeView](/Gui.Core/_TreeView.md) ([#2422](https://www.noesisengine.com/bugs/view.php?id=2422)).
- Fixed [MenuItem](/Gui.Core/_MenuItem.md) not receiving focus when inside [TreeView](/Gui.Core/_TreeView.md) or [ListView](/Gui.Controls/_ListView.md) ([#2431](https://www.noesisengine.com/bugs/view.php?id=2431)).
- Fixed [ContextMenu](/Gui.Core/_ContextMenu.md) *Placement* intermittently not being respected ([#2437](https://www.noesisengine.com/bugs/view.php?id=2437)).
- Fixed Gamepad *Accept* button not executing selected [MenuItem](/Gui.Core/_MenuItem.md).
...
- Fixed C++ Support for rectangles and DPI scale in [TextureProvider](/Gui.Core/ProvidersTutorial.md#texture-provider) ([#2373](https://www.noesisengine.com/bugs/view.php?id=2373)).
...
- Fixed Unity Crash rendering [WrapPanel](/Gui.Core/_WrapPanel.md) ([#2417](https://www.noesisengine.com/bugs/view.php?id=2417)).
...
- Feature Implemented [MouseBinding](/Gui.Core/_MouseBinding.md) ([#1161](https://www.noesisengine.com/bugs/view.php?id=1161)).
...
- Enhancement Added *CopyPixels* method to retrieve the image bytes from a [BitmapSource](/Gui.Core/_BitmapSource.md) ([#2349](https://www.noesisengine.com/bugs/view.php?id=2349)).
- Enhancement Improved virtualization warning message when panel is not wrapped in a [ScrollViewer](/Gui.Core/_ScrollViewer.md).
...
- Fixed [TextBlock](/Gui.Core/_TextBlock.md) not correctly aligned when bigger than its container.
- Fixed [Popup](/Gui.Core/_Popup.md) contents cannot fill the entire screen ([#2358](https://www.noesisengine.com/bugs/view.php?id=2358)).
...
- Fixed [EventTrigger](/Gui.Core/_EventTrigger.md) *Actions* throws an exception when created from code behind ([#2345](https://www.noesisengine.com/bugs/view.php?id=2345)).
- Fixed [InlineUIContainers](/Gui.Core/_InlineUIContainer.md) not rendered after disconnecting [TextBlock](/Gui.Core/_TextBlock.md) from the *View* ([#2343](https://www.noesisengine.com/bugs/view.php?id=2343)).
- Fixed [MultiBinding](/Gui.Core/_MultiBinding.md) shows error messages when removing target from the visual tree ([#2347](https://www.noesisengine.com/bugs/view.php?id=2347)).
...
- Fixed Unreal Hot reload not always working for [UserControls](/Gui.Core/_UserControl.md) in the Content folder.
...
- Fixed [ScrollViewer](/Gui.Core/_ScrollViewer.md) scroll not working if contained element has focus ([#2303](https://www.noesisengine.com/bugs/view.php?id=2303)).
- Fixed Crash removing a [Path](/Gui.Core/_Path.md) previously collapsed and its *Data* set to null.
...
- Enhancement Doc Our tutorials for [Unity](/Gui.Core/Unity3DTutorial.md) and [Unreal](/Gui.Core/UnrealTutorial.md) have been improved.
...
- Fixed Collection properties of [PathGeometry](/Gui.Core/_PathGeometry.md), [PathFigure](/Gui.Core/_PathFigure.md), [PolyLineSegment](/Gui.Core/_PolyLineSegment.md) and [GradientBrush](/Gui.Core/_GradientBrush.md) are null ([#2229](https://www.noesisengine.com/bugs/view.php?id=2229)).
...
- Fixed [StaticResourceExtension](/Gui.Core/_StaticResourceExtension.md) not in the public API ([#2216](https://www.noesisengine.com/bugs/view.php?id=2216)).
- Fixed Text not clipped after being collapsed.
- Fixed [Path](/Gui.Core/_Path.md) not stretching when [Viewbox](/Gui.Core/_Viewbox.md) expands ([#2240](https://www.noesisengine.com/bugs/view.php?id=2240)).
- Fixed Incorrect [Rectangle](/Gui.Core/_Rectangle.md) geometry when only setting one of *RadiusX* or *RadiusY* ([#2236](https://www.noesisengine.com/bugs/view.php?id=2236)).
- Fixed [TextBlock](/Gui.Core/_TextBlock.md) inlines not triggering *Loaded* and *Unloaded* events ([#2237](https://www.noesisengine.com/bugs/view.php?id=2237)).
...
- Fixed [PasswordBox](/Gui.Core/_PasswordBox.md) inside a [ListBoxItem](/Gui.Core/_ListBoxItem.md) loses focus ([#2278](https://www.noesisengine.com/bugs/view.php?id=2278)).
...
- Fixed C# Added [UIElement](/Gui.Core/_UIElement.md) *TranslatePoint* method ([#2030](https://www.noesisengine.com/bugs/view.php?id=2030), [#2124](https://www.noesisengine.com/bugs/view.php?id=2124)).
- Fixed C# [UIElement](/Gui.Core/_UIElement.md) *CaptureTouch/ReleaseTouchCapture* should receive TouchDevice.
...
- Enhancement [GridSplitter](/Gui.Core/_GridSplitter.md) control implemented ([#1601](https://www.noesisengine.com/bugs/view.php?id=1601), [#1870](https://www.noesisengine.com/bugs/view.php?id=1870), [#1990](https://www.noesisengine.com/bugs/view.php?id=1990)).
- Enhancement [Adorner](/Gui.Core/_Adorner.md) and [AdornerLayer](/Gui.Core/_AdornerLayer.md) implemented ([#2120](https://www.noesisengine.com/bugs/view.php?id=2120)).
...
- Enhancement [PropertyPath](/Gui.Core/_PropertyPath.md) parser optimized to avoid heavy stack usage ([#2131](https://www.noesisengine.com/bugs/view.php?id=2131)).
...
- Fixed [TabControl](/Gui.Core/_TabControl.md) produces "Visual is null" error messages ([#2106](https://www.noesisengine.com/bugs/view.php?id=2106)).
...
- Fixed [ComboBox](/Gui.Core/_ComboBox.md) KeyboardNavigation.DirectionalNavigation="Cycle" not working ([#2177](https://www.noesisengine.com/bugs/view.php?id=2177)).
- Fixed PageUp/PageDown keyboard navigation not working in [ComboBox](/Gui.Core/_ComboBox.md) dropdown.
- Fixed [ItemsControl](/Gui.Core/_ItemsControl.md) keyboard navigation failing with disabled/hidden containers.
- Fixed [ContentPresenter](/Gui.Core/_ContentPresenter.md) with a *ContentTemplate* binding is not displaying the content ([#2086](https://www.noesisengine.com/bugs/view.php?id=2086)).
...
- Fixed [Freezable](/Gui.DependencySystem/_Freezable.md) objects inside templates not registered in the [NameScope](/Gui.Core/_NameScope.md) ([#1476](https://www.noesisengine.com/bugs/view.php?id=1476)).
...
- Fixed Software Keyboard not opening when tapping on a focused [TextBox](/Gui.Core/_TextBox.md) or [PasswordBox](/Gui.Core/_PasswordBox.md) ([#2159](https://www.noesisengine.com/bugs/view.php?id=2159)).
- Fixed Avoid binding errors when part of the path is null ([#2200](https://www.noesisengine.com/bugs/view.php?id=2200)).
- Fixed Gaps when using [TileBrush](/Gui.Core/_TileBrush.md) *ViewBox* with *TileMode=None*.
...
- Fixed [BindingOperations](/Gui.Core/_BindingOperations.md) *SetBinding()* can return a destroyed expression.
- Fixed [TargetedTriggerActions](/App.Interactivity/_TargetedTriggerAction.md) not firing on rare cases.
- Fixed Rendering artifacts after tabbing in [TabControl](/Gui.Core/_TabControl.md) ([#2217](https://www.noesisengine.com/bugs/view.php?id=2217))
...
- Fixed Unity [DropShadowEffect](/Gui.Core/_DropShadowEffect.md) not working in PS5 builds ([#2190](https://www.noesisengine.com/bugs/view.php?id=2190)).
- Fixed C# Crash destroying [ItemsPresenter](/Gui.Core/_ItemsPresenter.md) after [ScrollContentPresenter](/Gui.Core/_ScrollContentPresenter.md).
- Fixed C# *OnApplyTemplate* should be public to match WPF.
- Fixed C# Missing [ItemsControl](/Gui.Core/_ItemsControl.md) container virtual methods ([#2004](https://www.noesisengine.com/bugs/view.php?id=2004)).
...
- Fixed C# Exposed [Visual](/Gui.Core/_Visual.md) child management protected methods.
...
- Enhancement C# Added missing [FrameworkElement](/Gui.Core/_FrameworkElement.md) virtual method *OnApplyTemplate* ([#2008](https://www.noesisengine.com/bugs/view.php?id=2008)).
...
- Fixed [Grid](/Gui.Core/_Grid.md) doesn't layout according to *star* column definition ([#2078](https://www.noesisengine.com/bugs/view.php?id=2078)).
- Fixed Crash in [StaticResource](/Gui.Core/_StaticResourceExtension.md) and [DynamicResource](/Gui.Core/_DynamicResourceExtension.md) using *Type* keys for unknown types ([#2077](https://www.noesisengine.com/bugs/view.php?id=2077)).
- Fixed Custom types with namespace in x:Key not supported.
- Fixed [TextBlock](/Gui.Core/_TextBlock.md) not including correct height of [InlineUIContainer](/Gui.Core/_InlineUIContainer.md) ([#2066](https://www.noesisengine.com/bugs/view.php?id=2066)).
...
- Fixed Crash changing selection in [ComboBox](/Gui.Core/_ComboBox.md) ([#2090](https://www.noesisengine.com/bugs/view.php?id=2090)).
...
- Fixed *Loaded* event not recognized in [DataTemplate](/Gui.Core/_DataTemplate.md) *Triggers* ([#2107](https://www.noesisengine.com/bugs/view.php?id=2107)).
...
- Fixed Memory leak when removing *TextureProvider* before releasing last [BitmapImage](/Gui.Core/_BitmapImage.md) ([#2105](https://www.noesisengine.com/bugs/view.php?id=2105)).
...
> - Events are now *Direct*, so only raised on the element owning the [ToolTip](/Gui.Core/_ToolTip.md).
> - Marking *ToolTipClosing* event as handled does not cancel closing the [ToolTip](/Gui.Core/_ToolTip.md).

- Fixed Make *ScrollInfo* available for [ScrollViewer](/Gui.Core/_ScrollViewer.md)'s inheritors.
...
- Fixed C# Crash defining [GridLength](/Gui.Core/_GridLength.md) dependency property ([#2084](https://www.noesisengine.com/bugs/view.php?id=2084)).
- Fixed C# Allow resize of [DynamicTextureSource](/Gui.Core/_DynamicTextureSource.md).
- Fixed C# [DynamicTextureSource](/Gui.Core/_DynamicTextureSource.md) callback not executed when creating multiple instances.
...
- Fixed Unity Unity's *Texture* used in [TextureSource](/Gui.Core/_TextureSource.md) rendered with black background.
...
- Fixed Unreal *InputScope* property on [TextBox](/Gui.Core/_TextBox.md) not working ([#2068](https://www.noesisengine.com/bugs/view.php?id=2068)).
...
- Enhancement C++ Added helper tables to [RenderDevice API](/Gui.Core/RenderDeviceNotes.md): *VertexShaders*, *VertexFormats* and *VertexSizes*.
- Enhancement C++ Stride information added to renderer *Batch* structure.
- Enhancement Exposed *Placeholder* property in [TextBox](/Gui.Core/_TextBox.md), [PasswordBox](/Gui.Core/_PasswordBox.md) and [ComboBox](/Gui.Core/_ComboBox.md) to use in code.
...
![Changelog_v31_5.jpg](/Changelog_v31_5/jpg.md)

- Feature New Unreal features. Read the [tutorial](/Gui.Core/UnrealTutorial.md) for more information.

> - Support for custom [Brushes](/Gui.Core/UnrealTutorial.md#materialsbrushes) using Unreal *Materials*. See our *Materials* sample.
> - Support for custom [Effects](/Gui.Core/UnrealTutorial.md#materialseffects) using Unreal *Materials*. See our *VideoEffect* example.
...
> - Added support for binding [Map](/Gui.Core/UnrealTutorial.md#bindingmap) properties, and improved native DataContext integration with support for [getter/setter](/Gui.Core/UnrealTutorial.md#bindingfunctions) properties and [command](/Gui.Core/UnrealTutorial.md#bindingcommand) properties.
...
![Changelog_v31_4.jpg](/Changelog_v31_4/jpg.md)

- Feature New Unity features. Read the [tutorial](/Gui.Core/Unity3DTutorial.md) for more information.
...
- Feature Implemented support for custom shaders. There are two ways where custom shaders can be used in NoesisGUI. [Effects](/Gui.Core/_ShaderEffect.md) ([preview](https://www.noesisengine.com/xamltoy/54cdaf5f05116c60c0cca759fc4a290a)) apply a post-processing shader to any object including children. On the other hand, [Brushes](/Gui.Core/_BrushShader.md) ([preview](https://www.noesisengine.com/xamltoy/ada01d4790a936b6aad8fa51421c9588)) can be customized to define how elements are filled and stroked. More information in the [Extending with Shaders](/Gui.Core/ShadersTutorial.md) tutorial.

  ![Changelog_v31_0.jpg](/Changelog_v31_0/jpg.md)
- Feature Added compatibility with [MediaElement](/App.MediaElement/_MediaElement.md) to display video content. [MediaElement](/App.MediaElement/_MediaElement.md) requires a platform dependant implementation of [MediaPlayer](/App.MediaElement/_MediaPlayer.md). Our application framework provides an implementation for each renderer. A new [example](https://github.com/Noesis/Tutorials/tree/master/Samples/VideoEffect) was added to the SDK showcasing this feature. We also added the following media actions: [PlayMediaAction](/App.Interactivity/_PlayMediaAction.md), [PauseMediaAction](/App.Interactivity/_PauseMediaAction.md), [RewindMediaAction](/App.Interactivity/_RewindMediaAction.md) and [StopMediaAction](/App.Interactivity/_StopMediaAction.md).
  ...
  ![Changelog_v31_2.jpg](/Changelog_v31_2/jpg.md)
- Feature [CroppedBitmap](/Gui.Core/_CroppedBitmap.md) implemented. With [CroppedBitmap](/Gui.Core/_CroppedBitmap.md), atlases can be defined in a [ResourceDictionary](/Gui.Core/_ResourceDictionary.md). These sub-images can be later rendered using standard [Images](/Gui.Core/_Image.md) ([preview](https://www.noesisengine.com/xamltoy/723ac4c89abbdf78c6bbb21fbd06d007)). Atlases also support now all combinations of tiling modes.

  ![Changelog_v31_3.jpg](/Changelog_v31_3/jpg.md)
- Feature New blending modes supported: *Multiply*, *Screen*, *Additive* ([preview](https://www.noesisengine.com/xamltoy/0899dee89b63bba437ad474dd92009bf)). This is an [extension](/Gui.Core/ExtensionsTutorial.md#blending) to WPF.

  ![Changelog_v31_1.jpg](/Changelog_v31_1/jpg.md)
- Enhancement Better performance of [BlurEffect](/Gui.Core/_BlurEffect.md) and [DropShadowEffect](/Gui.Core/_DropShadowEffect.md) by using *Gaussian* pyramids instead of the traditional two-passes approach. For large radius, performance has been improved by an order of magnitude.
...
- Enhancement Added support for drawing *Lines*, *Rectangles* and *Ellipses* to [DrawingContext](/Gui.Core/_DrawingContext.md). New [Custom Render](/Gui.Core/CustomRenderTutorial.md) tutorial and [example](https://github.com/Noesis/Tutorials/tree/master/Samples/CustomRender).
...
- Enhancement Multi-touch handling improvements:
  ...
  - *Manipulations* and *Touch* events are now handled independently. This is a deviation from WPF explained in our [Touch and Manipulation](/Gui.Core/TouchTutorial.md) tutorial. With this change, [Controls](/Gui.Core/_Control.md) implementing *Touch* events will behave correctly under [ScrollViewers](/Gui.Core/_ScrollViewer.md).
  - All controls adapted to this new *Manipulations* behavior. A few of them like [ListBoxItem](/Gui.Core/_ListBoxItem.md), [ListViewItem](/Gui.Controls/_ListViewItem.md) and [TreeViewItem](/Gui.Core/_TreeViewItem.md) are now reacting to *TouchUp* events instead of *TouchDown*.
  - Touches used for manipulations are now damped for smoother movements.
  - [Menu](/Gui.Core/_Menu.md), [ContextMenu](/Gui.Core/_ContextMenu.md) and [ComboBox](/Gui.Core/_ComboBox.md) popups now correctly close under touch scrolling.
  - [Sliders](/Gui.Core/_Slider.md) with *IsMoveToPointEnabled* can now continue dragging without releasing the mouse or finger.
