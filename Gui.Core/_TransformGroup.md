Source: https://www.noesisengine.com/docs/Gui.Core._TransformGroup.html

# TransformGroup Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.transformgroup.aspx)

Represents a composite [Transform](/Gui.Core/_Transform.md) composed of other [Transform](/Gui.Core/_Transform.md) objects.
...
| Name | Description |
| --- | --- |
| ● *Children* | Gets or sets the TransformCollection that defines this [TransformGroup](/Gui.Core/_TransformGroup.md) |
