...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.transformgroup.aspx)

Represents a composite [Transform](_Transform.md) composed of other [Transform](_Transform.md) objects.
...
| Name | Description |
| --- | --- |
| ● *Children* | Gets or sets the TransformCollection that defines this [TransformGroup](_TransformGroup.md) |
