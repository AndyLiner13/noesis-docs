...
| Property | Description |
|----------|-------------|
| AdornedElement | Gets the element that this adorner is bound to |
| IsClipEnabled | Gets or sets a value that indicates whether clipping of the adorner is enabled |

## Attached Properties

Adorner has no attached properties
