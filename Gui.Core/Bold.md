...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.documents.bold.aspx)

An inline-level flow content element which causes content to render with a bold font weight.

## Inheritance Hierarchy

 • [DispatcherObject](https://www.noesisengine.com/docs/Gui.DependencySystem._DispatcherObject.html) • [DependencyObject](https://www.noesisengine.com/docs/Gui.DependencySystem._DependencyObject.html) • [Visual](https://www.noesisengine.com/docs/Gui.Core._Visual.html) • [UIElement](https://www.noesisengine.com/docs/Gui.Core._UIElement.html) • [FrameworkElement](https://www.noesisengine.com/docs/Gui.Core._FrameworkElement.html) • [TextElement](https://www.noesisengine.com/docs/Gui.Core._TextElement.html) • [Inline](https://www.noesisengine.com/docs/Gui.Core._Inline.html) • [Span](https://www.noesisengine.com/docs/Gui.Core._Span.html) • Bold

## Properties

### From [Span](https://www.noesisengine.com/docs/Gui.Core._Span.html)

| Property | Description |
|----------|-------------|
| Inlines | Gets a collection containing the top-level Inline elements that comprise the Span's contents |

### From [Inline](https://www.noesisengine.com/docs/Gui.Core._Inline.html)

| Property | Description |
|----------|-------------|
| FlowDirection | Gets or sets a value that specifies the relative direction for flow of content within a inline element |
| NextInline | Returns an Inline immediately following this one on the same level of siblings |
| PreviousInline | Returns an Inline immediately preceding this one on the same level of siblings |
...
### From [TextElement](https://www.noesisengine.com/docs/Gui.Core._TextElement.html)
...
| Typography | Gets the currently effective typography variations for the text contents of this TextElement |
...
Bold has no attached properties
