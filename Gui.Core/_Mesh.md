Source: https://www.noesisengine.com/docs/Gui.Core._Mesh.html
...
The [Mesh](/Gui.Core/_Mesh.md) element acts as a container for [MeshData](/Gui.Core/_MeshData.md), allowing you to draw custom geometric shapes efficiently. Assign a [MeshData](/Gui.Core/_MeshData.md) instance to define the vertices, UVs, and triangle indices that will be submitted directly to the GPU.

Use [Mesh](/Gui.Core/_Mesh.md) when you need precise control over low-level geometry, enabling high-performance, dynamic rendering.
...
| Name | Description |
| --- | --- |
| ● *Brush* | Gets or sets the [Brush](/Gui.Core/_Brush.md) used to fill the mesh |
| ● *Data* | Gets or sets the [MeshData](/Gui.Core/_MeshData.md) to be rendered |
...
Mesh has no attached properties
