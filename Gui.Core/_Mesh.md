...
The [Mesh](_Mesh.md) element acts as a container for [MeshData](_MeshData.md), allowing you to draw custom geometric shapes efficiently. Assign a [MeshData](_MeshData.md) instance to define the vertices, UVs, and triangle indices that will be submitted directly to the GPU.

Use [Mesh](_Mesh.md) when you need precise control over low-level geometry, enabling high-performance, dynamic rendering.
...
| Name | Description |
| --- | --- |
| ● *Brush* | Gets or sets the [Brush](_Brush.md) used to fill the mesh |
| ● *Data* | Gets or sets the [MeshData](_MeshData.md) to be rendered |
