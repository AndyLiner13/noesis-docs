Source: https://www.noesisengine.com/docs/Gui.Core._InlineUIContainer.html

# InlineUIContainer Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.documents.inlineuicontainer.aspx)

An inline-level flow content element which enables [UIElement](/Gui.Core/_UIElement.md) elements (i.e. a [Button](/Gui.Core/_Button.md)) to be embedded in flow content.
...
| Name | Description |
| --- | --- |
| ○ *Child* | Gets or sets the [UIElement](/Gui.Core/_UIElement.md) hosted by the [InlineUIContainer](/Gui.Core/_InlineUIContainer.md) |
...
InlineUIContainer has no attached properties
