...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.documents.inlineuicontainer.aspx)

An inline-level flow content element which enables [UIElement](_UIElement.md) elements (i.e. a [Button](_Button.md)) to be embedded in flow content.
...
| Name | Description |
| --- | --- |
| ○ *Child* | Gets or sets the [UIElement](_UIElement.md) hosted by the [InlineUIContainer](_InlineUIContainer.md) |
