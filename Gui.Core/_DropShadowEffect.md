Source: https://www.noesisengine.com/docs/Gui.Core._DropShadowEffect.html

# DropShadowEffect Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.effects.dropshadoweffect)
...
DropShadowEffect has no attached properties
...
DropShadowEffect has no events