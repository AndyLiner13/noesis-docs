Source: https://www.noesisengine.com/docs/Gui.Core._RotateTransform.html

# RotateTransform Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.rotatetransform.aspx)
...
RotateTransform has no attached properties
