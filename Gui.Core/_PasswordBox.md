...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.passwordbox.aspx)
...
| Name | Description |
| --- | --- |
| ● *CaretBrush* | Gets or sets the brush that is used to paint the caret of the [PasswordBox](_PasswordBox.md) |
| ● *MaxLength* | Gets or sets the maximum length for passwords to be handled by this [PasswordBox](_PasswordBox.md) |
| ○ *Password* | Gets or sets the password currently held by the [PasswordBox](_PasswordBox.md). |
| ● *PasswordChar* | Gets or sets the masking character for the [PasswordBox](_PasswordBox.md) |
...
| ● *ShowLastCharacterDuration* | Gets or sets the duration in milliseconds that the last character typed in the [PasswordBox](_PasswordBox.md) remains visible before it is converted into the corresponding *PasswordChar* |
...
|  *SelectAll()* | Selects the entire contents of the [PasswordBox](_PasswordBox.md) |
