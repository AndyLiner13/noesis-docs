Source: https://www.noesisengine.com/docs/Gui.Core._PasswordBox.html

# PasswordBox Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.passwordbox.aspx)
...
| Name | Description |
| --- | --- |
| ● *CaretBrush* | Gets or sets the brush that is used to paint the caret of the [PasswordBox](/Gui.Core/_PasswordBox.md) |
| ● *MaxLength* | Gets or sets the maximum length for passwords to be handled by this [PasswordBox](/Gui.Core/_PasswordBox.md) |
| ○ *Password* | Gets or sets the password currently held by the [PasswordBox](/Gui.Core/_PasswordBox.md). |
| ● *PasswordChar* | Gets or sets the masking character for the [PasswordBox](/Gui.Core/_PasswordBox.md) |
...
| ● *ShowLastCharacterDuration* | Gets or sets the duration in milliseconds that the last character typed in the [PasswordBox](/Gui.Core/_PasswordBox.md) remains visible before it is converted into the corresponding *PasswordChar* |
...
|  *SelectAll()* | Selects the entire contents of the [PasswordBox](/Gui.Core/_PasswordBox.md) |
