Source: https://www.noesisengine.com/docs/Gui.Core._BaseButton.html

# BaseButton Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.buttonbase.aspx)
...
• [Button](/Gui.Core/_Button.md)

• [GridViewColumnHeader](/Gui.Controls/_GridViewColumnHeader.md)

• [RepeatButton](/Gui.Core/_RepeatButton.md)
...
BaseButton has no attached properties
