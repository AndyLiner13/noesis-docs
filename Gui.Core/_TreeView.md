Source: https://www.noesisengine.com/docs/Gui.Core._TreeView.html

# TreeView Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.treeview.aspx)
...
| Name | Description |
| --- | --- |
| ● *SelectedItem* | Gets the selected item in a [TreeView](/Gui.Core/_TreeView.md) |
