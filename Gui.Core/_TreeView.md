...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.treeview.aspx)
...
| Name | Description |
| --- | --- |
| ● *SelectedItem* | Gets the selected item in a [TreeView](_TreeView.md) |
