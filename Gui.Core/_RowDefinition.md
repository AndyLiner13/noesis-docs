Source: https://www.noesisengine.com/docs/Gui.Core._RowDefinition.html

# RowDefinition Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.rowdefinition.aspx)

Defines row-specific properties that apply to [Grid](/Gui.Core/_Grid.md) elements.
...
| Name | Description |
| --- | --- |
| ● *Height* | Gets or sets column height defined by a [GridLength](/Gui.Core/_GridLength.md) value. Default is 1\* |
| ● *MaxHeight* | Gets or sets column maximum height in pixels. Default value is positive Infinity |
| ● *MinHeight* | Gets or sets column minimum height in pixels. Default value is 0 |
...
RowDefinition has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *GetActualHeight()* | Gets a value that represents the calculated height of the [RowDefinition](/Gui.Core/_RowDefinition.md) |
