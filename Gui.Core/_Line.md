Source: https://www.noesisengine.com/docs/Gui.Core._Line.html

# Line Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.shapes.line.aspx)
...
| Name | Description |
| --- | --- |
| ● *X1* | Gets or sets the x-coordinate of the [Line](/Gui.Core/_Line.md) start point |
| ● *X2* | Gets or sets the x-coordinate of the [Line](/Gui.Core/_Line.md) end point |
| ● *Y1* | Gets or sets the y-coordinate of the [Line](/Gui.Core/_Line.md) start point |
| ● *Y2* | Gets or sets the y-coordinate of the [Line](/Gui.Core/_Line.md) end point |
...
Line has no attached properties
