...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.shapes.line.aspx)
...
| Name | Description |
| --- | --- |
| ● *X1* | Gets or sets the x-coordinate of the [Line](_Line.md) start point |
| ● *X2* | Gets or sets the x-coordinate of the [Line](_Line.md) end point |
| ● *Y1* | Gets or sets the y-coordinate of the [Line](_Line.md) start point |
| ● *Y2* | Gets or sets the y-coordinate of the [Line](_Line.md) end point |
