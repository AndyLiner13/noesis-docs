Source: https://www.noesisengine.com/docs/Gui.Core._BrushShader.html
...
Derive from the [BrushShader](/Gui.Core/_BrushShader.md) class to implement a custom brush based on a pixel shader.

In comparison with [ShaderEffect](/Gui.Core/_ShaderEffect.md), a brush shader is more efficient because it doesn't need an extra render pass to an offscreen.
...
BrushShader has no attached properties
