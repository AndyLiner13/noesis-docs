...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.brush.aspx)

Defines objects used to paint graphical objects. Classes that derive from [Brush](_Brush.md) describe how the area is painted.
...
• [SolidColorBrush](_SolidColorBrush.md)
