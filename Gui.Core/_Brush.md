Source: https://www.noesisengine.com/docs/Gui.Core._Brush.html

# Brush Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.brush.aspx)

Defines objects used to paint graphical objects. Classes that derive from [Brush](/Gui.Core/_Brush.md) describe how the area is painted.
...
• [SolidColorBrush](/Gui.Core/_SolidColorBrush.md)
