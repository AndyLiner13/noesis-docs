...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.listboxitem.aspx)

Represents a selectable item in a [ListBox](_ListBox.md).
...
| Name | Description |
| --- | --- |
| ● *IsSelected* | Gets or sets a value that indicates whether a [ListBoxItem](_ListBoxItem.md) is selected |
...
| Name | Description |
| --- | --- |
| ▸ *Selected* | Occurs when a [ListBoxItem](_ListBoxItem.md) is selected |
| ▸ *Unselected* | Occurs when a [ListBoxItem](_ListBoxItem.md) is unselected |
