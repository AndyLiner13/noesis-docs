Source: https://www.noesisengine.com/docs/Gui.Core._ListBoxItem.html

# ListBoxItem Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.listboxitem.aspx)

Represents a selectable item in a [ListBox](/Gui.Core/_ListBox.md).
...
• [ComboBoxItem](/Gui.Core/_ComboBoxItem.md)

• [ListViewItem](/Gui.Controls/_ListViewItem.md)
...
ListBoxItem has no attached properties
