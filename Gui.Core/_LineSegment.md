...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.linesegment)

Creates a line between two points in a [PathFigure](_PathFigure.md).
...
| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [LineSegment](_LineSegment.md) to the path |
