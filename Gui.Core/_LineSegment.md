Source: https://www.noesisengine.com/docs/Gui.Core._LineSegment.html

# LineSegment Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.linesegment)

Creates a line between two points in a [PathFigure](/Gui.Core/_PathFigure.md).
...
LineSegment has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [LineSegment](/Gui.Core/_LineSegment.md) to the path |
