Source: https://www.noesisengine.com/docs/Gui.Core._PolyBezierSegment.html

# PolyBezierSegment Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.polybeziersegment)
...
PolyBezierSegment has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [PolyBezierSegment](/Gui.Core/_PolyBezierSegment.md) to the path |
...
PolyBezierSegment has no events