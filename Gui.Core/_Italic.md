Source: https://www.noesisengine.com/docs/Gui.Core._Italic.html

# Italic Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.documents.italic.aspx)
...
Italic has no attached properties
