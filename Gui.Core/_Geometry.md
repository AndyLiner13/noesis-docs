...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.geometry.aspx)

Classes that derive from this abstract base class define geometric shapes. [Geometry](_Geometry.md) objects can be used for clipping, hit-testing, and rendering 2D graphic data.
...
• [CombinedGeometry](_CombinedGeometry.md)

• [EllipseGeometry](_EllipseGeometry.md)

• [GeometryGroup](_GeometryGroup.md)

• [LineGeometry](_LineGeometry.md)

• [PathGeometry](_PathGeometry.md)

• [RectangleGeometry](_RectangleGeometry.md)

• [StreamGeometry](_StreamGeometry.md)
