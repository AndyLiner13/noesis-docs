Source: https://www.noesisengine.com/docs/Gui.Core._PolyLineSegment.html

# PolyLineSegment Class

## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.polylinesegment)
...
PolyLineSegment has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [PolyLineSegment](_PolyLineSegment.md) to the path |
