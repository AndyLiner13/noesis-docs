...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.separator.aspx)

[Control](_Control.md) that is used to separate items in items controls.
