Source: https://www.noesisengine.com/docs/Gui.Core._Separator.html

# Separator Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.separator.aspx)

[Control](/Gui.Core/_Control.md) that is used to separate items in items controls.
...
Separator has no attached properties
