Source: https://www.noesisengine.com/docs/Gui.Core._ScrollViewer.html

# ScrollViewer Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/ms612678.aspx)
...
• [ContentControl](/Gui.Core/_ContentControl.md)
...
| Name | Description |
| --- | --- |
| ● *CanContentScroll* | Gets or sets a value that indicates whether content that support the IScrollInfo interface are allowed to scroll |
| ● *ComputedHorizontalScrollBarVisibility* | Gets a value that indicates whether the horizontal [ScrollBar](/Gui.Core/_ScrollBar.md) is visible |
| ● *ComputedVerticalScrollBarVisibility* | Gets a value that indicates whether the vertical [ScrollBar](/Gui.Core/_ScrollBar.md) is visible |
...
| ● *HorizontalScrollBarVisibility* | Gets or sets a value that indicates whether a horizontal [ScrollBar](/Gui.Core/_ScrollBar.md) should be displayed |
| ● *IsDeferredScrollingEnabled* | Gets or sets a value that indicates whether the [ScrollViewer](/Gui.Core/_ScrollViewer.md) should scroll contents immediately during a thumb drag or defer until a drag completes |
| ● *PanningDeceleration* | Gets or sets the rate [ScrollViewer](/Gui.Core/_ScrollViewer.md) slows in pixel per squared millisecond when in inertia |
| ● *PanningMode* | Gets or sets the way [ScrollViewer](/Gui.Core/_ScrollViewer.md) reacts to touch manipulation |
...
| ● *VerticalScrollBarVisibility* | Gets or sets a value that indicates whether a vertical [ScrollBar](/Gui.Core/_ScrollBar.md) should be displayed |
...
## From [ContentControl](/Gui.Core/_ContentControl.md)

| Name | Description |
| --- | --- |
| ● *Content* | Gets or sets the content of a [ContentControl](/Gui.Core/_ContentControl.md) |
| ● *ContentStringFormat* | Gets or sets the format used to display the content of the control as a string. |
| ● *ContentTemplate* | Gets or sets the template used to display the content of the [ContentControl](/Gui.Core/_ContentControl.md) |
| ● *ContentTemplateSelector* | Gets or sets a [DataTemplateSelector](/Gui.Core/_DataTemplateSelector.md) that provides custom logic for choosing the template used to display the content |
| ● *HasContent* | Gets a value that indicates whether the [ContentControl](/Gui.Core/_ContentControl.md) contains content |
...
ScrollViewer has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *InvalidateScrollInfo()* | Called by ScrollInfo object when any scrolling property changes |
...
|  *ScrollToBottom()* | Vertically scroll to the end of the content. |
|  *ScrollToEnd()* | Scroll to Bottom-Left of the content. |
|  *ScrollToHome()* | Scroll to Top-Left of the content. |
|  *ScrollToHorizontalOffset(offset)* | Scrolls the content within the [ScrollViewer](/Gui.Core/_ScrollViewer.md) to the specified horizontal offset position. |
|  *ScrollToLeftEnd()* | Horizontally scroll to the beginning of the content. |
|  *ScrollToRightEnd()* | Horizontally scroll to the end of the content. |
|  *ScrollToTop()* | Vertically scroll to the beginning of the content. |
|  *ScrollToVerticalOffset(offset)* | Scrolls the content within the [ScrollViewer](/Gui.Core/_ScrollViewer.md) to the specified vertical offset position. |
...
| Name | Description |
| --- | --- |
| ▸ *ScrollChanged* | Notifies about changes in scroll position, extent, or viewport size |
