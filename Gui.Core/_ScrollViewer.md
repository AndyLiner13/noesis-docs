...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/ms612678.aspx)
...
• [ContentControl](_ContentControl.md)
...
| ● *ComputedHorizontalScrollBarVisibility* | Gets a value that indicates whether the horizontal [ScrollBar](_ScrollBar.md) is visible |
| ● *ComputedVerticalScrollBarVisibility* | Gets a value that indicates whether the vertical [ScrollBar](_ScrollBar.md) is visible |
...
| ● *HorizontalScrollBarVisibility* | Gets or sets a value that indicates whether a horizontal [ScrollBar](_ScrollBar.md) should be displayed |
| ● *IsDeferredScrollingEnabled* | Gets or sets a value that indicates whether the [ScrollViewer](_ScrollViewer.md) should scroll contents immediately during a thumb drag or defer until a drag completes |
| ● *PanningDeceleration* | Gets or sets the rate [ScrollViewer](_ScrollViewer.md) slows in pixel per squared millisecond when in inertia |
| ● *PanningMode* | Gets or sets the way [ScrollViewer](_ScrollViewer.md) reacts to touch manipulation |
...
| ● *VerticalScrollBarVisibility* | Gets or sets a value that indicates whether a vertical [ScrollBar](_ScrollBar.md) should be displayed |
...
## From [ContentControl](_ContentControl.md)

| Name | Description |
| --- | --- |
| ● *Content* | Gets or sets the content of a [ContentControl](_ContentControl.md) |
| ● *ContentStringFormat* | Gets or sets the format used to display the content of the control as a string. |
| ● *ContentTemplate* | Gets or sets the template used to display the content of the [ContentControl](_ContentControl.md) |
| ● *ContentTemplateSelector* | Gets or sets a [DataTemplateSelector](_DataTemplateSelector.md) that provides custom logic for choosing the template used to display the content |
| ● *HasContent* | Gets a value that indicates whether the [ContentControl](_ContentControl.md) contains content |
...
|  *ScrollToHorizontalOffset(offset)* | Scrolls the content within the [ScrollViewer](_ScrollViewer.md) to the specified horizontal offset position. |
...
|  *ScrollToVerticalOffset(offset)* | Scrolls the content within the [ScrollViewer](_ScrollViewer.md) to the specified vertical offset position. |
