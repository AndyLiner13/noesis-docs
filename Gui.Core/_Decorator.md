...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.decorator.aspx)

Provides a base class for elements that apply effects onto or around a single child element, such as [Border](_Border.md) or [Viewbox](_Viewbox.md).
...
• [AdornerDecorator](_AdornerDecorator.md)

• [Border](_Border.md)

• [BulletDecorator](_BulletDecorator.md)
