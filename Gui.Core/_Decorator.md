Source: https://www.noesisengine.com/docs/Gui.Core._Decorator.html

# Decorator Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.decorator.aspx)

Provides a base class for elements that apply effects onto or around a single child element, such as [Border](/Gui.Core/_Border.md) or [Viewbox](/Gui.Core/_Viewbox.md).
...
• [AdornerDecorator](/Gui.Core/_AdornerDecorator.md)

• [Border](/Gui.Core/_Border.md)

• [BulletDecorator](/Gui.Core/_BulletDecorator.md)
