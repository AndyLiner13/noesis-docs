Source: https://www.noesisengine.com/docs/Gui.Core._TextureSource.html

# TextureSource Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace)

Defines a [BitmapSource](/Gui.Core/_BitmapSource.md) constructed from a [Texture](/Render.RenderDevice/_Texture.md).
...
TextureSource has no attached properties
