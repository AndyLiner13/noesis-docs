...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/ms611602.aspx)
...
| Name | Description |
| --- | --- |
| ● *IsMainMenu* | Gets or sets a value that indicates whether this [Menu](_Menu.md) receives a main menu activation notification |
...
| Name | Description |
| --- | --- |
|  *GetActivated()* | Gets or sets a value that indicates whether this [Menu](_Menu.md) is activated and sub menu items get opened when mouse moves over them |
