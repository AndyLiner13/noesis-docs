...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.matrixtransform.aspx)
...
| Name | Description |
| --- | --- |
| ● *Matrix* | Gets or sets the 2D matrix that represents this [MatrixTransform](_MatrixTransform.md) |
