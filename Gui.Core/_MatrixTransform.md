Source: https://www.noesisengine.com/docs/Gui.Core._MatrixTransform.html

# MatrixTransform Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.media.matrixtransform.aspx)

Creates an arbitrary affine matrix transformation that is used to manipulate objects or coordinate systems in a 2D plane.
...
| Name | Description |
| --- | --- |
| ● *Matrix* | Gets or sets the 2D matrix that represents this [MatrixTransform](/Gui.Core/_MatrixTransform.md) |

● Dependency Property   ○ Reflection Property

## From [Transform](/Gui.Core/_Transform.md)
...
MatrixTransform has no attached properties
