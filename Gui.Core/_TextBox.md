Source: https://www.noesisengine.com/docs/Gui.Core._TextBox.html

# TextBox Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.textbox.aspx)
...
• [BaseTextBox](/Gui.Core/_BaseTextBox.md)
...
| ○ *SelectedText* | Gets or sets the content of the current selection in the text box interact with the text box |
...
| ○ *Typography* | Gets the currently effective typography variations for the text contents of this [TextBox](/Gui.Core/_TextBox.md) |

● Dependency Property   ○ Reflection Property

## From [BaseTextBox](/Gui.Core/_BaseTextBox.md)
...
| ● *CaretBrush* | Gets or sets the brush that is used to paint the caret of the text box |
| ○ *ExtentHeight* | Vertical size of scrollable content; 0.0 if [TextBox](/Gui.Core/_TextBox.md) is non-scrolling |
| ○ *ExtentWidth* | Horizontal size of scrollable content; 0.0 if [TextBox](/Gui.Core/_TextBox.md) is non-scrolling |
| ○ *HorizontalOffset* | Actual HorizontalOffset contains the [ScrollViewer](/Gui.Core/_ScrollViewer.md)'s current horizontal offset. This is a computed value, depending on the state of [ScrollViewer](/Gui.Core/_ScrollViewer.md), its Viewport, Extent and previous scrolling commands. |
...
| ● *PanningMode* | Gets or sets the way [TextBox](/Gui.Core/_TextBox.md) reacts to touch manipulation |
...
| ○ *VerticalOffset* | Actual VerticalOffset contains the [ScrollViewer](/Gui.Core/_ScrollViewer.md)'s current vertical offset. This is a computed value, depending on the state of [ScrollViewer](/Gui.Core/_ScrollViewer.md), its Viewport, Extent and previous scrolling commands. |
| ● *VerticalScrollBarVisibility* | Gets or sets a value that indicates whether a vertical scroll bar is shown |
| ○ *ViewportHeight* | Vertical size of scroll area; 0.0 if [TextBox](/Gui.Core/_TextBox.md) is non-scrolling |
| ○ *ViewportWidth* | Horizontal size of scroll area; 0.0 if [TextBox](/Gui.Core/_TextBox.md) is non-scrolling |
...
TextBox has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *AddCompositionUnderline(compositionUnderline)* | Adds a new IME composition underline |
|  *Clear()* | Clear all the content in the [TextBox](/Gui.Core/_TextBox.md) control |
|  *ClearCompositionUnderlines()* | Removes all IME composition underlines |
|  *GetCaretIndex()* | Gets or sets the insertion position index of the caret |
|  *GetCharacterIndexFromLineIndex(lineIndex)* | Return the 0-based character index of the first character of lineIndex, or -1 if no layout information is available |
|  *GetCharacterIndexFromPoint(point, snapToText)* | Return the 0-based character index of the given point. If there is no character at that point and snapToText is false, return -1. Point is specified in [TextBox](/Gui.Core/_TextBox.md) coordinates |
|  *GetCompositionUnderline(index)* | Gets the specified IME composition underline |
|  *GetFirstVisibleLineIndex()* | Return the index of the first line that is currently visible in the [TextBox](/Gui.Core/_TextBox.md), or -1 if no layout information is available |
|  *GetLastVisibleLineIndex()* | Return the index of the last line that is currently visible in the [TextBox](/Gui.Core/_TextBox.md), or -1 if no layout information is available |
|  *GetLineIndexFromCharacterIndex(charIndex)* | Return the 0-based index of the line containing the given character index, or -1 if no layout information is available |
|  *GetLineLength(lineIndex)* | Return the number of characters in the given line, or -1 if no layout information is available |
|  *GetNumCompositionUnderlines()* | Returns the number of IME composition underlines |
|  *GetRangeBounds(start, end)* | Calculates the bounding box of a range of text |
|  *GetTextView()* | Gets the visual that renders the text of the [TextBox](/Gui.Core/_TextBox.md) |
|  *HideCaret()* | Removes the caret until control gets focused again |
|  *ScrollToLine(lineIndex)* | Scroll the minimal amount necessary to bring the given line into full view. |
|  *Select(start, length)* | Select the text in the given position and length |
...
| Name | Description |
| --- | --- |
|  *LineDown()* | Scroll content by one line to the bottom. |
|  *LineLeft()* | Scroll content by one line to the left. |
|  *LineRight()* | Scroll content by one line to the right. |
|  *LineUp()* | Scroll content by one line to the top. |
|  *PageDown()* | Scroll content by one page to the bottom. |
|  *PageLeft()* | Scroll content by one page to the left. |
|  *PageRight()* | Scroll content by one page to the right. |
|  *PageUp()* | Scroll content by one page to the top. |
|  *ScrollToEnd()* | Vertically scroll to the end of the content. |
|  *ScrollToHome()* | Vertically scroll to the beginning of the content. |
|  *ScrollToHorizontalOffset(offset)* | Scroll horizontally to the specified offset. |
|  *ScrollToVerticalOffset(offset)* | Scroll vertically to the specified offset. |
