...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.textbox.aspx)
...
| ○ *Typography* | Gets the currently effective typography variations for the text contents of this [TextBox](_TextBox.md) |

● Dependency Property   ○ Reflection Property

## From [BaseTextBox](_BaseTextBox.md)
...
| ○ *ExtentHeight* | Vertical size of scrollable content; 0.0 if [TextBox](_TextBox.md) is non-scrolling |
| ○ *ExtentWidth* | Horizontal size of scrollable content; 0.0 if [TextBox](_TextBox.md) is non-scrolling |
| ○ *HorizontalOffset* | Actual HorizontalOffset contains the [ScrollViewer](_ScrollViewer.md)'s current horizontal offset. This is a computed value, depending on the state of [ScrollViewer](_ScrollViewer.md), its Viewport, Extent and previous scrolling commands. |
...
| ● *PanningMode* | Gets or sets the way [TextBox](_TextBox.md) reacts to touch manipulation |
...
| ○ *VerticalOffset* | Actual VerticalOffset contains the [ScrollViewer](_ScrollViewer.md)'s current vertical offset. This is a computed value, depending on the state of [ScrollViewer](_ScrollViewer.md), its Viewport, Extent and previous scrolling commands. |
| ● *VerticalScrollBarVisibility* | Gets or sets a value that indicates whether a vertical scroll bar is shown |
| ○ *ViewportHeight* | Vertical size of scroll area; 0.0 if [TextBox](_TextBox.md) is non-scrolling |
| ○ *ViewportWidth* | Horizontal size of scroll area; 0.0 if [TextBox](_TextBox.md) is non-scrolling |
...
|  *Clear()* | Clear all the content in the [TextBox](_TextBox.md) control |
...
|  *GetCharacterIndexFromPoint(point, snapToText)* | Return the 0-based character index of the given point. If there is no character at that point and snapToText is false, return -1. Point is specified in [TextBox](_TextBox.md) coordinates |
|  *GetCompositionUnderline(index)* | Gets the specified IME composition underline |
|  *GetFirstVisibleLineIndex()* | Return the index of the first line that is currently visible in the [TextBox](_TextBox.md), or -1 if no layout information is available |
|  *GetLastVisibleLineIndex()* | Return the index of the last line that is currently visible in the [TextBox](_TextBox.md), or -1 if no layout information is available |
...
|  *GetTextView()* | Gets the visual that renders the text of the [TextBox](_TextBox.md) |
