...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.itemscontrol.aspx)
...
Each [ItemsControl](_ItemsControl.md) type has a corresponding item container type. The corresponding item container for each [ItemsControl](_ItemsControl.md) appends Item to its name. For example, for [ListBox](_ListBox.md), the item containers are [ListBoxItem](_ListBoxItem.md) controls; for [ComboBox](_ComboBox.md), they are [ComboBoxItem](_ComboBoxItem.md) controls. You can explicitly create a container type for each item in the [ItemsControl](_ItemsControl.md), but it is not necessary. When you do not explicitly create the container type, one is generated that contains a data item in the item collection. For example, if you bind a collection of string objects to the ItemsSource property of a [ListBox](_ListBox.md), you do not explicitly create [ListBoxItem](_ListBoxItem.md) objects, but the [ListBox](_ListBox.md) will generate one for each string. You can access a generated item container by using the [ItemContainerGenerator](_ItemContainerGenerator.md) property
