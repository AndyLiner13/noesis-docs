Source: https://www.noesisengine.com/docs/Gui.Core._ItemsControl.html

# ItemsControl Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.itemscontrol.aspx)
...
Each [ItemsControl](/Gui.Core/_ItemsControl.md) type has a corresponding item container type. The corresponding item container for each [ItemsControl](/Gui.Core/_ItemsControl.md) appends Item to its name. For example, for [ListBox](/Gui.Core/_ListBox.md), the item containers are [ListBoxItem](/Gui.Core/_ListBoxItem.md) controls; for [ComboBox](/Gui.Core/_ComboBox.md), they are [ComboBoxItem](/Gui.Core/_ComboBoxItem.md) controls. You can explicitly create a container type for each item in the [ItemsControl](/Gui.Core/_ItemsControl.md), but it is not necessary. When you do not explicitly create the container type, one is generated that contains a data item in the item collection. For example, if you bind a collection of string objects to the ItemsSource property of a [ListBox](/Gui.Core/_ListBox.md), you do not explicitly create [ListBoxItem](/Gui.Core/_ListBoxItem.md) objects, but the [ListBox](/Gui.Core/_ListBox.md) will generate one for each string. You can access a generated item container by using the [ItemContainerGenerator](/Gui.Core/_ItemContainerGenerator.md) property
...
• [BaseMenu](/Gui.Core/_BaseMenu.md)

• [HeaderedItemsControl](/Gui.Core/_HeaderedItemsControl.md)

• [Selector](/Gui.Core/_Selector.md)

• [StatusBar](/Gui.Core/_StatusBar.md)

• [TreeView](/Gui.Core/_TreeView.md)
