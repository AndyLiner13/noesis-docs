...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.pathfigure)
...
| ● *IsFilled* | Gets or sets whether the contained area of this [PathFigure](_PathFigure.md) is to be used for hit-testing, rendering, and clipping. The default value is true. |
| ● *Segments* | Gets or sets the collection of segments that define the shape of this [PathFigure](_PathFigure.md) object. |
| ● *StartPoint* | Gets or sets the Point where the [PathFigure](_PathFigure.md) begins. The default value is 0,0. |
...
| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [PathFigure](_PathFigure.md) to the path |
