Source: https://www.noesisengine.com/docs/Gui.Core._PathFigure.html

# PathFigure Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](https://docs.microsoft.com/en-us/dotnet/api/system.windows.media.pathfigure)
...
| Name | Description |
| --- | --- |
| ● *IsClosed* | Gets or sets a value that specifies whether first and last segments are connected. |
| ● *IsFilled* | Gets or sets whether the contained area of this [PathFigure](/Gui.Core/_PathFigure.md) is to be used for hit-testing, rendering, and clipping. The default value is true. |
| ● *Segments* | Gets or sets the collection of segments that define the shape of this [PathFigure](/Gui.Core/_PathFigure.md) object. |
| ● *StartPoint* | Gets or sets the Point where the [PathFigure](/Gui.Core/_PathFigure.md) begins. The default value is 0,0. |
...
PathFigure has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *BuildPath(commands)* | Adds this [PathFigure](/Gui.Core/_PathFigure.md) to the path |
|  *IsEmpty()* | Indicates if this figure does not contain any segments |
