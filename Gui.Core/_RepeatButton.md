...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.repeatbutton.aspx)
...
| Name | Description |
| --- | --- |
| ● *Delay* | Gets or sets the amount of time, in milliseconds, the [RepeatButton](_RepeatButton.md) waits while it is pressed before it starts repeating. The value must be non-negative |
