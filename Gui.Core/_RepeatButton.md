Source: https://www.noesisengine.com/docs/Gui.Core._RepeatButton.html

# RepeatButton Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.repeatbutton.aspx)
...
| Name | Description |
| --- | --- |
| ● *Delay* | Gets or sets the amount of time, in milliseconds, the [RepeatButton](/Gui.Core/_RepeatButton.md) waits while it is pressed before it starts repeating. The value must be non-negative |
...
RepeatButton has no attached properties
