...
## namespace [Noesis](_ClassHierarchy.md#noesis-namespace) | [MSDN](https://msdn.microsoft.com/en-us/library/system.windows.media.imaging.bitmapsource.aspx)
...
• [BitmapImage](_BitmapImage.md)

• [CroppedBitmap](_CroppedBitmap.md)

• [TextureSource](_TextureSource.md)
