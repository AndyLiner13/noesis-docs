Source: https://www.noesisengine.com/docs/App.ApplicationLauncher._MessageBox.html

# MessageBox Class

## namespace [NoesisApp](/Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

Displays a message box by calling the static *Show* method. The callback gets called when the dialog is closed indicating which button was pressed as result.
...
• [UserControl](/Gui.Core/_UserControl.md)
...
MessageBox has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *Show(text, callback)* | Displays a message box that has a message and uses a callback to notify the result. |
|  *Show(text, caption, callback)* | Displays a message box that has a message and title bar caption; it uses a callback to notify the result. |
|  *Show(text, caption, button, callback)* | Displays a message box that has a message, title bar caption, and button; it uses a callback to notify the result. |
|  *Show(text, caption, button, icon, callback)* | Displays a message box that has a message, title bar caption, button, and icon; it uses a callback to notify the result. |
|  *Show(text, caption, button, icon, defaultResult, callback)* | Displays a message box that has a message, title bar caption, button, icon, and accept a default message box result; it uses a callback to notify the result. |
