...
| ● *ScrubbingEnabled* | Gets or sets a value that indicates whether the [MediaElement](_MediaElement.md) will update frames for seek operations while paused. The default is false. |
...
| ● *Stretch* | Gets or sets a value that describes how a [MediaElement](_MediaElement.md) fills the destination rectangle. The default is Stretch.Uniform. |
