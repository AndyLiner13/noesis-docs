Source: https://www.noesisengine.com/docs/App.RiveBase._RiveRun.html

# RiveRun Class

## namespace [NoesisApp](/Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

Represents a text run in the [RiveControl](/App.RiveBase/_RiveControl.md) scene.

Each text run is identified by a name in the rive scene. The run exposes its text and it can be set directly in the XAML or bound to properties of the data context.
...
| Name | Description |
| --- | --- |
| ● *RunName* | Gets or sets the name of the run you want to interact with |
| ● *RunText* | Gets or sets the run text |
...
RiveRun has no attached properties
