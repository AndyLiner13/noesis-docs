...
The scene can contain inputs to control the state machine and animations. This control exposes a list of [RiveInput](_RiveInput.md) to set the values of those inputs in XAML.
...
The control also exposes a list of [RiveRun](_RiveRun.md) to interact with the text runs defined in the Rive scene. The text can be bound to set or get run's current value.
