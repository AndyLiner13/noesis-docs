Source: https://www.noesisengine.com/docs/Gui.Controls._GridViewColumn.html

# GridViewColumn Class

## namespace [Noesis](../Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.gridviewcolumn.aspx)
...
| Name | Description |
| --- | --- |
| ○ *ActualWidth* | Gets the actual width of a [GridViewColumn](_GridViewColumn.md) |
| ● *CellTemplate* | Gets or sets the template to use to display the contents of a column cell |
| ● *CellTemplateSelector* | Gets or sets a [DataTemplateSelector](../Gui.Core/_DataTemplateSelector.md) that determines the template to use to display cells in a column |
| ○ *DisplayMemberBinding* | Gets or sets the data item to bind to for this column |
| ● *Header* | Gets or sets the content of the header of a [GridViewColumn](_GridViewColumn.md) |
| ● *HeaderContainerStyle* | Gets or sets the style to use for the header of the [GridViewColumn](_GridViewColumn.md) |
...
| ● *HeaderTemplateSelector* | Gets or sets the [DataTemplateSelector](../Gui.Core/_DataTemplateSelector.md) that provides logic to select the template to use to display the column header |
...
GridViewColumn has no attached properties

# Methods

| Name | Description |
| --- | --- |
|  *ActualWidthChanged()* | Occurs when column *ActualWidth* changes |
