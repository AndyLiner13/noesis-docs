...
| Name | Description |
| --- | --- |
| ○ *ActualWidth* | Gets the actual width of a [GridViewColumn](/Gui.Controls/_GridViewColumn.md) |
...
| ● *Header* | Gets or sets the content of the header of a [GridViewColumn](/Gui.Controls/_GridViewColumn.md) |
| ● *HeaderContainerStyle* | Gets or sets the style to use for the header of the [GridViewColumn](/Gui.Controls/_GridViewColumn.md) |
