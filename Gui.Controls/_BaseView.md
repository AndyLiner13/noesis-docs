Source: https://www.noesisengine.com/docs/Gui.Controls._BaseView.html

# BaseView Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.viewbase.aspx)

Represents the base class for views that define the appearance of data in a [ListView](/Gui.Controls/_ListView.md) control.
...
• [GridView](/Gui.Controls/_GridView.md)
...
BaseView has no attached properties
