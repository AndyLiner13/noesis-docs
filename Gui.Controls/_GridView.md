...
Represents a view mode that displays data items in columns for a [ListView](/Gui.Controls/_ListView.md) control.
...
The [GridView](/Gui.Controls/_GridView.md) class and its supporting classes provide the infrastructure to display data items that are specified for a [ListView](/Gui.Controls/_ListView.md) control in a series of columns. The columns have column headers, which are buttons that are derived from ButtonBase, and you can reorder the columns by using drag-and-drop operations. Note that the columns of a [GridView](/Gui.Controls/_GridView.md) display data and do not provide direct access to the source of the data.

The columns in a [GridView](/Gui.Controls/_GridView.md) are defined as [GridViewColumn](/Gui.Controls/_GridViewColumn.md) objects. In XAML, you can define [GridViewColumn](/Gui.Controls/_GridViewColumn.md) objects as child elements of the [GridView](/Gui.Controls/_GridView.md).
...
• [BaseView](/Gui.Controls/_BaseView.md)
...
| Name | Description |
| --- | --- |
| ● *AllowsColumnReorder* | Gets or sets whether columns in a [GridView](/Gui.Controls/_GridView.md) can be reordered by a drag-and-drop operation |
| ● *ColumnHeaderContainerStyle* | Gets or sets the style to apply to column headers |
| ● *ColumnHeaderContextMenu* | Gets or sets a [ContextMenu](/Gui.Core/_ContextMenu.md) for the [GridView](/Gui.Controls/_GridView.md) |
| ● *ColumnHeaderStringFormat* | Gets or sets a composite string that specifies how to format the column headers of the [GridView](/Gui.Controls/_GridView.md) if they are displayed as strings |
...
| ○ *Columns* | Gets the collection of [GridViewColumn](/Gui.Controls/_GridViewColumn.md) objects that is defined for this [GridView](/Gui.Controls/_GridView.md) |
...
## From [BaseView](/Gui.Controls/_BaseView.md)
