...
## namespace [Noesis](https://www.noesisengine.com/docs/Gui.Core._ClassHierarchy.html#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.primitives.gridviewrowpresenterbase.aspx)
...
- [GridViewHeaderRowPresenter](https://www.noesisengine.com/docs/Gui.Controls._GridViewHeaderRowPresenter.html)
- [GridViewRowPresenter](https://www.noesisengine.com/docs/Gui.Controls._GridViewRowPresenter.html)
...
| Property | Description |
|----------|-------------|
| Columns | Gets or sets a GridViewColumnCollection that specifies the columns of the GridView |
