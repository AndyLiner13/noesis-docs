Source: https://www.noesisengine.com/docs/Gui.Controls._GridViewHeaderRowPresenter.html

# GridViewHeaderRowPresenter Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.gridviewheaderrowpresenter.aspx)
...
| ● *ColumnHeaderContainerStyle* | Gets or sets the [Style](/Gui.Core/_Style.md) to use for the column headers |
| ● *ColumnHeaderContextMenu* | Gets or sets a [ContextMenu](/Gui.Core/_ContextMenu.md) for the column headers |
...
| ● *ColumnHeaderTemplateSelector* | Gets or sets a [DataTemplateSelector](/Gui.Core/_DataTemplateSelector.md) that provides logic that selects the data template to use to display a column header |
| ● *ColumnHeaderToolTip* | Gets or sets the content for a tooltip for the column header row |

● Dependency Property   ○ Reflection Property

## From [BaseGridViewRowPresenter](/Gui.Controls/_BaseGridViewRowPresenter.md)

| Name | Description |
| --- | --- |
| ● *Columns* | Gets or sets a GridViewColumnCollection that specifies the columns of the [GridView](/Gui.Controls/_GridView.md) |
...
GridViewHeaderRowPresenter has no attached properties
