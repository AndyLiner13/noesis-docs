...
• [BaseGridViewRowPresenter](_BaseGridViewRowPresenter.md)
...
## From [BaseGridViewRowPresenter](_BaseGridViewRowPresenter.md)

| Name | Description |
| --- | --- |
| ● *Columns* | Gets or sets a GridViewColumnCollection that specifies the columns of the [GridView](_GridView.md) |
