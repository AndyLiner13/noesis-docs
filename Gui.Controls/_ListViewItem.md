Source: https://www.noesisengine.com/docs/Gui.Controls._ListViewItem.html

# ListViewItem Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.listviewitem.aspx)

Represents an item in a [ListView](/Gui.Controls/_ListView.md) control.
...
• [ListBoxItem](/Gui.Core/_ListBoxItem.md)

• *ListViewItem*

# Properties

## From [ListBoxItem](/Gui.Core/_ListBoxItem.md)

| Name | Description |
| --- | --- |
| ● *IsSelected* | Gets or sets a value that indicates whether a [ListBoxItem](/Gui.Core/_ListBoxItem.md) is selected |
...
ListViewItem has no attached properties
...
| Name | Description |
| --- | --- |
| ▸ *Selected* | Occurs when a [ListBoxItem](/Gui.Core/_ListBoxItem.md) is selected |
| ▸ *Unselected* | Occurs when a [ListBoxItem](/Gui.Core/_ListBoxItem.md) is unselected |
