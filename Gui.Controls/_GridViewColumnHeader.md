Source: https://www.noesisengine.com/docs/Gui.Controls._GridViewColumnHeader.html

# GridViewColumnHeader Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.gridviewcolumnheader.aspx)

Represents a column header for a [GridViewColumn](/Gui.Controls/_GridViewColumn.md).
...
| Name | Description |
| --- | --- |
| ○ *Column* | Gets the [GridViewColumn](/Gui.Controls/_GridViewColumn.md) that is associated with the [GridViewColumnHeader](/Gui.Controls/_GridViewColumnHeader.md) |
| ● *Role* | Gets the role of a [GridViewColumnHeader](/Gui.Controls/_GridViewColumnHeader.md) |
...
GridViewColumnHeader has no attached properties
