...
Represents a column header for a [GridViewColumn](_GridViewColumn.md).
...
| Name | Description |
| --- | --- |
| ○ *Column* | Gets the [GridViewColumn](_GridViewColumn.md) that is associated with the [GridViewColumnHeader](_GridViewColumnHeader.md) |
| ● *Role* | Gets the role of a [GridViewColumnHeader](_GridViewColumnHeader.md) |
