Source: https://www.noesisengine.com/docs/Gui.Controls._ListView.html

# ListView Class

## namespace [Noesis](/Gui.Core/_ClassHierarchy.md#noesis-namespace) | [MSDN](http://msdn.microsoft.com/en-us/library/system.windows.controls.listview.aspx)
...
| Name | Description |
| --- | --- |
| ● *View* | Gets or sets an object that defines how the data is styled and organized in a [ListView](/Gui.Controls/_ListView.md) control |

● Dependency Property   ○ Reflection Property

## From [ListBox](/Gui.Core/_ListBox.md)

| Name | Description |
| --- | --- |
| ● *SelectedItems* | Gets a list of the currently selected items |
| ● *SelectionMode* | Gets or sets the selection behavior for a [ListBox](/Gui.Core/_ListBox.md) |
...
|  *ScrollIntoView(item)* | Causes the item to scroll into view. If it is not visible, it is aligned either at the top or bottom of the viewport |
|  *SelectAll()* | Selects all the items |
|  *UnselectAll()* | Clears all of the selected items |
