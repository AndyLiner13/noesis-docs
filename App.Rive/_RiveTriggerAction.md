Source: https://www.noesisengine.com/docs/App.Rive._RiveTriggerAction.html

# RiveTriggerAction Class

## namespace [NoesisApp](/Gui.Core/_ClassHierarchy.md#noesisapp-namespace)

An action that will fire a trigger in a [RiveControl](/App.RiveBase/_RiveControl.md).
...
| Name | Description |
| --- | --- |
| ● *TriggerName* | Gets or sets the name of the trigger in the Rive scene |
...
RiveTriggerAction has no attached properties
...
RiveTriggerAction has no events